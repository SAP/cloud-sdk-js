...
__esmMin((() => {
	...
	ss = () => {}, He = ss;
	Ve = "string", Ue = "array", lt = "cursor", Te = "indent", be = "align", ct = "trim", we = "group", ke = "fill", xe = "if-break", ye = "indent-if-break", ut = "line-suffix", pt = "line-suffix-boundary", $ = "line", ht = "label", Ae = "break-parent", mt = /* @__PURE__ */ new Set([
		lt,
		Te,
		be,
		ct,
...
`) {
	...
	qt = {
		...
		cases: !0,
		expression: !0
	}, $i = /* @__PURE__ */ new Set(["parent"]), Be = class Be {
		constructor(t = {}) {
			Dr(this, re);
			Ut(this, "kind");
			Ut(this, "parent");
	...
	Oo = at(Ht), Do = /* @__PURE__ */ new Set(["mj-style", "mj-raw"]), Io = at({
		...Ht,
		name: "mjml",
