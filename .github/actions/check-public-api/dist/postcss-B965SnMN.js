...
`), m = x.length - 1, m > 0 ? (g = u + m, v = l - x[m].length) : (g = u, v = o), r.push([
	...
	Ac = /(\r?\n|^) *\* ?/g;
	zn = [];
	Xn = ["noformat", "noprettier"];
	Jn = ["format", "prettier"];
	Zn = "format";
	ei = Cc;
	ni = (t) => ti(xe(t).content);
...
` : "") + si(s);
	...
	Pi = /(["'])(?:(?!\1)[^\\]|\\.)*\1/gs;
	Bc = new RegExp(Pi.source + `|(${/[$@]?[_a-z\u0080-\uFFFF][\w\u0080-\uFFFF-]*/gi.source})?(${/(?:\d*\.\d+|\d+\.?)(?:e[+-]?\d+)?/gi.source})(${/[a-z]+/gi.source})?`, "gi");
	Li = (t) => t === `
` || t === "\r" || t === "\u2028" || t === "\u2029";
	jt = Uc;
	Ht = Fc;
...
export { Dl as default, Ui as languages, Wi as options, cn as parsers, yg as printers };
