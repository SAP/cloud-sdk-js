...
${codeblock}`, options8);
	...
	estreePlugin = createParsersAndPrinters([{
		importPlugin: () => import("./estree-C1nrgvTS.js"),
	...
	({parsers, printers} = createParsersAndPrinters([
		{
			importPlugin: () => import("./acorn-BW8IuGUU.js"),
			parsers: ["acorn", "espree"]
		},
		{
			importPlugin: () => import("./angular-Cjr2GSMv.js"),
			parsers: [
				"__ng_action",
				"__ng_binding",
				"__ng_interpolation",
		...
		{
			importPlugin: () => import("./babel-Be0qNPkT.js"),
			parsers: [
				"babel",
				"babel-flow",
				"babel-ts",
		...
		{
			importPlugin: () => import("./flow-DEK2_VDM.js"),
			parsers: ["flow"]
		},
		{
			importPlugin: () => import("./glimmer-CVvRStjs.js"),
			parsers: ["glimmer"],
			printers: ["glimmer"]
		},
		{
			importPlugin: () => import("./graphql-C-bUYq8k.js"),
			parsers: ["graphql"],
			printers: ["graphql"]
		},
		{
			importPlugin: () => import("./html-1cVpyCxf.js"),
			parsers: [
				"html",
				"angular",
				"vue",
		...
		{
			importPlugin: () => import("./markdown-DSgjUFSU.js"),
			parsers: [
				"markdown",
				"mdx",
				"remark"
		...
		{
			importPlugin: () => import("./meriyah-U8V_UGOx.js"),
			parsers: ["meriyah"]
		},
		{
			importPlugin: () => import("./postcss-BARDyLIz.js"),
			parsers: [
				"css",
				"less",
				"scss"
		...
		{
			importPlugin: () => import("./typescript-CiOrBbVD.js"),
			parsers: ["typescript"]
		},
		{
