...
async function loadYaml(file) {
	const content = await read_file_default(file);
	if (!parseYaml) ({__parsePrettierYamlConfig: parseYaml} = await import("./yaml-D2D0Hj1Y.js"));
	try {
...
__esmMin((() => {
	...
	init_production_plugins = __esm({ "src/main/plugins/builtin-plugins/production-plugins.js"() {
		...
		plugins = /* @__PURE__ */ toLazyLoadPlugins({
			name: "acorn",
			load: () => import("./acorn-CO7zgUoW.js"),
			parsers: ["acorn", "espree"]
		}, {
			name: "angular",
			load: () => import("./angular-hxMGiaHC.js"),
			parsers: [
				"__ng_action",
				"__ng_binding",
				"__ng_directive",
			...
			name: "markdown",
			load: () => import("./markdown-BhSVygrp.js"),
			...
			name: "meriyah",
			load: () => import("./meriyah-BVCiq5Wa.js"),
			parsers: ["meriyah"]
		}, {
			name: "postcss",
			load: () => import("./postcss-CGjHGNtt.js"),
			...
			name: "typescript",
			load: () => import("./typescript-CmPECN6u.js"),
			parsers: ["typescript"]
		}, {
			name: "yaml",
			load: () => import("./yaml-D2D0Hj1Y.js"),
