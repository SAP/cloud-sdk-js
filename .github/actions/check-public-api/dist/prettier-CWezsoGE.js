import { __esmMin, __exportAll } from "./rolldown-runtime-C5kaFYNG.js";
...
async function loadYaml(file) {
	const content = await read_file_default(file);
	if (!parseYaml) ({__parsePrettierYamlConfig: parseYaml} = await import("./yaml-BYDBkZFB.js"));
	try {
...
__esmMin((() => {
	...
	init_production_plugins = __esm({ "src/main/plugins/builtin-plugins/production-plugins.js"() {
		...
		plugins = /* @__PURE__ */ toLazyLoadPlugins({
			...
			name: "graphql",
			load: () => import("./graphql-CtSS04Lw.js"),
			...
			name: "markdown",
			load: () => import("./markdown-CMk0JIEY.js"),
			...
			name: "postcss",
			load: () => import("./postcss-B0V-b7pn.js"),
			...
			name: "typescript",
			load: () => import("./typescript-C0CIIv2u.js"),
			parsers: ["typescript"]
		}, {
			name: "yaml",
			load: () => import("./yaml-BYDBkZFB.js"),
