...
async function loadYaml(file) {
	const content = await read_file_default(file);
	if (!parseYaml) ({__parsePrettierYamlConfig: parseYaml} = await import("./yaml-BfCBQ5ay.js"));
	try {
...
__esmMin((() => {
	...
	init_production_plugins = __esm({ "src/main/plugins/builtin-plugins/production-plugins.js"() {
		...
		plugins = /* @__PURE__ */ toLazyLoadPlugins({
			name: "acorn",
			load: () => import("./acorn-nbH0I4gI.js"),
			parsers: ["acorn", "espree"]
		}, {
			name: "angular",
			load: () => import("./angular-Cj5uoO_C.js"),
			parsers: [
				"__ng_action",
				"__ng_binding",
				"__ng_directive",
			...
			name: "markdown",
			load: () => import("./markdown-D0mLzfh0.js"),
			...
			name: "meriyah",
			load: () => import("./meriyah-D3ULj66Q.js"),
			parsers: ["meriyah"]
		}, {
			name: "postcss",
			load: () => import("./postcss-xpGwE-q_.js"),
			...
			name: "typescript",
			load: () => import("./typescript-DPTVUMAo.js"),
			parsers: ["typescript"]
		}, {
			name: "yaml",
			load: () => import("./yaml-BfCBQ5ay.js"),
