...
async function loadYaml(file) {
	const content = await read_file_default(file);
	if (!parseYaml) ({__parsePrettierYamlConfig: parseYaml} = await import("./yaml-EkSMxulB.js"));
	try {
...
${codeblock}`, options8);
	...
	estreePlugin = createParsersAndPrinters([{
		importPlugin: () => import("./estree-D3wK6kDg.js"),
	...
	({parsers, printers} = createParsersAndPrinters([
		{
			importPlugin: () => import("./acorn-Lo8hV0QE.js"),
			parsers: ["acorn", "espree"]
		},
		{
			importPlugin: () => import("./angular-BDq8CpSH.js"),
			parsers: [
				"__ng_action",
				"__ng_binding",
				"__ng_interpolation",
		...
		{
			importPlugin: () => import("./babel-CZV-nXip.js"),
			parsers: [
				"babel",
				"babel-flow",
				"babel-ts",
		...
		{
			importPlugin: () => import("./flow-DKIme0c4.js"),
			parsers: ["flow"]
		},
		{
			importPlugin: () => import("./glimmer-C2CSmn_t.js"),
			parsers: ["glimmer"],
			printers: ["glimmer"]
		},
		{
			importPlugin: () => import("./graphql-DMUfcyR9.js"),
			parsers: ["graphql"],
			printers: ["graphql"]
		},
		{
			importPlugin: () => import("./html-CGnTnh3H.js"),
			parsers: [
				"html",
				"angular",
				"vue",
		...
		{
			importPlugin: () => import("./markdown-CujGU574.js"),
			parsers: [
				"markdown",
				"mdx",
				"remark"
		...
		{
			importPlugin: () => import("./meriyah-UhC-PINz.js"),
			parsers: ["meriyah"]
		},
		{
			importPlugin: () => import("./postcss-CFOfUTlp.js"),
			parsers: [
				"css",
				"less",
				"scss"
		...
		{
			importPlugin: () => import("./typescript-DMmyaOpv.js"),
			parsers: ["typescript"]
		},
		{
			importPlugin: () => import("./yaml-EkSMxulB.js"),
			parsers: ["yaml"],
			printers: ["yaml"]
		}
	]));
