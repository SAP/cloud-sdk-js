import { __esmMin, __exportAll } from "./chunk-pW83Rt8M.js";
...
async function loadYaml(file) {
	const content = await read_file_default(file);
	if (!parseYaml) ({__parsePrettierYamlConfig: parseYaml} = await import("./yaml-BWH9dTHC.js"));
	try {
...
${codeblock}`, options8);
	...
	estreePlugin = createParsersAndPrinters([{
		importPlugin: () => import("./estree-BfsHT6B_.js"),
	...
	({parsers, printers} = createParsersAndPrinters([
		{
			importPlugin: () => import("./acorn-C-XKBC-o.js"),
			parsers: ["acorn", "espree"]
		},
		{
			importPlugin: () => import("./angular-C9VvcPa_.js"),
			parsers: [
				"__ng_action",
				"__ng_binding",
				"__ng_interpolation",
		...
		{
			importPlugin: () => import("./babel-BK5qWniV.js"),
			parsers: [
				"babel",
				"babel-flow",
				"babel-ts",
		...
		{
			importPlugin: () => import("./flow-DqpKpnyi.js"),
			parsers: ["flow"]
		},
		{
			importPlugin: () => import("./glimmer-Y6FV8NBB.js"),
			parsers: ["glimmer"],
			printers: ["glimmer"]
		},
		{
			importPlugin: () => import("./graphql-BFr7PIX2.js"),
			parsers: ["graphql"],
			printers: ["graphql"]
		},
		{
			importPlugin: () => import("./html-DLmZxF98.js"),
			parsers: [
				"html",
				"angular",
				"vue",
		...
		{
			importPlugin: () => import("./markdown-B57yLT0G.js"),
			parsers: [
				"markdown",
				"mdx",
				"remark"
		...
		{
			importPlugin: () => import("./meriyah-D-aEcTSw.js"),
			parsers: ["meriyah"]
		},
		{
			importPlugin: () => import("./postcss-CW48Q4oJ.js"),
			parsers: [
				"css",
				"less",
				"scss"
		...
		{
			importPlugin: () => import("./typescript-ChEPDbj5.js"),
			parsers: ["typescript"]
		},
		{
			importPlugin: () => import("./yaml-BWH9dTHC.js"),
			parsers: ["yaml"],
			printers: ["yaml"]
		}
	]));
