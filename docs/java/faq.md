...
_Generally Available_ or _Beta_ state get into the next release. Here you can find the latest SDK version and the list
...
The general recommendation is _YES_. This way you'll reduce an effort to keep up with the fast pace of cloud
...
external GitHub repository or use internal one if you're SAP employee.
...
use. If you found a feature that you need but not yet supported by Cloud SDK for Java, please, make a feature request
