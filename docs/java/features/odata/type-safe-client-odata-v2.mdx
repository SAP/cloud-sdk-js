...
We're still in progress of documenting OData BATCH requests with type-safe client. The quick code snippet below will demonstrate a simple example of multiple create requests ran as BATCH. Stay tuned for comprehensive documentation soon and look into our API documentation if you're in a hurry. You'll find it in our [release notes](../../release-notes-sap-cloud-sdk-for-java).
:::

A simple example of BATCH create requests based on BusinessPartner OData v2 service.
