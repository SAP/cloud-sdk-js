...
We're still in progress of documenting OData BATCH requests with type-safe client. The quick code snippet below will demonstrate a simple example of multiple create requests ran as BATCH. Stay tuned for comprehensive documentation soon and look into our API documentation if you're in a hurry.
:::
