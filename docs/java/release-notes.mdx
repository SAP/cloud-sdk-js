...
- To leverage the new **OData v2 client**, you need to adjust existing code. Refer to [documentation on how to switch](./features/odata/use-typed-odata-v2-client-in-sap-cloud-sdk-for-java#switch-to-improved-odata-v2-type-safe-client) for detailed instructions.
...
Refer to the [documentation on how to switch](./features/odata/use-typed-odata-v2-client-in-sap-cloud-sdk-for-java#switch-to-improved-odata-v2-type-safe-client) for more details on the new OData 2 client.
