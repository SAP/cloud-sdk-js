...
The SAP Cloud SDK command-line interface resides in a separate [Github repository](https://github.com/sap/cloud-sdk-cli).
...
All features that are in _Generally Available_ or _Beta_ state get into the next release.
...
Yes, we do. They usually have a higher `patch` number according to [semver](https://semver.org/), i.e: 1.24.1 instead of 1.24.0. Check our [release notes](https://github.com/SAP/cloud-sdk-js/releases) for more details.
...
Please, report it to us through any available channel. The preferred support channel is [Github](https://github.com/SAP/cloud-sdk-js/issues/new/choose).
