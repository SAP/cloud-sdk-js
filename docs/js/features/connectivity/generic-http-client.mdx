...
The values you give in the request config [will be merged](https://github.com/SAP/cloud-sdk/blob/main/packages/core/src/http-client/http-client.ts#L136-L148) with ones related to the destination:
```ts
{
