---
id: on-premise-connectivity-in-the-sap-cloud-sdk-for-javascript
...
```
and will be used by the [HTTP client](generic-http-client.mdx) of the SDK to execute the request.
