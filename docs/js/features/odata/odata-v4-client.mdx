...
If you want to get all persons with first name `John` the query is:
...
If you want to get all persons who have at least one friend with first name `John` the query is:
...
In case you want to get all persons, but reduce the friends in the response the filter has to be inside the expand:
