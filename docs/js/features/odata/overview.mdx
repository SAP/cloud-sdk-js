...
|---------------------------------------------------------------------|--------------------------|
| [OData v2](use-odata-v2-type-safe-client-for-javascript-typescript) | &#10003;                 |
| [OData v4](use-odata-v4-type-safe-client-for-javascript-typescript) | &#10003;                 |
...
- We ship pre-generated OData clients for the SAP S/4HANA OData services. They are also referred to as the *Virtual Data Model* or *VDM*. You can find a list of all those services in the [SAP API Business Hub](https://api.sap.com/package/SAPS4HANACloud?section=Artifacts) (check the ODATA box).
