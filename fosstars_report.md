...
**Score**: **7.38**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **4.9** (weight is 0.5)
...
Score: **4.9**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 6955
1.  **Number of stars for a GitHub repository:** 214
