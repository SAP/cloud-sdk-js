...
Score: **4.82**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 6846
1.  **Number of stars for a GitHub repository:** 202
