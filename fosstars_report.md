...
1.  **[Project popularity](#project-popularity)**: **4.51** (weight is 0.5)
...
Score: **4.51**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 6433
1.  **Number of stars for a GitHub repository:** 173
