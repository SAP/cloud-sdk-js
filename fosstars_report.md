...
**Score**: **7.25**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **3.62** (weight is 0.5)
...
Score: **3.62**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 5113
1.  **Number of stars for a GitHub repository:** 159
