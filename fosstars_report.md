...
1.  **[Project popularity](#project-popularity)**: **2.27** (weight is 0.5)
...
272 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 272
1.  **Number of contributors in the last three months:** 3


### Project popularity

Score: **2.27**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 3128
