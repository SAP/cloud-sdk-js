...
**Score**: **7.27**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **3.86** (weight is 0.5)
...
Score: **3.86**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 5461
1.  **Number of stars for a GitHub repository:** 161
