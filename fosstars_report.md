...
**Score**: **7.35**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **4.58** (weight is 0.5)
...
Score: **4.58**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 6535
1.  **Number of stars for a GitHub repository:** 175
