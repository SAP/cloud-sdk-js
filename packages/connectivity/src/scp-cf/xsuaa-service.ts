...
/**
 * Make a client credentials request against the XSUAA credentials inside {@link service}.
...
/**
 * Make a user token request against the XSUAA credentials inside {@link service}.
 * @param service - Service as it is defined in the environment variable.
