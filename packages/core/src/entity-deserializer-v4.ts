...
import { Entity, isExpandedProperty, isSelectedProperty, isSelectedPropertyV4 } from './entity';
 ...
 */
export function extractCustomFields<EntityT extends Entity<ODataV4>, JsonT>(
  json: Partial<JsonT>,
 ...
 */
export function deserializeEntity<EntityT extends Entity<ODataV4>, JsonT>(
  json: Partial<JsonT>,
  entityConstructor: Constructable<EntityT>,
  requestHeader?: any
): EntityT {
  ...
  return entityConstructor._allFields
    .filter(field => isSelectedPropertyV4(json, field))
