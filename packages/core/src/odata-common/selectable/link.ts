...
export class Link<EntityT extends Entity, LinkedEntityT extends Entity = any>
  ...
  /**
   * Creates a selection on a linked entity. Has the same behavior as [[GetAllRequestBuilder.select]] and [[GetByKeyRequestBuilderV4.select]] but for linked entities.
   *
   * See also, [[Selectable]]
   *
