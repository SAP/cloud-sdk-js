...
export class Link<EntityT extends Entity, LinkedEntityT extends Entity = any>
  ...
  /**
   * Creates a selection on a linked entity. Has the same behavior as [[GetAllRequestBuilderV2.select]] and [[GetByKeyRequestBuilder.select]] but for linked entities.
   *
   * See also, [[Selectable]]
   *
