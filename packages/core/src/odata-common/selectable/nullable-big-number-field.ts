...
/**
 * Represents a property with a big number value, that is nullable.
 *
 * @typeparam EntityT - Type of the entity the field belongs to
 */
class NullableBigNumberFieldBase<
  EntityT extends Entity
> extends GreaterOrLessEdmTypeField<EntityT, BigNumber | null> {}

/**
 * Represents a selectable property with a big number value, that is nullable.
 *
 * @typeparam EntityT - Type of the entity the field belongs to
 */
export class NullableBigNumberField<EntityT extends Entity>
  extends NullableBigNumberFieldBase<EntityT>
...
/**
 * Represents a complex type property with a big number value, that is nullable.
 *
 * @typeparam EntityT - Type of the entity the field belongs to
 */
export class ComplexTypeNullableBigNumberPropertyField<
  EntityT extends Entity,
  ComplexT = any
> extends NullableBigNumberFieldBase<EntityT> {
  /**
