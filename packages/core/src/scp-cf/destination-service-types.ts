...
// prettier-ignore
export type DestinationRetrievalOptions = (DestinationCachingOptions | CachingOptions) & ResilienceOptions; // TODO: remove union type with 2.0
//Also here remove TODO and make a comment in the 2.0 todo list
