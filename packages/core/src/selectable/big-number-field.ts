...
class BigNumberFieldBaseODataV4<EntityT extends EntityODataV4> extends EdmTypeFieldODataV4<
  EntityT,
  BigNumber
  > {
  /**
   ...
   * @returns The resulting filter
   */
  greaterThan(value: BigNumber): FilterODataV4<EntityT, BigNumber> {
   ...
   * @returns The resulting filter
   */
  greaterOrEqual(value: BigNumber): FilterODataV4<EntityT, BigNumber> {
   ...
   * @returns The resulting filter
   */
  lessThan(value: BigNumber): FilterODataV4<EntityT, BigNumber> {
   ...
   * @returns The resulting filter
   */
  lessOrEqual(value: BigNumber): FilterODataV4<EntityT, BigNumber> {
...
export class BigNumberFieldODataV4<EntityT extends EntityODataV4>
  extends BigNumberFieldBaseODataV4<EntityT>
  implements SelectableEdmTypeField {
  readonly selectable: true;
}
...
export class ComplexTypeBigNumberPropertyFieldODataV4<
