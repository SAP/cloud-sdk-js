...
//todo check reference in e.g., boolean field
export abstract class ComplexTypeFieldODataV4<EntityT extends EntityODataV4> extends FieldODataV4<
  EntityT
  > {
  /**
   * The constructor of the entity or the complex type this field belongs to
   ...
   * @param fieldOf - If the complex field is on root level of entity it is the entity otherwise the parent complex field
   */
  constructor(fieldName: string, fieldOf: ConstructorOrFieldODataV4<EntityT>);
  ...
  constructor(
    ...
    super(fieldName, getEntityConstructorODataV4(fieldOf));
    this.fieldOf = fieldOf;
    this.complexTypeName = complexTypeName;
  }
...
export type ConstructorOrFieldODataV4<EntityT extends EntityODataV4> =
  | ConstructableODataV4<EntityT>
...
export function getEntityConstructorODataV4<EntityT extends EntityODataV4>(
  arg: ConstructableODataV4<EntityT> | ComplexTypeFieldODataV4<EntityT>
): ConstructableODataV4<EntityT> {
  return arg instanceof ComplexTypeFieldODataV4 ? arg._entityConstructor : arg;
}
