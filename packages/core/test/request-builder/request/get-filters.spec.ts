...
import { TestEntity as TestEntityV4, TestEntityMultiLink as  TestEntityMultiLinkV4} from '../../test-util/test-services/v4/test-service';
...
describe('get filters', () => {
  ...
  describe('odata v4', () => {
    ...
    it('for lambda expression on one-to-many navigation property', () => {
      expect(
        getFilter(testFilterLambdaExpressionOnLink.filter, TestEntityMultiLinkV4).filter
