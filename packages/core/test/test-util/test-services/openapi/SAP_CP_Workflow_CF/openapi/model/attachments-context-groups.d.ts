 ...
 */
import { AttachmentsContextRefs } from './attachments-context-refs';
/**
 *
 * @export
 * @interface AttachmentsContextGroups
 */
export interface AttachmentsContextGroups {
    /**
     * A folder that shall be used for uploading files at the remote repository for this group (i.e. relative to the root folder)
     * @type {string}
     * @memberof AttachmentsContextGroups
     */
    folder?: string;
    /**
     * A list of references to files in the remote repository
     * @type {Array<AttachmentsContextRefs>}
     * @memberof AttachmentsContextGroups
     */
    refs?: Array<AttachmentsContextRefs>;
}
//# sourceMappingURL=attachments-context-groups.d.ts.map