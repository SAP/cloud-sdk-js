 ...
 */
import { AttachmentsContextGroups } from './attachments-context-groups';
/**
 *
 * @export
...
export interface AttachmentsContext {
     ...
     * @type {string}
     * @memberof AttachmentsContext
     */
    rootFolder?: string;
    /**
     * A map of groups allowing to semantically separate attachments. The key is the group name.
     * @type {{ [key: string]: AttachmentsContextGroups; }}
     * @memberof AttachmentsContext
     */
    groups?: {
        [key: string]: AttachmentsContextGroups;
    };
}
//# sourceMappingURL=attachments-context.d.ts.map