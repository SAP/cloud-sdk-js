 ...
 *
 * @export
 * @interface TaskDefinitionAttribute
 */
export interface TaskDefinitionAttribute {
    /**
     * The ID of the attribute.
     * @type {string}
     * @memberof TaskDefinitionAttribute
     */
    id?: string;
    /**
     ...
     * @memberof TaskDefinitionAttribute
     */
    type?: TaskDefinitionAttributeTypeEnum;
}
/**
    * @export
    * @enum {string}
    */
export declare enum TaskDefinitionAttributeTypeEnum {
    String = "string"
}
//# sourceMappingURL=task-definition-attribute.d.ts.map