 ...
 *
 * @export
 * @interface TechnicalErrorErrorDetails
 */
export interface TechnicalErrorErrorDetails {
    /**
     * The severity of the error.
     * @type {string}
     * @memberof TechnicalErrorErrorDetails
     */
    severity?: string;
    /**
...
//# sourceMappingURL=technical-error-error-details.d.ts.map