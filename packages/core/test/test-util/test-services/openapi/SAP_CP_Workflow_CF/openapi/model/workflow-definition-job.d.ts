 ...
 *
 * @export
 * @interface WorkflowDefinitionJob
 */
export interface WorkflowDefinitionJob {
    /**
     * The job ID. The ID is at least 36 characters long.
     * @type {string}
     * @memberof WorkflowDefinitionJob
     */
    id?: string;
    /**
     ...
     * @memberof WorkflowDefinitionJob
     */
    purpose?: WorkflowDefinitionJobPurposeEnum;
}
/**
    * @export
    * @enum {string}
    */
export declare enum WorkflowDefinitionJobPurposeEnum {
    Delete = "delete"
}
