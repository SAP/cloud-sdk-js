 ...
 * @export
 * @interface WorkflowInstanceExecutionLogChanges
 */
export interface WorkflowInstanceExecutionLogChanges {
    /**
     * The variables, which were created in the context.
     * @type {Set<string>}
     * @memberof WorkflowInstanceExecutionLogChanges
     */
    create?: Set<string>;
    /**
...
//# sourceMappingURL=workflow-instance-execution-log-changes.d.ts.map