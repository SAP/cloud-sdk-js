 ...
 * 
 * @export
 * @interface WorkflowInstanceUpdatePayload
 */
export interface WorkflowInstanceUpdatePayload {
    /**
     * The new status of the workflow instance.
     * @type {string}
     * @memberof WorkflowInstanceUpdatePayload
     */
    status?: WorkflowInstanceUpdatePayloadStatusEnum;
}
