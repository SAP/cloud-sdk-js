 ...
 * @export
 */
export const TestCaseApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    getTestCasesNoOperationId: async (
      options: any = {}
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    testCaseGetDuplicateParameters: async (
      ...
      const localVarPath = `/test-cases/parameters/{duplicateParam}`.replace(
        `{${'duplicateParam'}}`,
     ...
     * @throws {RequiredError}
     */
    testCaseGetRequiredParameters: async (
      ...
      const localVarPath = `/test-cases/parameters/required-parameters/{requiredPathItemPathParam}`.replace(
        `{${'requiredPathItemPathParam'}}`,
     ...
     * @throws {RequiredError}
     */
    testCasePostRequiredParameters: async (
      requiredPathItemQueryParam: string,
      requiredPathItemPathParam: string,
      requiredQueryParam: string,
      simpleTestEntity: SimpleTestEntity,
...
export const TestCaseApiFp = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    async getTestCasesNoOperationId(
      options?: any
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
     ...
     * @throws {RequiredError}
     */
    async testCaseGetDuplicateParameters(
      duplicateParam: string,
      duplicateParam2: string,
      options?: any
    ): Promise<
     ...
     * @throws {RequiredError}
     */
    async testCaseGetRequiredParameters(
      requiredPathItemQueryParam: string,
      requiredPathItemPathParam: string,
      requiredQueryParam: string,
      optionalQueryParam?: string,
     ...
     * @throws {RequiredError}
     */
    async testCasePostRequiredParameters(
      requiredPathItemQueryParam: string,
      requiredPathItemPathParam: string,
      requiredQueryParam: string,
      simpleTestEntity: SimpleTestEntity,
 ...
 * @export
 */
export const TestCaseApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
...
export class TestCaseApi extends BaseAPI {
   ...
   * @memberof TestCaseApi
   */
  public testCaseGetDuplicateParameters(
    duplicateParam: string,
    duplicateParam2: string,
    options?: any
  ) {
   ...
   * @memberof TestCaseApi
   */
  public testCaseGetRequiredParameters(
    requiredPathItemQueryParam: string,
    requiredPathItemPathParam: string,
    requiredQueryParam: string,
    optionalQueryParam?: string,
   ...
   * @memberof TestCaseApi
   */
  public testCasePostRequiredParameters(
    requiredPathItemQueryParam: string,
    requiredPathItemPathParam: string,
    requiredQueryParam: string,
    simpleTestEntity: SimpleTestEntity,
