...
export function testFunctionImportEdmReturnType(
...
): FunctionImportRequestBuilder<TestFunctionImportEdmReturnTypeParameters, boolean> {
  const params = {};
  ...
  return new FunctionImportRequestBuilder(
    ...
    data => transformReturnValueForEdmType(data, val => edmToTs(val, 'Edm.Boolean')),
    params
  );
}
...
export function testFunctionImportEdmReturnTypeCollection(
...
): FunctionImportRequestBuilder<TestFunctionImportEdmReturnTypeCollectionParameters, string[]> {
  const params = {};
  ...
  return new FunctionImportRequestBuilder(
    ...
    data => transformReturnValueForEdmTypeList(data, val => edmToTs(val, 'Edm.String')),
    params
  );
}
...
): FunctionImportRequestBuilder<TestFunctionImportEntityReturnTypeParameters, TestEntity> {
  const params = {};
...
): FunctionImportRequestBuilder<TestFunctionImportEntityReturnTypeCollectionParameters, TestEntity[]> {
  const params = {};
...
): FunctionImportRequestBuilder<TestFunctionImportComplexReturnTypeParameters, TestComplexType> {
  const params = {};
...
): FunctionImportRequestBuilder<TestFunctionImportComplexReturnTypeCollectionParameters, TestComplexType[]> {
  const params = {};
...
): FunctionImportRequestBuilder<TestFunctionImportMultipleParamsParameters, boolean> {
  const params = {
...
): FunctionImportRequestBuilder<CreateTestComplexTypeParameters, TestComplexType> {
  const params = {};
