...
export class TestEntityLvl2MultiLinkRequestBuilder extends RequestBuilder<TestEntityLvl2MultiLink> {
   ...
   */
  getByKey(keyProperty: string): GetByKeyRequestBuilderV2<TestEntityLvl2MultiLink> {
    return new GetByKeyRequestBuilderV2(TestEntityLvl2MultiLink, { KeyProperty: keyProperty });
  }
   ...
   */
  create(entity: TestEntityLvl2MultiLink): CreateRequestBuilderV2<TestEntityLvl2MultiLink> {
   ...
   */
  update(entity: TestEntityLvl2MultiLink): UpdateRequestBuilderV2<TestEntityLvl2MultiLink> {
   ...
   */
  delete(entity: TestEntityLvl2MultiLink): DeleteRequestBuilderV2<TestEntityLvl2MultiLink>;
  delete(keyPropertyOrEntity: any): DeleteRequestBuilderV2<TestEntityLvl2MultiLink> {
    return new DeleteRequestBuilderV2(TestEntityLvl2MultiLink, keyPropertyOrEntity instanceof TestEntityLvl2MultiLink ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity! });
  }
}
