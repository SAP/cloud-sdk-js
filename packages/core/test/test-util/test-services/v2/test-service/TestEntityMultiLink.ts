...
import { AllFields, Constructable, EdmTypeField, EntityBuilderType, Field, FieldBuilder, Link, OneToOneLink, OrderableEdmTypeField } from '@sap-cloud-sdk/odata-common';
