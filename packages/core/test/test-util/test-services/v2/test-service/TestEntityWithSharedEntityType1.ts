 ...
 */
export class TestEntityWithSharedEntityType1 extends EntityV2 implements TestEntityWithSharedEntityType1Type {
  /**
  ...
  static customField(fieldName: string): CustomFieldV2<TestEntityWithSharedEntityType1> {
    return EntityV2.customFieldSelector(fieldName, TestEntityWithSharedEntityType1);
  }
