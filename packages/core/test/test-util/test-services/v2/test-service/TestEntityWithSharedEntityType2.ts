 ...
 */
export class TestEntityWithSharedEntityType2 extends EntityV2 implements TestEntityWithSharedEntityType2Type {
  /**
  ...
  static customField(fieldName: string): CustomFieldV2<TestEntityWithSharedEntityType2> {
    return EntityV2.customFieldSelector(fieldName, TestEntityWithSharedEntityType2);
  }
