...
export namespace TestEntity3 {
   ...
   */
  export const _allFields: Array<EdmTypeField<TestEntity3, 'Edm.String', false, true> | EdmTypeField<TestEntity3, 'Edm.Enum', true, true> | TestComplexType2Field<TestEntity3, true, true>> = [
