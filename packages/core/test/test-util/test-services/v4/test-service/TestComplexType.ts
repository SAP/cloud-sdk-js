...
import { CollectionField, ComplexTypeField, ConstructorOrField, EdmTypeField, EnumField, FieldBuilder, FieldOptions, FieldType, OrderableEdmTypeField, PropertyMetadata, Time } from '@sap-cloud-sdk/odata-common';
