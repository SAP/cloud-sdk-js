...
> extends ComplexTypeField<EntityT, TestComplexType> {
   ...
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  timeOfDayProperty: ComplexTypeTimePropertyField<EntityT> = new ComplexTypeTimePropertyField(
    'TimeOfDayProperty',
    this,
    'Edm.TimeOfDay'
  );
   ...
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  dateProperty: ComplexTypeDatePropertyField<EntityT> = new ComplexTypeDatePropertyField(
    'DateProperty',
    this,
    'Edm.Date'
  );
   ...
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  geographyPointProperty: ComplexTypeAnyPropertyField<EntityT> = new ComplexTypeAnyPropertyField(
   ...
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  enumProperty: ComplexTypeEnumPropertyField<EntityT> = new ComplexTypeEnumPropertyField(
    'EnumProperty',
    this
  );
  /**
