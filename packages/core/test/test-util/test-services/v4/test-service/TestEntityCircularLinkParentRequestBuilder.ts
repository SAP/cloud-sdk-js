...
export class TestEntityCircularLinkParentRequestBuilder extends RequestBuilder<TestEntityCircularLinkParent> {
   ...
   */
  getByKey(keyProperty: string): GetByKeyRequestBuilderV4<TestEntityCircularLinkParent> {
    return new GetByKeyRequestBuilderV4(TestEntityCircularLinkParent, { KeyProperty: keyProperty });
  }
   ...
   */
  create(entity: TestEntityCircularLinkParent): CreateRequestBuilderV4<TestEntityCircularLinkParent> {
   ...
   */
  update(entity: TestEntityCircularLinkParent): UpdateRequestBuilderV4<TestEntityCircularLinkParent> {
   ...
   */
  delete(keyProperty: string): DeleteRequestBuilderV4<TestEntityCircularLinkParent>;
  /**
   * Returns a request builder for deleting an entity of type `TestEntityCircularLinkParent`.
   ...
   */
  delete(entity: TestEntityCircularLinkParent): DeleteRequestBuilderV4<TestEntityCircularLinkParent>;
  delete(keyPropertyOrEntity: any): DeleteRequestBuilderV4<TestEntityCircularLinkParent> {
    return new DeleteRequestBuilderV4(TestEntityCircularLinkParent, keyPropertyOrEntity instanceof TestEntityCircularLinkParent ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity! });
  }
}
