...
export class TestEntityLvl2MultiLinkRequestBuilder extends RequestBuilder<TestEntityLvl2MultiLink> {
  ...
  getByKey(keyProperty: string): GetByKeyRequestBuilderV4<TestEntityLvl2MultiLink> {
    return new GetByKeyRequestBuilderV4(TestEntityLvl2MultiLink, { KeyProperty: keyProperty });
  }
  ...
  getAll(): GetAllRequestBuilderV4<TestEntityLvl2MultiLink> {
    return new GetAllRequestBuilderV4(TestEntityLvl2MultiLink);
  }
  ...
  create(entity: TestEntityLvl2MultiLink): CreateRequestBuilderV4<TestEntityLvl2MultiLink> {
    return new CreateRequestBuilderV4(TestEntityLvl2MultiLink, entity);
  }
  ...
  update(entity: TestEntityLvl2MultiLink): UpdateRequestBuilderV4<TestEntityLvl2MultiLink> {
    return new UpdateRequestBuilderV4(TestEntityLvl2MultiLink, entity);
  }
  ...
  delete(keyPropertyOrEntity: any): DeleteRequestBuilderV4<TestEntityLvl2MultiLink> {
    return new DeleteRequestBuilderV4(TestEntityLvl2MultiLink, keyPropertyOrEntity instanceof TestEntityLvl2MultiLink ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity! });
  }
}
