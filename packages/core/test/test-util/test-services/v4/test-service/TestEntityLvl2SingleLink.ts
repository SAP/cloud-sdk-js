...
import { AllFields, BooleanField, CustomField, Entity, EntityBuilderType, NumberField, Selectable, StringField } from '../../../../../src/v4';
...
export class TestEntityLvl2SingleLink extends Entity implements TestEntityLvl2SingleLinkType {
   ...
   */
  static _entityName: 'A_TestEntityLvl2SingleLink' = 'A_TestEntityLvl2SingleLink';

readonly _entityName: 'A_TestEntityLvl2SingleLink' = 'A_TestEntityLvl2SingleLink';
  /**
