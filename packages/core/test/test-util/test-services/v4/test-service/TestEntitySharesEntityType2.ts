...
export namespace TestEntitySharesEntityType2 {
   ...
   */
  export const _allFields: Array<StringField<TestEntitySharesEntityType2> | NumberField<TestEntitySharesEntityType2>> = [
   ...
   */
  export const _keyFields: Array<Field<TestEntitySharesEntityType2>> = [TestEntitySharesEntityType2.KEY_PROPERTY_STRING];
  /**
