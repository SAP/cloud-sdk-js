 ...
 */
export class TestEntityWithSharedEntityType1 extends EntityV4 implements TestEntityWithSharedEntityType1Type {
  /**
  ...
  static customField(fieldName: string): CustomFieldV4<TestEntityWithSharedEntityType1> {
    return EntityV4.customFieldSelector(fieldName, TestEntityWithSharedEntityType1);
  }
