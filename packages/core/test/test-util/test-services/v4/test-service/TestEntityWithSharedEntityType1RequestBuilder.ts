...
export class TestEntityWithSharedEntityType1RequestBuilder extends RequestBuilder<TestEntityWithSharedEntityType1> {
   ...
   */
  getByKey(keyProperty: string): GetByKeyRequestBuilderV4<TestEntityWithSharedEntityType1> {
    return new GetByKeyRequestBuilderV4(TestEntityWithSharedEntityType1, { KeyProperty: keyProperty });
  }
   ...
   */
  create(entity: TestEntityWithSharedEntityType1): CreateRequestBuilderV4<TestEntityWithSharedEntityType1> {
   ...
   */
  update(entity: TestEntityWithSharedEntityType1): UpdateRequestBuilderV4<TestEntityWithSharedEntityType1> {
   ...
   */
  delete(keyProperty: string): DeleteRequestBuilderV4<TestEntityWithSharedEntityType1>;
  /**
   * Returns a request builder for deleting an entity of type `TestEntityWithSharedEntityType1`.
   ...
   */
  delete(entity: TestEntityWithSharedEntityType1): DeleteRequestBuilderV4<TestEntityWithSharedEntityType1>;
  delete(keyPropertyOrEntity: any): DeleteRequestBuilderV4<TestEntityWithSharedEntityType1> {
    return new DeleteRequestBuilderV4(TestEntityWithSharedEntityType1, keyPropertyOrEntity instanceof TestEntityWithSharedEntityType1 ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity! });
  }
}
