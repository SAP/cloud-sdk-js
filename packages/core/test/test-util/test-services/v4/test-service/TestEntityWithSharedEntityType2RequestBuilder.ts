...
export class TestEntityWithSharedEntityType2RequestBuilder extends RequestBuilder<TestEntityWithSharedEntityType2> {
   ...
   */
  getByKey(keyProperty: string): GetByKeyRequestBuilderV4<TestEntityWithSharedEntityType2> {
    return new GetByKeyRequestBuilderV4(TestEntityWithSharedEntityType2, { KeyProperty: keyProperty });
  }
   ...
   */
  create(entity: TestEntityWithSharedEntityType2): CreateRequestBuilderV4<TestEntityWithSharedEntityType2> {
   ...
   */
  update(entity: TestEntityWithSharedEntityType2): UpdateRequestBuilderV4<TestEntityWithSharedEntityType2> {
   ...
   */
  delete(keyProperty: string): DeleteRequestBuilderV4<TestEntityWithSharedEntityType2>;
  /**
   * Returns a request builder for deleting an entity of type `TestEntityWithSharedEntityType2`.
   ...
   */
  delete(entity: TestEntityWithSharedEntityType2): DeleteRequestBuilderV4<TestEntityWithSharedEntityType2>;
  delete(keyPropertyOrEntity: any): DeleteRequestBuilderV4<TestEntityWithSharedEntityType2> {
    return new DeleteRequestBuilderV4(TestEntityWithSharedEntityType2, keyPropertyOrEntity instanceof TestEntityWithSharedEntityType2 ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity! });
  }
}
