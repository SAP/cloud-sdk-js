...
export function testActionImportNullableTest(parameters: TestActionImportNullableTestParameters): ActionImportRequestBuilder<TestActionImportNullableTestParameters, TestComplexType | null> {
  ...
  return new ActionImportRequestBuilder('/sap/opu/odata/sap/API_TEST_SRV', 'TestActionImportNullableTest', (data) => transformReturnValueForComplexTypeV4(data, (data) => deserializeComplexTypeV4(data, TestComplexType)), params);
}
