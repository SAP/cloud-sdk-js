...
import { edmToTs, deserializeComplexType, FunctionImportRequestBuilder, transformReturnValueForEdmType, transformReturnValueForEdmTypeList, transformReturnValueForEntity, transformReturnValueForEntityList, transformReturnValueForComplexType, transformReturnValueForComplexTypeList, transformReturnValueForUndefined } from '@sap-cloud-sdk/odata-v4';
...
export function testFunctionImportNullableTest(parameters: TestFunctionImportNullableTestParameters): FunctionImportRequestBuilder<TestFunctionImportNullableTestParameters, string[] | null> {
  ...
  return new FunctionImportRequestBuilder('/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportNullableTest', (data) => transformReturnValueForEdmTypeList(data, (val) => edmToTs(val, 'Edm.String')), params);
}
