 ...
 */
export function testFunctionImportEdmReturnType(parameters: TestFunctionImportEdmReturnTypeParameters): FunctionImportRequestBuilderV4<TestFunctionImportEdmReturnTypeParameters, boolean> {
  const params = {

  }

  return new FunctionImportRequestBuilderV4('/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportEdmReturnType', (data) => transformReturnValueForEdmTypeV4(data, (val) => edmToTsV4(val.value, 'Edm.Boolean')), params);
}
 ...
 * @returns A request builder that allows to overwrite some of the values and execute the resultng request.
 */
export function testFunctionImportEdmReturnTypeCollection(parameters: TestFunctionImportEdmReturnTypeCollectionParameters): FunctionImportRequestBuilderV4<TestFunctionImportEdmReturnTypeCollectionParameters, string[]> {
  const params = {

  }

  return new FunctionImportRequestBuilderV4('/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportEdmReturnTypeCollection', (data) => transformReturnValueForEdmTypeListV4(data, (val) => edmToTsV4(val, 'Edm.String')), params);
}
 ...
 * @returns A request builder that allows to overwrite some of the values and execute the resultng request.
 */
export function testFunctionImportEntityReturnType(parameters: TestFunctionImportEntityReturnTypeParameters): FunctionImportRequestBuilderV4<TestFunctionImportEntityReturnTypeParameters, TestEntity> {
  const params = {
 ...
 * @returns A request builder that allows to overwrite some of the values and execute the resultng request.
 */
export function testFunctionImportSharedEntityReturnTypeWithEntitySetInfo(parameters: TestFunctionImportSharedEntityReturnTypeWithEntitySetInfoParameters): FunctionImportRequestBuilderV4<TestFunctionImportSharedEntityReturnTypeWithEntitySetInfoParameters, TestEntitySharesEntityType1> {
  const params = {

  }

  return new FunctionImportRequestBuilderV4('/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportSharedEntityReturnTypeWithEntitySetInfo', (data) => transformReturnValueForEntityV4(data, TestEntitySharesEntityType1), params);
}
 ...
 * @returns A request builder that allows to overwrite some of the values and execute the resultng request.
 */
export function testFunctionImportSharedEntityReturnTypeWithoutEntitySetInfo(parameters: TestFunctionImportSharedEntityReturnTypeWithoutEntitySetInfoParameters): FunctionImportRequestBuilderV4<TestFunctionImportSharedEntityReturnTypeWithoutEntitySetInfoParameters, TestEntitySharesEntityType1> {
  const params = {

  }

  return new FunctionImportRequestBuilderV4('/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportSharedEntityReturnTypeWithoutEntitySetInfo', (data) => transformReturnValueForEntityV4(data, TestEntitySharesEntityType1), params);
}
 ...
 * @returns A request builder that allows to overwrite some of the values and execute the resultng request.
 */
export function testFunctionImportSharedEntityReturnTypeCollectionWithEntitySetInfo(parameters: TestFunctionImportSharedEntityReturnTypeCollectionWithEntitySetInfoParameters): FunctionImportRequestBuilderV4<TestFunctionImportSharedEntityReturnTypeCollectionWithEntitySetInfoParameters, TestEntitySharesEntityType1[]> {
  const params = {

  }

  return new FunctionImportRequestBuilderV4('/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportSharedEntityReturnTypeCollectionWithEntitySetInfo', (data) => transformReturnValueForEntityListV4(data, TestEntitySharesEntityType1), params);
}
 ...
 * @returns A request builder that allows to overwrite some of the values and execute the resultng request.
 */
export function testFunctionImportSharedEntityReturnTypeCollectionWithoutEntitySetInfo(parameters: TestFunctionImportSharedEntityReturnTypeCollectionWithoutEntitySetInfoParameters): FunctionImportRequestBuilderV4<TestFunctionImportSharedEntityReturnTypeCollectionWithoutEntitySetInfoParameters, TestEntitySharesEntityType1[]> {
  const params = {

  }

  return new FunctionImportRequestBuilderV4('/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportSharedEntityReturnTypeCollectionWithoutEntitySetInfo', (data) => transformReturnValueForEntityListV4(data, TestEntitySharesEntityType1), params);
}
 ...
 * @returns A request builder that allows to overwrite some of the values and execute the resultng request.
 */
export function testFunctionImportComplexReturnType(parameters: TestFunctionImportComplexReturnTypeParameters): FunctionImportRequestBuilderV4<TestFunctionImportComplexReturnTypeParameters, TestComplexType> {
  const params = {

  }

  return new FunctionImportRequestBuilderV4('/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportComplexReturnType', (data) => transformReturnValueForComplexTypeV4(data, (data) => deserializeComplexTypeV4(data, TestComplexType)), params);
}
 ...
 * @returns A request builder that allows to overwrite some of the values and execute the resultng request.
 */
export function testFunctionImportComplexReturnTypeCollection(parameters: TestFunctionImportComplexReturnTypeCollectionParameters): FunctionImportRequestBuilderV4<TestFunctionImportComplexReturnTypeCollectionParameters, TestComplexType[]> {
  const params = {
 ...
 * @returns A request builder that allows to overwrite some of the values and execute the resultng request.
 */
export function testFunctionImportMultipleParams(parameters: TestFunctionImportMultipleParamsParameters): FunctionImportRequestBuilderV4<TestFunctionImportMultipleParamsParameters, boolean> {
  const params = {
  ...
  return new FunctionImportRequestBuilderV4('/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportMultipleParams', (data) => transformReturnValueForEdmTypeV4(data, (val) => edmToTsV4(val.value, 'Edm.Boolean')), params);
}
 ...
 * @returns A request builder that allows to overwrite some of the values and execute the resultng request.
 */
export function testFunctionImportWithDifferentName(parameters: TestFunctionImportWithDifferentNameParameters): FunctionImportRequestBuilderV4<TestFunctionImportWithDifferentNameParameters, undefined> {
  const params = {

  }

  return new FunctionImportRequestBuilderV4('/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportWithDifferentName', (data) => transformReturnValueForUndefinedV4(data, (val) => undefined), params);
}
...
export const functionImports = {
  ...
  testFunctionImportSharedEntityReturnTypeWithEntitySetInfo,
  testFunctionImportSharedEntityReturnTypeWithoutEntitySetInfo,
  testFunctionImportSharedEntityReturnTypeCollectionWithEntitySetInfo,
  testFunctionImportSharedEntityReturnTypeCollectionWithoutEntitySetInfo,
