...
<li>Generate a typed client by running:<p><code style="white-space: pre;">${installCommand}</code></p>to install the generator.</li>
<li>Execute the generator:<p><code style="white-space: pre;">${generateCommand}</code></p></li>
