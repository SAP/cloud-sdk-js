...
describe('function', () => {
  it('functionImportFunction', () => {
    ...
    expect(actual).toEqual({
      ...
      isExported: true,
      statements:
        "const params = {\nwithHoneyToast: new FunctionImportParameter('WithHoneyToast', 'Edm.Boolean', parameters.withHoneyToast)\n}\n\nreturn new FunctionImportRequestBuilder('post', 'some/path/to/food', 'OrderBreakfast', (data) => transformReturnValueForEdmTypeV2(data, (val) => edmToTs(val, Edm.String)), params);"
    });
  });
});
