...
import { entityTypeForceMandatoryInterface, entityTypeInterface } from './interface';
import { entityNamespace } from './namespace';

export function entitySourceFile(entity: VdmEntity, service: VdmServiceMetadata): SourceFileStructure {
  return {
