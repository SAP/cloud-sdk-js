...
requestBuilder(): any { throw new Error("Not implemented"); }
  ...
  get schema() {
    const fieldBuilder = new FieldBuilder(CommonEntitySingleLink, this.deSerializers);
    return { 
...
export class CommonService<DeSerializersT extends DeSerializers = DefaultDeSerializers> {
    ...
    get commonEntitySingleLinkApi(): CommonEntitySingleLinkApi<DeSerializersT> {
        const api = this.initApi('commonEntitySingleLinkApi', CommonEntitySingleLinkApi);
