 ...
 * The properties available in the response can be restricted by creating a {@link GetByKeyRequestBuilderV4.select selection}, where no selection is equal to selecting all fields of the entity.
 * Navigational properties need to expanded explicitly by {@link GetAllRequestBuilderV4.expand}
