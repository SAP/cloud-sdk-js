...
- 94b45b10b: [Compatibility Note] The internal option `packageVersion` of the OpenAPI generator is removed.
...
- 94b45b10b: [Compatibility Note] `tsConfig` option has been renamed to `tsconfig`.
