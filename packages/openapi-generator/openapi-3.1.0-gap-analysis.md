...
- **3.0:** booleans that modify `minimum`/`maximum`. **3.1:** numeric values that *are* the bound.
...
- Every parser/serializer imports `OpenAPIV3` (3.0), never `OpenAPIV3_1`: [schema.ts:4](src/parser/schema.ts#L4), [document.ts:14](src/parser/document.ts#L14), [media-type.ts:4](src/parser/media-type.ts#L4), [openapi-types.ts:1](src/openapi-types.ts#L1), etc. `openapi-types@12.1.3` *does* ship an `OpenAPIV3_1` namespace that the generator does not use.
