...
$ generate-openapi-client --input ./my-spec.yaml --outputDir ./client --transpile`
  ...
  static flags = {
    ...
    strictNaming: flags.boolean({
      name: 'strictNaming',
      description:
        'By default, the generation fails, when there are duplicate names for operations and/or path parameters after transforming them to camel case. Set this to true to enable unique name generation. The names are then be generated by appending numbers.',
      default: true,
      allowNo: true
    }),
    ...
    packageJson: flags.boolean({
      description:
        'When set to true, a `package.json`, that specifies dependencies and scripts for transpilation and documentation generation is generated.',
      default: false
    }),
    ...
    metadata: flags.boolean({
      description: 'When set to true, metadata for the API hub is generated.',
      default: false,
      hidden: true
    })
  };
