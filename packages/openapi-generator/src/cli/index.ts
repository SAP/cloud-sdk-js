...
$ openapi-generator --input ./my-spec.yaml --outputDir ./client --transpile`
  ...
  static flags = {
    ...
    strictNaming: flags.boolean({
      name: 'strictNaming',
      description:
        'By default, the generation fails, when there are duplicate names for operations and/or path parameters after transforming them to camel case. Disable strict naming to ensure unique name generation. The names are then be generated by appending numbers.',
      default: true,
      allowNo: true
    }),
