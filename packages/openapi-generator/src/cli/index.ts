...
$ generate-openapi-client --input ./my-spec.yaml --outputDir ./client --transpile`
  ...
  static flags = {
    ...
    tsConfig: flags.string({
      description:
        'Replace the default `tsconfig.json` by passing a path to a custom config. By default, a `tsconfig.json` is only generated, when transpilation is enabled (`--transpile`). If a directory is passed, a `tsconfig.json` file will be read from this directory.',
      parse: input => resolve(input),
