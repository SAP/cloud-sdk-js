...
export interface ARTSCommonHeaderType {
   ...
   * @memberof ARTSCommonHeaderType
   */
  BusinessUnit: BusinessUnitCommonData[];
  /**
   *
...
export interface CustomerOrderForDeliveryBase {
   ...
   * @memberof CustomerOrderForDeliveryBase
   */
  MerchandiseHierarchy?: MerchandiseHierarchyCommonData[];
  /**
   *
   ...
   * @memberof CustomerOrderForDeliveryBase
   */
  RetailPriceModifier?: RetailPriceModifierDomainSpecific[];
  /**
   ...
   * @memberof CustomerOrderForDeliveryBase
   */
  FrequentShopperPointsModifier?: FrequentShopperPointsModifierType[];
  /**
   ...
   * @memberof CustomerOrderForDeliveryBase
   */
  PromotionPriceDerivationRuleReference?: PromotionPriceDerivationRuleReferenceType[];
  /**
...
export interface ExternalActionType {
   ...
   */
  Text?: ExternalActionTextType[];
  /**
   *
   * @type {Array<ExternalActionParameterType>}
   * @memberof ExternalActionType
   */
  Parameter?: ExternalActionParameterType[];
  /**
   * This is currently not supported.
   * @type {Array<object>}
   * @memberof ExternalActionType
...
export interface LoyaltyAccountCommonData {
   ...
   * @memberof LoyaltyAccountCommonData
   */
  LoyaltyProgram?: LoyaltyAccountType[];
  /**
...
export interface LoyaltyAccountType {
   ...
   */
  LoyaltyProgramID?: LoyaltyProgramIDType[];
  /**
   * This is currently not supported.
   * @type {Array<object>}
   * @memberof LoyaltyAccountType
...
export interface PriceCalculate {
   ...
   * @memberof PriceCalculate
   */
  PriceCalculateBody: PriceCalculateBase[];
  /**
   * This is currently not supported.
   * @type {Array<object>}
   * @memberof PriceCalculate
...
export interface PriceCalculateBase {
   ...
   * @memberof PriceCalculateBase
   */
  Loyalty?: LoyaltyAccountCommonData[];
  /**
   *
...
export interface PriceDerivationRuleBase {
   ...
   * @memberof PriceDerivationRuleBase
   */
  Eligibility?: PriceDerivationRuleEligibility[];
  /**
   * This is currently not supported.
   * @type {Array<object>}
   * @memberof PriceDerivationRuleBase
   ...
   * @memberof PriceDerivationRuleBase
   */
  PromotionDescriptionMultiLanguage?: DescriptionCommonData[];
  /**
   ...
   * @memberof PriceDerivationRuleBase
   */
  ReceiptLineMultiLanguage?: DescriptionCommonData[];
  /**
   ...
   * @memberof PriceDerivationRuleBase
   */
  OperatorDisplayText?: DescriptionCommonData[];
  /**
   ...
   * @memberof PriceDerivationRuleBase
   */
  CustomerDisplayText?: DescriptionCommonData[];
  /**
...
export interface ShoppingBasketBase {
   ...
   */
  LineItem: LineItemDomainSpecific[];
  /**
   * This is currently not supported.
   * @type {Array<object>}
   * @memberof ShoppingBasketBase
 ...
 * @export
 */
export const PriceCalculationApiAxiosParamCreator = function (
  configuration?: Configuration
) {
  return {
    /**
...
export const PriceCalculationApiFp = function (configuration?: Configuration) {
  return {
    ...
    > {
      const localVarAxiosArgs = await PriceCalculationApiAxiosParamCreator(
        configuration
      ).calculateViaRestWithTenant(tenantName, priceCalculate, options);
      return (
        axios: AxiosInstance = globalAxios,
 ...
 * @export
 */
export const PriceCalculationApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    calculateViaRestWithTenant(
      ...
      return PriceCalculationApiFp(configuration)
        .calculateViaRestWithTenant(tenantName, priceCalculate, options)
        .then(request => request(axios, basePath));
    }
  };
...
export class PriceCalculationApi extends BaseAPI {
  ...
  public calculateViaRestWithTenant(
    ...
    return PriceCalculationApiFp(this.configuration)
      .calculateViaRestWithTenant(tenantName, priceCalculate, options)
      .then(request => request(this.axios, this.basePath));
  }
}
