...
import useCorpLogo from '@theme/hooks/useCorpLogo';
    ...
    <nav
      ...
      <div className="navbar__inner">
        ...
        <div className="navbar__items navbar__items--right">
          ...
          />
	  <Link className={classnames('navbar__brand', styles.sapBrand)} to={corpLogo.logoLink} {...corpLogo.logoLinkProps}>
            {corpLogo.logoImageUrl != null && (
              <img
                key={isClient}
                className="navbar__logo"
                src={corpLogo.logoImageUrl}
                alt={corpLogo.logoAlt}
              />
            )}
          </Link>
        </div>
