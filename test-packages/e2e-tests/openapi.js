...
async function getSchemas() {
  ...
  const document = await SwaggerParser.dereference(
    '../../test-resources/openapi-service-specs/test-service-json/test-service.json'
  );
...
async function createApi() {
  const api = new OpenAPIBackend({
    definition: '../../test-resources/openapi-service-specs/test-service-json/test-service.json'
  });
