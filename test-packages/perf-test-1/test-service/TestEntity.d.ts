...
import { AllFields, CustomFieldV4, EdmTypeField, EntityBuilderType, EntityV4, Field, OneToManyLink, OrderableEdmTypeField, Time } from '@sap-cloud-sdk/core';
/**
...
export declare namespace TestEntity {
     ...
     */
    const KEY_TEST_ENTITY: OrderableEdmTypeField<TestEntity, "Edm.Int32", false, true>;
    /**
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const DATA_TIME_OFFSET_DATA_TIME_PROPERTY: OrderableEdmTypeField<TestEntity, "Edm.DateTimeOffset", true, true>;
    /**
     * Static representation of the [[dataTimeOffsetTimestampProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const DATA_TIME_OFFSET_TIMESTAMP_PROPERTY: OrderableEdmTypeField<TestEntity, "Edm.DateTimeOffset", true, true>;
    /**
