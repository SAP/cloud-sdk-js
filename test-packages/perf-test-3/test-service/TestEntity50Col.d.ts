 ...
 */
export declare class TestEntity50Col<T extends DeSerializers = DefaultDeSerializers> extends Entity implements TestEntity50ColType<T> {
    /**
...
export interface TestEntity50ColType<T extends DeSerializers = DefaultDeSerializers> {
    keyTestEntity50Col: DeserializedType<T, 'Edm.Int32'>;
    stringProperty1?: DeserializedType<T, 'Edm.String'> | null;
    guidProperty1?: DeserializedType<T, 'Edm.Guid'> | null;
    booleanProperty1?: DeserializedType<T, 'Edm.Boolean'> | null;
