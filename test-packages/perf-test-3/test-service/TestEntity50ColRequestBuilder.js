...
class TestEntity50ColRequestBuilder extends odata_v4_1.RequestBuilder {
    ...
    getByKey(keyTestEntity50Col) {
        return new odata_v4_1.GetByKeyRequestBuilder(this.entityApi, { KeyTestEntity50Col: keyTestEntity50Col });
    }
    /**
    ...
    delete(keyTestEntity50ColOrEntity) {
        return new odata_v4_1.DeleteRequestBuilder(this.entityApi, keyTestEntity50ColOrEntity instanceof TestEntity50Col_1.TestEntity50Col ? keyTestEntity50ColOrEntity : { KeyTestEntity50Col: keyTestEntity50ColOrEntity });
    }
}
