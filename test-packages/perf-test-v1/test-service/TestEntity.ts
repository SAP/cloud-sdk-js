...
import { AllFields, Constructable, CustomFieldV4, EdmTypeField, EntityBuilderType, EntityV4, Field, FieldBuilder, OneToManyLink, OrderableEdmTypeField, Time } from '@sap-cloud-sdk/core';
