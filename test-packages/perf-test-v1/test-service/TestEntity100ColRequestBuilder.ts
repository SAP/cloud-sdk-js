 ...
 */
export class TestEntity100ColRequestBuilder extends RequestBuilder<TestEntity100Col> {
  /**
  ...
  getByKey(keyTestEntity100Col: number): GetByKeyRequestBuilderV4<TestEntity100Col> {
    return new GetByKeyRequestBuilderV4(TestEntity100Col, { KeyTestEntity100Col: keyTestEntity100Col });
  }
  ...
  getAll(): GetAllRequestBuilderV4<TestEntity100Col> {
    return new GetAllRequestBuilderV4(TestEntity100Col);
  }
  ...
  create(entity: TestEntity100Col): CreateRequestBuilderV4<TestEntity100Col> {
    return new CreateRequestBuilderV4(TestEntity100Col, entity);
  }
  ...
  update(entity: TestEntity100Col): UpdateRequestBuilderV4<TestEntity100Col> {
    return new UpdateRequestBuilderV4(TestEntity100Col, entity);
  }
  ...
  delete(keyTestEntity100ColOrEntity: any): DeleteRequestBuilderV4<TestEntity100Col> {
    return new DeleteRequestBuilderV4(TestEntity100Col, keyTestEntity100ColOrEntity instanceof TestEntity100Col ? keyTestEntity100ColOrEntity : { KeyTestEntity100Col: keyTestEntity100ColOrEntity! });
  }
}
