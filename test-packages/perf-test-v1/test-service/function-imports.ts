 ...
 */
import { transformReturnValueForEdmTypeV4, transformReturnValueForEdmTypeListV4, transformReturnValueForEntityV4, transformReturnValueForEntityListV4, edmToTsV4, FunctionImportRequestBuilderV4, FunctionImportParameter } from '@sap-cloud-sdk/core';
 ...
 */
export function returnSapCloudSdk(parameters: ReturnSapCloudSdkParameters): FunctionImportRequestBuilderV4<ReturnSapCloudSdkParameters, string | null> {
  const params = {
 ...
 * @returns A request builder that allows to overwrite some of the values and execute the resulting request.
 */
export function concatStrings(parameters: ConcatStringsParameters): FunctionImportRequestBuilderV4<ConcatStringsParameters, string | null> {
  const params = {
 ...
 * @returns A request builder that allows to overwrite some of the values and execute the resulting request.
 */
export function returnInt(parameters: ReturnIntParameters): FunctionImportRequestBuilderV4<ReturnIntParameters, number | null> {
  const params = {
 ...
 * @returns A request builder that allows to overwrite some of the values and execute the resulting request.
 */
export function returnCollection(parameters: ReturnCollectionParameters): FunctionImportRequestBuilderV4<ReturnCollectionParameters, number[]> {
  const params = {
    param: new FunctionImportParameter('param', 'Edm.Int32', parameters.param)
  }

  return new FunctionImportRequestBuilderV4('/odata/test-service', 'returnCollection', (data) => transformReturnValueForEdmTypeListV4(data, (val) => edmToTsV4(val, 'Edm.Int32')), params);
}
 ...
 * @returns A request builder that allows to overwrite some of the values and execute the resulting request.
 */
export function getByKey(parameters: GetByKeyParameters): FunctionImportRequestBuilderV4<GetByKeyParameters, TestEntity | null> {
  const params = {
    param: new FunctionImportParameter('param', 'Edm.Int32', parameters.param)
  }
 ...
 * @returns A request builder that allows to overwrite some of the values and execute the resulting request.
 */
export function getAll(parameters: GetAllParameters): FunctionImportRequestBuilderV4<GetAllParameters, TestEntity[]> {
  const params = {

  }

  return new FunctionImportRequestBuilderV4('/odata/test-service', 'getAll', (data) => transformReturnValueForEntityListV4(data, TestEntity), params);
}
