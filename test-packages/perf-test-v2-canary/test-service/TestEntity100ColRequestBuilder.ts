 ...
 */
export class TestEntity100ColRequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<TestEntity100Col<T>, T> {
  /**
  ...
  getByKey(keyTestEntity100Col: DeserializedType<T, 'Edm.Int32'>): GetByKeyRequestBuilder<TestEntity100Col<T>, T> {
    return new GetByKeyRequestBuilder<TestEntity100Col<T>, T>(this.entityApi, { KeyTestEntity100Col: keyTestEntity100Col });
  }
  ...
  getAll(): GetAllRequestBuilder<TestEntity100Col<T>, T> {
    return new GetAllRequestBuilder<TestEntity100Col<T>, T>(this.entityApi);
  }
  ...
  create(entity: TestEntity100Col<T>): CreateRequestBuilder<TestEntity100Col<T>, T> {
    return new CreateRequestBuilder<TestEntity100Col<T>, T>(this.entityApi, entity);
  }
  ...
  update(entity: TestEntity100Col<T>): UpdateRequestBuilder<TestEntity100Col<T>, T> {
    return new UpdateRequestBuilder<TestEntity100Col<T>, T>(this.entityApi, entity);
  }
  ...
  delete(keyTestEntity100ColOrEntity: any): DeleteRequestBuilder<TestEntity100Col<T>, T> {
    return new DeleteRequestBuilder<TestEntity100Col<T>, T>(this.entityApi, keyTestEntity100ColOrEntity instanceof TestEntity100Col ? keyTestEntity100ColOrEntity : { KeyTestEntity100Col: keyTestEntity100ColOrEntity! });
  }
}
