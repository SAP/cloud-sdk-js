...
class TestEntity50ColApi {
    ...
    requestBuilder() {
        return new TestEntity50ColRequestBuilder_1.TestEntity50ColRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v4_1.FieldBuilder(TestEntity50Col_1.TestEntity50Col, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
             ...
             */
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v4_1.AllFields('*', TestEntity50Col_1.TestEntity50Col)
            };
        }
        return this._schema;
    }
