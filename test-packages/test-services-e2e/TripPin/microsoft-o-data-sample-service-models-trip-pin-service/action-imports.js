...
function resetDataSource(parameters, deSerializers = odata_v4_1.defaultDeSerializers) {
    const params = {};
    return new odata_v4_1.ActionImportRequestBuilder('VALUE_IS_UNDEFINED', 'ResetDataSource', data => (0, odata_v4_1.transformReturnValueForUndefined)(data, val => undefined), params, deSerializers);
}
