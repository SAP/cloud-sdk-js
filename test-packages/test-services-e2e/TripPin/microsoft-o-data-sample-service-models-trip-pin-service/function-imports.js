...
function getNearestAirport(parameters, deSerializers = odata_v4_1.defaultDeSerializers) {
    ...
    return new odata_v4_1.FunctionImportRequestBuilder('VALUE_IS_UNDEFINED', 'GetNearestAirport', data => (0, odata_v4_1.transformReturnValueForEntity)(data, (0, service_1.microsoftODataSampleServiceModelsTripPinService)(deSerializers)
