...
export function microsoftODataSampleServiceModelsTripPinService<
  BinaryT = string,
  BooleanT = boolean,
  ByteT = number,
  DecimalT = BigNumber,
...
>(
...
): MicrosoftODataSampleServiceModelsTripPinService<
  DeSerializers<
    BinaryT,
    BooleanT,
    ByteT,
  ...
  >
> {
  return new MicrosoftODataSampleServiceModelsTripPinService(
