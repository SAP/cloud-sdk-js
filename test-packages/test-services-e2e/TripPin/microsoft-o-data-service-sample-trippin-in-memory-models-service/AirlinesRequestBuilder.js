...
var AirlinesRequestBuilder = /** @class */ (function (_super) {
    ...
    AirlinesRequestBuilder.prototype.getByKey = function (airlineCode) {
        return new odata_v4_1.GetByKeyRequestBuilder(Airlines_1.Airlines, { AirlineCode: airlineCode });
    };
    /**
    ...
    AirlinesRequestBuilder.prototype.delete = function (airlineCodeOrEntity) {
        return new odata_v4_1.DeleteRequestBuilder(Airlines_1.Airlines, airlineCodeOrEntity instanceof Airlines_1.Airlines ? airlineCodeOrEntity : { AirlineCode: airlineCodeOrEntity });
    };
