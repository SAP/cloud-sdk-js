...
(function (Airports) {
    var _fieldBuilder = new odata_common_1.FieldBuilder(Airports);
    /**
     * Static representation of the [[icaoCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Airports.ICAO_CODE = _fieldBuilder.buildEdmTypeField('IcaoCode', 'Edm.String', false);
    /**
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Airports.IATA_CODE = _fieldBuilder.buildEdmTypeField('IataCode', 'Edm.String', false);
    /**
     * Static representation of the [[location]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Airports.LOCATION = _fieldBuilder.buildComplexTypeField('Location', AirportLocation_1.AirportLocationField, false);
    /**
