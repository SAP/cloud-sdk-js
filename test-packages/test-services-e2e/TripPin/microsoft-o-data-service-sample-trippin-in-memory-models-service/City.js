...
var CityField = /** @class */ (function (_super) {
    ...
    function CityField(fieldName, fieldOf, fieldOptions) {
        var _this = _super.call(this, fieldName, fieldOf, City, fieldOptions) || this;
         ...
         */
        _this.countryRegion = _this._fieldBuilder.buildEdmTypeField('CountryRegion', 'Edm.String', false);
        /**
         * Representation of the [[City.name]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.name = _this._fieldBuilder.buildEdmTypeField('Name', 'Edm.String', false);
        /**
         * Representation of the [[City.region]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.region = _this._fieldBuilder.buildEdmTypeField('Region', 'Edm.String', false);
        return _this;
    }
    return CityField;
