...
var EventLocationField = /** @class */ (function (_super) {
    ...
    function EventLocationField(fieldName, fieldOf, fieldOptions) {
        var _this = _super.call(this, fieldName, fieldOf, EventLocation, fieldOptions) || this;
         ...
         */
        _this.buildingInfo = _this._fieldBuilder.buildEdmTypeField('BuildingInfo', 'Edm.String', true);
        /**
         * Representation of the [[EventLocation.address]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.address = _this._fieldBuilder.buildEdmTypeField('Address', 'Edm.String', false);
        /**
         * Representation of the [[EventLocation.city]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.city = _this._fieldBuilder.buildComplexTypeField('City', City_1.CityField, false);
        return _this;
    }
