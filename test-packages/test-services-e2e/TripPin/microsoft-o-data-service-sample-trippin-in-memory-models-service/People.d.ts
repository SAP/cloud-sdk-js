...
import { AllFields, CollectionField, CustomFieldV4, EdmTypeField, EntityBuilderType, EntityV4, EnumField, Field, OneToManyLink, OneToOneLink, OrderableEdmTypeField } from '@sap-cloud-sdk/core';
/**
...
export declare namespace People {
     ...
     */
    const _allFields: Array<EdmTypeField<People, 'Edm.String', false, true> | CollectionField<People, 'Edm.String', true, true> | CollectionField<People, Location, true, true> | EnumField<People, PersonGender, true, true> | OrderableEdmTypeField<People, 'Edm.Int64', false, true> | OneToManyLink<People, People> | OneToOneLink<People, Photos>>;
    /**
     * All fields selector.
     */
