...
import { AllFields, CollectionField, Constructable, CustomFieldV4, EdmTypeField, EntityBuilderType, EntityV4, EnumField, Field, FieldBuilder, OneToManyLink, OneToOneLink, OrderableEdmTypeField } from '@sap-cloud-sdk/core';
...
export namespace People {
  const _fieldBuilder: FieldBuilder<Constructable<People>> = new FieldBuilder(People);
  /**
   * Static representation of the [[userName]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const USER_NAME = _fieldBuilder.buildEdmTypeField('UserName', 'Edm.String', false);
  /**
   * Static representation of the [[firstName]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const FIRST_NAME = _fieldBuilder.buildEdmTypeField('FirstName', 'Edm.String', false);
  /**
   * Static representation of the [[lastName]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const LAST_NAME = _fieldBuilder.buildEdmTypeField('LastName', 'Edm.String', false);
  /**
   * Static representation of the [[emails]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const EMAILS = _fieldBuilder.buildCollectionField('Emails', 'Edm.String', true);
  /**
   * Static representation of the [[addressInfo]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const ADDRESS_INFO = _fieldBuilder.buildCollectionField('AddressInfo', Location, true);
  /**
   * Static representation of the [[gender]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const GENDER = _fieldBuilder.buildEnumField('Gender', PersonGender, true);
  /**
   * Static representation of the [[concurrency]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const CONCURRENCY = _fieldBuilder.buildEdmTypeField('Concurrency', 'Edm.Int64', false);
  /**
   ...
   */
  export const _allFields: Array<EdmTypeField<People, 'Edm.String', false, true> | CollectionField<People, 'Edm.String', true, true> | CollectionField<People, Location, true, true> | EnumField<People, PersonGender, true, true> | OrderableEdmTypeField<People, 'Edm.Int64', false, true> | OneToManyLink<People, People> | OneToOneLink<People, Photos>> = [
    People.USER_NAME,
    People.FIRST_NAME,
    People.LAST_NAME,
    People.EMAILS,
   ...
   */
  export const _keyFields: Array<Field<People, boolean, boolean>> = [People.USER_NAME];
  /**
   * Mapping of all key field names to the respective static field property People.
   */
  export const _keys: { [keys: string]: Field<People, boolean, boolean> } = People._keyFields.reduce((acc: { [keys: string]: Field<People, boolean, boolean> }, field: Field<People, boolean, boolean>) => {
