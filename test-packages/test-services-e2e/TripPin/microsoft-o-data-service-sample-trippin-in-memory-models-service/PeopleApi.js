...
class PeopleApi {
    ...
    get schema() {
        const fieldBuilder = new internal_1.FieldBuilder(People_1.People, this.deSerializers);
        return {
            /**
         ...
         */
             ...
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
            ADDRESS_INFO: fieldBuilder.buildCollectionField('AddressInfo', Location_1.Location, true),
            /**
             * Static representation of the [[gender]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
            GENDER: fieldBuilder.buildEnumField('Gender', PersonGender_1.PersonGender, true),
            /**
