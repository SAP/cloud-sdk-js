...
function resetDataSource(parameters) {
    var params = {};
    return new core_1.ActionImportRequestBuilder('TripPinRESTierService/(S(duh2c3dgb1c5lzc0bqwgyekc))/', 'ResetDataSource', function (data) { return core_1.transformReturnValueForUndefined(data, function (val) { return undefined; }); }, params);
}
