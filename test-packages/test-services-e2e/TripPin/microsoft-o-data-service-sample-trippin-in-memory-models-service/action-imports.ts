...
import { ActionImportRequestBuilder, ActionImportParameter, transformReturnValueForUndefined } from '@sap-cloud-sdk/odata-v4';
...
export function resetDataSource(parameters: ResetDataSourceParameters): ActionImportRequestBuilder<ResetDataSourceParameters, undefined> {
  ...
  return new ActionImportRequestBuilder('V4/(S(duh2c3dgb1c5lzc0bqwgyekc))/TripPinServiceRW/', 'ResetDataSource', (data) => transformReturnValueForUndefined(data, (val) => undefined), params);
}
