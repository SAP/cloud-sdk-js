...
function getNearestAirport(parameters) {
    ...
    return new core_1.FunctionImportRequestBuilderV4('V4/(S(duh2c3dgb1c5lzc0bqwgyekc))/TripPinServiceRW/', 'GetNearestAirport', function (data) { return (0, core_1.transformReturnValueForEntityV4)(data, Airports_1.Airports); }, params);
}
