...
function getNearestAirport(parameters) {
    ...
    return new core_1.FunctionImportRequestBuilderV4('TripPinServiceRW', 'GetNearestAirport', function (data) { return core_1.transformReturnValueForEntityV4(data, Airports_1.Airports); }, params);
}
