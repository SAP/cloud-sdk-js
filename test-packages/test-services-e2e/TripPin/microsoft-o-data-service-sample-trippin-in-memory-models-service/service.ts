...
import { resetDataSource_4, ResetDataSource4Parameters } from './action-imports';
...
class MicrosoftODataServiceSampleTrippinInMemoryModelsService<DeSerializersT extends DeSerializers = DefaultDeSerializers> {
    ...
    get airportsApi(): AirportsApi<DeSerializersT> { 
      ...
      get actionImports( ) {
        return {resetDataSource_4:(parameter:ResetDataSource4Parameters<DeSerializersT>)=>resetDataSource_4(parameter,this.deSerializers)}
      }
