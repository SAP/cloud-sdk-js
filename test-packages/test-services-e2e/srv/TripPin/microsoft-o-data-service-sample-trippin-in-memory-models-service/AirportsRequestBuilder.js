...
var AirportsRequestBuilder = /** @class */ (function (_super) {
    ...
    AirportsRequestBuilder.prototype.getByKey = function (icaoCode) {
        return new v4_1.GetByKeyRequestBuilder(Airports_1.Airports, { IcaoCode: icaoCode });
    };
    /**
    ...
    AirportsRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(Airports_1.Airports);
    };
    /**
    ...
    AirportsRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(Airports_1.Airports, entity);
    };
    /**
    ...
    AirportsRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(Airports_1.Airports, entity);
    };
    AirportsRequestBuilder.prototype.delete = function (icaoCodeOrEntity) {
        return new v4_1.DeleteRequestBuilder(Airports_1.Airports, icaoCodeOrEntity instanceof Airports_1.Airports ? icaoCodeOrEntity : { IcaoCode: icaoCodeOrEntity });
    };
