...
export declare namespace NewComePeople {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const EMAILS: CollectionField<NewComePeople>;
    /**
     * Static representation of the [[addressInfo]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const ADDRESS_INFO: CollectionField<NewComePeople>;
    /**
     ...
     */
    const _allFields: Array<StringField<NewComePeople> | BigNumberField<NewComePeople> | CollectionField<NewComePeople> | LocationField<NewComePeople>>;
    /**
     * All fields selector.
     */
