 ...
 */
export declare function batch(...requests: (ReadAdminServiceRequestBuilder | BatchChangeSet<WriteAdminServiceRequestBuilder>)[]): BatchRequestBuilder;
/**
 * Change set constructor consists of write operations supported on the Admin Service.
 * @param requests The requests of the change set
 * @returns A change set for batch.
 */
export declare function changeset(...requests: WriteAdminServiceRequestBuilder[]): BatchChangeSet<WriteAdminServiceRequestBuilder>;
