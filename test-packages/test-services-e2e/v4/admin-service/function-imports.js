...
function returnSapCloudSdk2(parameters) {
    ...
    return new core_1.FunctionImportRequestBuilderV4('/admin', 'returnSapCloudSdk2', function (data) { return core_1.transformReturnValueForEdmTypeV4(data, function (val) { return core_1.edmToTsV4(val.value, 'Edm.String'); }); }, params);
}
