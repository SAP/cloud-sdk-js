...
class TestEntity extends odata_v4_1.Entity {
    ...
    boundFunctionWithoutArgumentsComplexReturnType(parameters, deSerializers) {
        const params = {};
        return new odata_v4_1.BoundOperationRequestBuilder(this._entityApi, this, 'boundFunctionWithoutArgumentsComplexReturnType', data => (0, odata_v4_1.transformReturnValueForComplexType)(data, data => (0, odata_v4_1.entityDeserializer)(deSerializers || odata_v4_1.defaultDeSerializers).deserializeComplexType(data, MyComplexReturnType_1.MyComplexReturnType)), params, deSerializers || odata_v4_1.defaultDeSerializers, 'function');
    }
    /**
