 ...
 */
export class TestEntity50ColRequestBuilder<
...
> extends RequestBuilder<TestEntity50Col<T>, T> {
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<TestEntity50Col<T>, T>(this.entityApi, {
  ...
  create(
    ...
    return new CreateRequestBuilder<TestEntity50Col<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<TestEntity50Col<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    keyTestEntity50ColOrEntity: any
  ): DeleteRequestBuilder<TestEntity50Col<T>, T> {
    return new DeleteRequestBuilder<TestEntity50Col<T>, T>(
      this.entityApi,
      keyTestEntity50ColOrEntity instanceof TestEntity50Col
