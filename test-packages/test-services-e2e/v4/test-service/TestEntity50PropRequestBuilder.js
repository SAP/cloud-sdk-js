...
class TestEntity50PropRequestBuilder extends odata_v4_1.RequestBuilder {
    ...
    getByKey(keyTestEntity50Prop) {
        return new odata_v4_1.GetByKeyRequestBuilder(this.entityApi, { KeyTestEntity50Prop: keyTestEntity50Prop });
    }
    /**
    ...
    delete(keyTestEntity50PropOrEntity) {
        return new odata_v4_1.DeleteRequestBuilder(this.entityApi, keyTestEntity50PropOrEntity instanceof TestEntity50Prop_1.TestEntity50Prop ? keyTestEntity50PropOrEntity : { KeyTestEntity50Prop: keyTestEntity50PropOrEntity });
    }
}
