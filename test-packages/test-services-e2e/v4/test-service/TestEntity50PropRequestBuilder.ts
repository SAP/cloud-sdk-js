...
> extends RequestBuilder<TestEntity50Prop<T>, T> {
  ...
  create(
    ...
    return new CreateRequestBuilder<TestEntity50Prop<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<TestEntity50Prop<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    keyTestEntity50PropOrEntity: any
  ): DeleteRequestBuilder<TestEntity50Prop<T>, T> {
    return new DeleteRequestBuilder<TestEntity50Prop<T>, T>(
      this.entityApi,
      keyTestEntity50PropOrEntity instanceof TestEntity50Prop
