...
export declare namespace TestEntityLink {
     ...
     */
    const KEY_TEST_ENTITY_LINK: OrderableEdmTypeField<TestEntityLink, "Edm.Int32", false, true>;
    /**
     * Static representation of the [[keyToTestEntity]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const KEY_TO_TEST_ENTITY: OrderableEdmTypeField<TestEntityLink, "Edm.Int32", false, true>;
    /**
     ...
     */
    const _allFields: Array<OrderableEdmTypeField<TestEntityLink, 'Edm.Int32', false, true> | EdmTypeField<TestEntityLink, 'Edm.String', true, true>>;
    /**
     * All fields selector.
     */
