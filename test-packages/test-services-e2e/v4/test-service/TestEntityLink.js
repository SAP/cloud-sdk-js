...
(function (TestEntityLink) {
     ...
     */
    TestEntityLink.KEY_TEST_ENTITY_LINK = new core_1.NumberField('KeyTestEntityLink', TestEntityLink, 'Edm.Int32');
    /**
     * Static representation of the [[keyToTestEntity]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityLink.KEY_TO_TEST_ENTITY = new core_1.NumberField('KeyToTestEntity', TestEntityLink, 'Edm.Int32');
    /**
     * Static representation of the [[stringProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityLink.STRING_PROPERTY = new core_1.StringField('StringProperty', TestEntityLink, 'Edm.String');
    /**
     ...
     */
    TestEntityLink._keyFields = [TestEntityLink.KEY_TEST_ENTITY_LINK, TestEntityLink.KEY_TO_TEST_ENTITY];
    /**
     * Mapping of all key field names to the respective static field property TestEntityLink.
     */
    TestEntityLink._keys = TestEntityLink._keyFields.reduce(function (acc, field) {
