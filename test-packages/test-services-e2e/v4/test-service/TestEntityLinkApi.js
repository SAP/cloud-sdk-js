...
class TestEntityLinkApi {
    ...
    get schema() {
        const fieldBuilder = new internal_1.FieldBuilder(TestEntityLink_1.TestEntityLink, this.deSerializers);
        return {
            /**
         ...
         */
             ...
             * All fields selector.
             */
            ALL_FIELDS: new internal_1.AllFields('*', TestEntityLink_1.TestEntityLink)
        };
    }
}
