...
var TestEntityLinkRequestBuilder = /** @class */ (function (_super) {
    ...
    TestEntityLinkRequestBuilder.prototype.getByKey = function (keyTestEntityLink, keyToTestEntity) {
        return new odata_v4_1.GetByKeyRequestBuilder(TestEntityLink_1.TestEntityLink, {
    ...
    TestEntityLinkRequestBuilder.prototype.create = function (entity) {
        return new odata_v4_1.CreateRequestBuilder(TestEntityLink_1.TestEntityLink, entity);
    };
    /**
    ...
    TestEntityLinkRequestBuilder.prototype.update = function (entity) {
        return new odata_v4_1.UpdateRequestBuilder(TestEntityLink_1.TestEntityLink, entity);
    };
    TestEntityLinkRequestBuilder.prototype.delete = function (keyTestEntityLinkOrEntity, keyToTestEntity) {
        return new odata_v4_1.DeleteRequestBuilder(TestEntityLink_1.TestEntityLink, keyTestEntityLinkOrEntity instanceof TestEntityLink_1.TestEntityLink ? keyTestEntityLinkOrEntity : {
