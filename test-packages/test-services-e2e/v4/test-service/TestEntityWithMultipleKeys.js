...
class TestEntityWithMultipleKeys extends odata_v4_1.Entity {
    ...
    concatStrings(Str2) {
        ...
        const deSerializers = odata_v4_1.defaultDeSerializers;
        return new odata_v4_1.BoundFunctionRequestBuilder(this._entityApi, this, 'TestService.concatStrings', (data) => data, params, deSerializers);
    }
    getAll() {
        const params = {};
        const deSerializers = odata_v4_1.defaultDeSerializers;
        return new odata_v4_1.BoundFunctionRequestBuilder(this._entityApi, this, 'TestService.getAll', (data) => data, params, deSerializers);
    }
    getByKey() {
        const params = {};
        const deSerializers = odata_v4_1.defaultDeSerializers;
        return new odata_v4_1.BoundFunctionRequestBuilder(this._entityApi, this, 'TestService.getByKey', (data) => data, params, deSerializers);
    }
    getByKeyWithMultipleKeys(StringPropertyWithMultipleKeys, BooleanPropertyWithMultipleKeys) {
        const params = {
            StringPropertyWithMultipleKeys: new odata_v4_1.FunctionImportParameter('StringPropertyWithMultipleKeys', 'Edm.String', StringPropertyWithMultipleKeys),
            BooleanPropertyWithMultipleKeys: new odata_v4_1.FunctionImportParameter('BooleanPropertyWithMultipleKeys', 'Edm.Boolean', BooleanPropertyWithMultipleKeys),
        };
        const deSerializers = odata_v4_1.defaultDeSerializers;
        return new odata_v4_1.BoundFunctionRequestBuilder(this._entityApi, this, 'TestService.getByKeyWithMultipleKeys', (data) => data, params, deSerializers);
    }
    returnCollection() {
        const params = {};
        const deSerializers = odata_v4_1.defaultDeSerializers;
        return new odata_v4_1.BoundFunctionRequestBuilder(this._entityApi, this, 'TestService.returnCollection', (data) => data, params, deSerializers);
    }
    returnInt() {
        const params = {};
        const deSerializers = odata_v4_1.defaultDeSerializers;
        return new odata_v4_1.BoundFunctionRequestBuilder(this._entityApi, this, 'TestService.returnInt', (data) => data, params, deSerializers);
    }
    returnKey() {
        const params = {};
        const deSerializers = odata_v4_1.defaultDeSerializers;
    ...
    returnSapCloudSdk() {
        const params = {};
        const deSerializers = odata_v4_1.defaultDeSerializers;
        return new odata_v4_1.BoundFunctionRequestBuilder(this._entityApi, this, 'TestService.returnSapCloudSdk', (data) => data, params, deSerializers);
    }
    ...
    boundActionWithoutArgumentsWithMultipleKeys() {
        const params = {};
        const deSerializers = odata_v4_1.defaultDeSerializers;
        return new odata_v4_1.BoundActionRequestBuilder(this._entityApi, this, 'TestService.boundActionWithoutArgumentsWithMultipleKeys', (data) => data, params, deSerializers);
    }
    deleteEntity() {
        const params = {};
        const deSerializers = odata_v4_1.defaultDeSerializers;
        return new odata_v4_1.BoundActionRequestBuilder(this._entityApi, this, 'TestService.deleteEntity', (data) => data, params, deSerializers);
    }
