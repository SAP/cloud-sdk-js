 ...
 */
export declare class TestEntityWithMultipleKeysRequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<TestEntityWithMultipleKeys<T>, T> {
    /**
