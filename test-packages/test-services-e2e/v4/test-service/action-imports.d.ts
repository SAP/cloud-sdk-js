 ...
 */
export declare function createTestEntityById_4<DeSerializersT extends DeSerializers = DefaultDeSerializers>(parameters: CreateTestEntityById4Parameters<DeSerializersT>, deSerializers?: DeSerializersT): ActionImportRequestBuilder<DeSerializersT, CreateTestEntityById4Parameters<DeSerializersT>, TestEntity>;
/**
 ...
 * @returns A request builder that allows to overwrite some of the values and execute the resulting request.
 */
export declare function createTestEntityByIdReturnId_4<DeSerializersT extends DeSerializers = DefaultDeSerializers>(parameters: CreateTestEntityByIdReturnId4Parameters<DeSerializersT>, deSerializers?: DeSerializersT): ActionImportRequestBuilder<DeSerializersT, CreateTestEntityByIdReturnId4Parameters<DeSerializersT>, number>;
