...
exports.actionImports = exports.createTestEntityByIdReturnId_4 = exports.createTestEntityById_4 = void 0;
/*
 ...
 */
function createTestEntityById_4(parameters, deSerializers = odata_v4_1.defaultDeSerializers) {
    const params = {
 ...
 * @returns A request builder that allows to overwrite some of the values and execute the resulting request.
 */
function createTestEntityByIdReturnId_4(parameters, deSerializers = odata_v4_1.defaultDeSerializers) {
    const params = {
        id: new odata_v4_1.ActionImportParameter('id', 'Edm.Int32', parameters.id)
    };
