...
function createTestEntity(parameters) {
    ...
    return new core_1.ActionImportRequestBuilder('/test-service', 'createTestEntity', function (data) { return core_1.transformReturnValueForEntityV4(data, TestEntity_1.TestEntity); }, params);
}
...
function createTestEntityReturnId(parameters) {
    ...
    return new core_1.ActionImportRequestBuilder('/test-service', 'createTestEntityReturnId', function (data) { return core_1.transformReturnValueForEdmTypeV4(data, function (val) { return core_1.edmToTsV4(val.value, 'Edm.Int32'); }); }, params);
}
