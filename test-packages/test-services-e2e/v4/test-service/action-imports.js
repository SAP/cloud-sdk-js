...
function createTestEntityByIdReturnId(parameters, deSerializers = odata_v4_1.defaultDeSerializers) {
    ...
    return new odata_v4_1.ActionImportRequestBuilder('/odata/test-service', 'createTestEntityByIdReturnId', (data) => (0, odata_v4_1.transformReturnValueForEdmType)(data, (val) => (0, odata_v4_1.edmToTs)(val.value, 'Edm.Int32')), params, deSerializers);
}
