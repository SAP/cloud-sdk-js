...
function createTestEntityById(parameters) {
    ...
    return new core_1.ActionImportRequestBuilder('/odata/test-service', 'createTestEntityById', function (data) { return (0, core_1.transformReturnValueForEntityV4)(data, TestEntity_1.TestEntity); }, params);
}
...
function createTestEntityByIdReturnId(parameters) {
    ...
    return new core_1.ActionImportRequestBuilder('/odata/test-service', 'createTestEntityByIdReturnId', function (data) { return (0, core_1.transformReturnValueForEdmTypeV4)(data, function (val) { return (0, core_1.edmToTsV4)(val.value, 'Edm.Int32'); }); }, params);
}
