...
function createTestEntityById(parameters) {
    ...
    return new odata_v4_1.ActionImportRequestBuilder('/odata/test-service', 'createTestEntityById', function (data) { return (0, odata_v4_1.transformReturnValueForEntity)(data, TestEntity_1.TestEntity); }, params);
}
...
function createTestEntityByIdReturnId(parameters) {
    ...
    return new odata_v4_1.ActionImportRequestBuilder('/odata/test-service', 'createTestEntityByIdReturnId', function (data) { return (0, odata_v4_1.transformReturnValueForEdmType)(data, function (val) { return (0, odata_v4_1.edmToTsV4)(val.value, 'Edm.Int32'); }); }, params);
}
