 ...
 */
import { transformReturnValueForEntity, transformReturnValueForEdmType, edmToTsV4, ActionImportRequestBuilder, ActionImportParameter } from '@sap-cloud-sdk/core';
...
export function createTestEntityReturnId(parameters: CreateTestEntityReturnIdParameters): ActionImportRequestBuilder<CreateTestEntityReturnIdParameters, number> {
  ...
  return new ActionImportRequestBuilder('/odata/test-service', 'createTestEntityReturnId', (data) => transformReturnValueForEdmType(data, (val) => edmToTsV4(val.value, 'Edm.Int32')), params);
}
