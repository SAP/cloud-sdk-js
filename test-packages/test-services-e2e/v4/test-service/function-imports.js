...
function concatStrings(parameters, deSerializers = odata_v4_1.defaultDeSerializers) {
    ...
    return new odata_v4_1.FunctionImportRequestBuilder('/odata/test-service', 'concatStrings', (data) => (0, odata_v4_1.transformReturnValueForEdmType)(data, (val) => (0, odata_v4_1.edmToTs)(val.value, 'Edm.String')), params, deSerializers);
}
...
function returnCollection(parameters, deSerializers = odata_v4_1.defaultDeSerializers) {
    ...
    return new odata_v4_1.FunctionImportRequestBuilder('/odata/test-service', 'returnCollection', (data) => (0, odata_v4_1.transformReturnValueForEdmTypeList)(data, (val) => (0, odata_v4_1.edmToTs)(val, 'Edm.Int32')), params, deSerializers);
}
...
function returnInt(parameters, deSerializers = odata_v4_1.defaultDeSerializers) {
    ...
    return new odata_v4_1.FunctionImportRequestBuilder('/odata/test-service', 'returnInt', (data) => (0, odata_v4_1.transformReturnValueForEdmType)(data, (val) => (0, odata_v4_1.edmToTs)(val.value, 'Edm.Int32')), params, deSerializers);
}
...
function returnSapCloudSdk(parameters, deSerializers = odata_v4_1.defaultDeSerializers) {
    const params = {};
    return new odata_v4_1.FunctionImportRequestBuilder('/odata/test-service', 'returnSapCloudSdk', (data) => (0, odata_v4_1.transformReturnValueForEdmType)(data, (val) => (0, odata_v4_1.edmToTs)(val.value, 'Edm.String')), params, deSerializers);
}
