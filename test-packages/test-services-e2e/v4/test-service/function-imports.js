...
function returnInt(parameters) {
    ...
    return new core_1.FunctionImportRequestBuilderV4('/odata/test-service', 'returnInt', function (data) { return core_1.transformReturnValueForEdmType(data, function (val) { return core_1.edmToTs(val.value, 'Edm.Int32'); }); }, params);
}
...
function returnSapCloudSdk(parameters) {
    var params = {};
    return new core_1.FunctionImportRequestBuilderV4('/odata/test-service', 'returnSapCloudSdk', function (data) { return core_1.transformReturnValueForEdmType(data, function (val) { return core_1.edmToTs(val.value, 'Edm.String'); }); }, params);
}
...
function concatStrings(parameters) {
    ...
    return new core_1.FunctionImportRequestBuilderV4('/odata/test-service', 'concatStrings', function (data) { return core_1.transformReturnValueForEdmType(data, function (val) { return core_1.edmToTs(val.value, 'Edm.String'); }); }, params);
}
