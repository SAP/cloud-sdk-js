...
import { edmToTsV4, FunctionImportRequestBuilder, transformReturnValueForEdmType, transformReturnValueForEntityList, transformReturnValueForEntity, transformReturnValueForEdmTypeList } from '@sap-cloud-sdk/odata-v4';
...
export function concatStrings(parameters: ConcatStringsParameters): FunctionImportRequestBuilder<ConcatStringsParameters, string> {
  ...
  return new FunctionImportRequestBuilder('/odata/test-service', 'concatStrings', (data) => transformReturnValueForEdmType(data, (val) => edmToTsV4(val.value, 'Edm.String')), params);
}
 ...
 * @returns A request builder that allows to overwrite some of the values and execute the resulting request.
 */
export function getAll(parameters: GetAllParameters): FunctionImportRequestBuilder<GetAllParameters, TestEntity[]> {
  const params = {

  }

  return new FunctionImportRequestBuilder('/odata/test-service', 'getAll', (data) => transformReturnValueForEntityList(data, TestEntity), params);
}
 ...
 * @returns A request builder that allows to overwrite some of the values and execute the resulting request.
 */
export function returnCollection(parameters: ReturnCollectionParameters): FunctionImportRequestBuilder<ReturnCollectionParameters, number[]> {
  const params = {
    param: new FunctionImportParameter('param', 'Edm.Int32', parameters.param)
  }

  return new FunctionImportRequestBuilder('/odata/test-service', 'returnCollection', (data) => transformReturnValueForEdmTypeList(data, (val) => edmToTsV4(val, 'Edm.Int32')), params);
}
...
export function returnInt(parameters: ReturnIntParameters): FunctionImportRequestBuilder<ReturnIntParameters, number> {
  ...
  return new FunctionImportRequestBuilder('/odata/test-service', 'returnInt', (data) => transformReturnValueForEdmType(data, (val) => edmToTsV4(val.value, 'Edm.Int32')), params);
}
...
export function returnSapCloudSdk(parameters: ReturnSapCloudSdkParameters): FunctionImportRequestBuilder<ReturnSapCloudSdkParameters, string> {
  ...
  return new FunctionImportRequestBuilder('/odata/test-service', 'returnSapCloudSdk', (data) => transformReturnValueForEdmType(data, (val) => edmToTsV4(val.value, 'Edm.String')), params);
}
