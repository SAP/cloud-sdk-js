...
import { CreateTestEntityById4Parameters, CreateTestEntityByIdReturnId4Parameters } from './action-imports';
...
declare class TestService<DeSerializersT extends DeSerializers = DefaultDeSerializers> {
    ...
    get actionImports(): {
        createTestEntityById_4: (parameter: CreateTestEntityById4Parameters<DeSerializersT>) => import("@sap-cloud-sdk/odata-v4").ActionImportRequestBuilder<DeSerializersT, CreateTestEntityById4Parameters<DeSerializersT>, import("./TestEntity").TestEntity<DefaultDeSerializers>>;
        createTestEntityByIdReturnId_4: (parameter: CreateTestEntityByIdReturnId4Parameters<DeSerializersT>) => import("@sap-cloud-sdk/odata-v4").ActionImportRequestBuilder<DeSerializersT, CreateTestEntityByIdReturnId4Parameters<DeSerializersT>, number>;
    };
