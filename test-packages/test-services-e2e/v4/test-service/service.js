...
class TestService {
    ...
    get actionImports() {
        return { createTestEntityById_4: (parameter) => (0, action_imports_1.createTestEntityById_4)(parameter, this.deSerializers), createTestEntityByIdReturnId_4: (parameter) => (0, action_imports_1.createTestEntityByIdReturnId_4)(parameter, this.deSerializers) };
    }
    get batch() {
