...
export declare class CaseTestApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements EntityApi<CaseTest<DeSerializersT>, DeSerializersT> {
    ...
    private _schema?;
    get schema(): {
        KEY_PROPERTY_STRING: OrderableEdmTypeField<CaseTest<DeSerializers<any, any, any, any, any, any, any, any, any, any, any, any, any, any, any, any, any>>, DeSerializersT, "Edm.String", false, true>;
