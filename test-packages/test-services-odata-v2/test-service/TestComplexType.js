...
class TestComplexTypeField extends odata_v2_1.ComplexTypeField {
     ...
     * Use to reference this property in query operations such as 'filter' in the fluent request API.
     */
    timeProperty = this._fieldBuilder.buildEdmTypeField('TimeProperty', 'Edm.Time', true);
    /**
     * Representation of the {@link TestComplexType.dateTimeProperty} property for query construction.
     * Use to reference this property in query operations such as 'filter' in the fluent request API.
     */
    dateTimeProperty = this._fieldBuilder.buildEdmTypeField('DateTimeProperty', 'Edm.DateTime', true);
    /**
