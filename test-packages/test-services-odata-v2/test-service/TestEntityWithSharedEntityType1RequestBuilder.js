...
class TestEntityWithSharedEntityType1RequestBuilder extends odata_v2_1.RequestBuilder {
    ...
    delete(keyPropertyOrEntity) {
        return new odata_v2_1.DeleteRequestBuilder(this.entityApi, keyPropertyOrEntity instanceof TestEntityWithSharedEntityType1_1.TestEntityWithSharedEntityType1
            ? keyPropertyOrEntity
