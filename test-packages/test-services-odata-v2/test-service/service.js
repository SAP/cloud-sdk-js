...
class TestService {
    ...
    get functionImports() {
        return {
            ...
            testFunctionImportUnsupportedEdmTypes: (parameter) => (0, function_imports_1.testFunctionImportUnsupportedEdmTypes)(parameter, this.deSerializers),
            ...
            testFunctionImportGet: (parameter) => (0, function_imports_1.testFunctionImportGet)(parameter, this.deSerializers),
            testFunctionImportPost: (parameter) => (0, function_imports_1.testFunctionImportPost)(parameter, this.deSerializers),
