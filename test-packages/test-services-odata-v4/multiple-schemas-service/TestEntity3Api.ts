...
import { CustomField, defaultDeSerializers, DefaultDeSerializers, DeSerializers, AllFields, entityBuilder, EntityBuilderType, EntityApi, FieldBuilder, EdmTypeField, EnumField } from '@sap-cloud-sdk/odata-v4';
export class TestEntity3Api<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _schema?: {
    KEY_PROPERTY_STRING: EdmTypeField<TestEntity3<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
