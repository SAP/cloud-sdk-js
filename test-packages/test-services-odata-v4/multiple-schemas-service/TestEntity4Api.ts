...
export class TestEntity4Api<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _schema?: {
    KEY_PROPERTY_STRING: EdmTypeField<TestEntity4<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
BOOLEAN_PROPERTY: EdmTypeField<TestEntity4<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
