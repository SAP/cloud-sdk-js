...
import { CustomField, defaultDeSerializers, DefaultDeSerializers, DeSerializers, AllFields, entityBuilder, EntityBuilderType, EntityApi, FieldBuilder, Time, EdmTypeField, OrderableEdmTypeField, CollectionField, EnumField, OneToManyLink, OneToOneLink } from '@sap-cloud-sdk/odata-v4';
export class TestEntityApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _schema?: {
    KEY_PROPERTY_GUID: EdmTypeField<TestEntity<DeSerializers>, DeSerializersT, 'Edm.Guid', false, true>,
KEY_PROPERTY_STRING: EdmTypeField<TestEntity<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
STRING_PROPERTY: EdmTypeField<TestEntity<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BOOLEAN_PROPERTY: EdmTypeField<TestEntity<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
GUID_PROPERTY: EdmTypeField<TestEntity<DeSerializers>, DeSerializersT, 'Edm.Guid', true, true>,
