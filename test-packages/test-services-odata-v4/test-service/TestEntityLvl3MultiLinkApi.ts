...
export class TestEntityLvl3MultiLinkApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _schema?: {
    STRING_PROPERTY: EdmTypeField<TestEntityLvl3MultiLink<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
GUID_PROPERTY: EdmTypeField<TestEntityLvl3MultiLink<DeSerializers>, DeSerializersT, 'Edm.Guid', true, true>,
KEY_PROPERTY: EdmTypeField<TestEntityLvl3MultiLink<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
