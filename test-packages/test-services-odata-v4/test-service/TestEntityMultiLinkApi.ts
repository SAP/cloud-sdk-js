...
export class TestEntityMultiLinkApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _schema?: {
    STRING_PROPERTY: EdmTypeField<TestEntityMultiLink<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BOOLEAN_PROPERTY: EdmTypeField<TestEntityMultiLink<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
GUID_PROPERTY: EdmTypeField<TestEntityMultiLink<DeSerializers>, DeSerializersT, 'Edm.Guid', true, true>,
INT_16_PROPERTY: OrderableEdmTypeField<TestEntityMultiLink<DeSerializers>, DeSerializersT, 'Edm.Int16', true, true>,
KEY_PROPERTY: EdmTypeField<TestEntityMultiLink<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
/**
 * Static representation of the one-to-many navigation property [[toMultiLink1]] for query construction.
 * Use to reference this property in query operations such as 'select' in the fluent request API.
 */
