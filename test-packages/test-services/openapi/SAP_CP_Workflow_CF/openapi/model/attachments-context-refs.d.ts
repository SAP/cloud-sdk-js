 ...
 * @export
 * @interface AttachmentsContextRefs
 */
export interface AttachmentsContextRefs {
    /**
     * ID of the file in the remote repository
     * @type {string}
     * @memberof AttachmentsContextRefs
     */
    objectId?: string;
}
//# sourceMappingURL=attachments-context-refs.d.ts.map