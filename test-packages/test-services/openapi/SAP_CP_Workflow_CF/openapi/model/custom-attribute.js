...
exports.CustomAttributeTypeEnum = void 0;
/**
    * @export
    * @enum {string}
    */
var CustomAttributeTypeEnum;
(function (CustomAttributeTypeEnum) {
    CustomAttributeTypeEnum["String"] = "string";
})(CustomAttributeTypeEnum = exports.CustomAttributeTypeEnum || (exports.CustomAttributeTypeEnum = {}));
