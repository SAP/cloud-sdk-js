 ...
 * @export
 * @interface FormMetadataWorkflowDefinitions
 */
export interface FormMetadataWorkflowDefinitions {
    /**
     * ID of the workflow definition
     * @type {string}
     * @memberof FormMetadataWorkflowDefinitions
     */
    Id?: string;
}
//# sourceMappingURL=form-metadata-workflow-definitions.d.ts.map