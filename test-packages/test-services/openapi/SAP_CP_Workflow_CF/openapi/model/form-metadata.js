...
exports.FormMetadataTypeEnum = void 0;
/**
    * @export
    * @enum {string}
    */
var FormMetadataTypeEnum;
(function (FormMetadataTypeEnum) {
    FormMetadataTypeEnum["Start"] = "start";
    FormMetadataTypeEnum["Task"] = "task";
})(FormMetadataTypeEnum = exports.FormMetadataTypeEnum || (exports.FormMetadataTypeEnum = {}));
