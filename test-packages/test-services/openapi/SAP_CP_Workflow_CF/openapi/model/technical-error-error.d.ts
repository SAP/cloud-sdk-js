 ...
 */
import { TechnicalErrorErrorDetails } from './technical-error-error-details';
/**
 *
 * @export
 * @interface TechnicalErrorError
 */
export interface TechnicalErrorError {
    /**
     * The error category.
     * @type {string}
     * @memberof TechnicalErrorError
     */
    code?: string;
    /**
     * The error message.
    ...
    /**
     *
     * @type {Array<TechnicalErrorErrorDetails>}
     * @memberof TechnicalErrorError
     */
    details?: Array<TechnicalErrorErrorDetails>;
}
//# sourceMappingURL=technical-error-error.d.ts.map