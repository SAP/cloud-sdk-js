 ...
 *
 * @export
 * @interface WorkflowInstanceErrorMessage
 */
export interface WorkflowInstanceErrorMessage {
    /**
     * The ID of the model element where the error occurred. The ID is at most 255 characters long.
     * @type {string}
     * @memberof WorkflowInstanceErrorMessage
     */
    activityId?: string;
    /**
...
//# sourceMappingURL=workflow-instance-error-message.d.ts.map