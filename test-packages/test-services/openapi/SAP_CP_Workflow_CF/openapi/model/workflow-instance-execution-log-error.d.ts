 ...
 *
 * @export
 * @interface WorkflowInstanceExecutionLogError
 */
export interface WorkflowInstanceExecutionLogError {
    /**
     * The error message.
     * @type {string}
     * @memberof WorkflowInstanceExecutionLogError
     */
    message?: string;
    /**
     * The error category.
...
//# sourceMappingURL=workflow-instance-execution-log-error.d.ts.map