...
exports.DefaultApi = {
     ...
     */
    postEntity: function (pathParam, queryParameters) { return new openapi_1.OpenApiRequestBuilder('post', '/entities/{pathParam}', {
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    patchEntity: function (pathParam, body) { return new openapi_1.OpenApiRequestBuilder('patch', '/entities/{pathParam}', {
        pathParameters: { pathParam: pathParam },
        body: body
    }); }
};
