        ...
        return __generator(this, function (_a) {
          ...
          if (pathParam === null || pathParam === undefined) {
            throw new base_1.RequiredError(
              'pathParam',
              'Required parameter pathParam was null or undefined when calling patchEntity.'
            );
          }
          localVarPath = '/entities/{pathParam}'.replace(
            '{' + 'pathParam' + '}',
            encodeURIComponent(String(pathParam))
          );
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          if (pathParam === null || pathParam === undefined) {
            throw new base_1.RequiredError(
              'pathParam',
              'Required parameter pathParam was null or undefined when calling postEntity.'
            );
          }
          localVarPath = '/entities/{pathParam}'.replace(
            '{' + 'pathParam' + '}',
            ...
            case 0:
              return [
                ...
                exports
                  ...
                  .patchEntity(pathParam, testEntity, options)
              ];
            case 1:
          ...
          switch (_a.label) {
            case 0:
              return [
                ...
                exports
                  .DefaultApiAxiosParamCreator(configuration)
                  .postEntity(pathParam, queryParam, options)
              ];
            case 1:
              localVarAxiosArgs = _a.sent();
              return [
