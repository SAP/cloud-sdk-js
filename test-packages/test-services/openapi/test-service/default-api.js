...
exports.DefaultApi = {
     ...
     */
    noTag: function () { return new openapi_1.OpenApiRequestBuilder('get', '/test-cases/default-tag'); },
    /**
     * Create a request builder for execution of post requests to the '/test-cases/default-tag' endpoint.
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    defaultTag: function () { return new openapi_1.OpenApiRequestBuilder('post', '/test-cases/default-tag'); }
};
