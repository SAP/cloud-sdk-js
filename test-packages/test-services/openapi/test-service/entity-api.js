...
exports.EntityApi = {
     ...
     */
    getAllEntities: function (queryParameters) { return new openapi_1.OpenApiRequestBuilder('get', '/entities', {
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    updateEntityWithPut: function (body) { return new openapi_1.OpenApiRequestBuilder('put', '/entities', {
        body: body
    }); },
    /**
     * Create entity
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    createEntity: function (body) { return new openapi_1.OpenApiRequestBuilder('post', '/entities', {
        body: body
    }); },
    /**
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    updateEntity: function (body) { return new openapi_1.OpenApiRequestBuilder('patch', '/entities', {
        body: body
    }); },
    /**
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    deleteEntity: function (body) { return new openapi_1.OpenApiRequestBuilder('delete', '/entities', {
        body: body
    }); },
    /**
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    headEntities: function () { return new openapi_1.OpenApiRequestBuilder('head', '/entities'); },
    /**
     * Get entity by id
     * @param entityId - Key property of the entity
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    getEntityByKey: function (entityId) { return new openapi_1.OpenApiRequestBuilder('get', '/entities/{entityId}', {
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    countEntities: function () { return new openapi_1.OpenApiRequestBuilder('get', '/entities/count'); }
};
