...
exports.EntityApi = {
  ...
  getAllEntities: queryParameters =>
    new openapi_1.OpenApiRequestBuilder('get', '/entities', {
      queryParameters
    }),
  /**
   ...
   * @returns The request builder, use the `execute()` method to trigger the request.
   */
  updateEntityWithPut: body =>
    new openapi_1.OpenApiRequestBuilder('put', '/entities', {
      body
    }),
  /**
   * Create entity
   ...
   */
  createEntity: body =>
    new openapi_1.OpenApiRequestBuilder('post', '/entities', {
      body
    }),
  /**
   ...
   */
  updateEntity: body =>
    new openapi_1.OpenApiRequestBuilder('patch', '/entities', {
      body
    }),
  /**
   ...
   */
  deleteEntity: body =>
    new openapi_1.OpenApiRequestBuilder('delete', '/entities', {
      body
    }),
  /**
   ...
   * @returns The request builder, use the `execute()` method to trigger the request.
   */
  getEntityByKey: entityId =>
    new openapi_1.OpenApiRequestBuilder('get', '/entities/{entityId}', {
   ...
   */
  countEntities: () =>
    new openapi_1.OpenApiRequestBuilder('get', '/entities/count')
};
