...
exports.EntityApi = {
  ...
  getAllEntities: function (queryParameters) {
    return new openapi_1.OpenApiRequestBuilder('get', '/entities', {
  ...
  updateEntityWithPut: function (body) {
    return new openapi_1.OpenApiRequestBuilder('put', '/entities', {
      body: body
    });
  },
  /**
  ...
  createEntity: function (body) {
    return new openapi_1.OpenApiRequestBuilder('post', '/entities', {
      body: body
    });
  },
  /**
  ...
  updateEntity: function (body) {
    return new openapi_1.OpenApiRequestBuilder('patch', '/entities', {
      body: body
    });
  },
  /**
  ...
  deleteEntity: function (body) {
    return new openapi_1.OpenApiRequestBuilder('delete', '/entities', {
      body: body
    });
  },
  /**
  ...
  headEntities: function () {
    return new openapi_1.OpenApiRequestBuilder('head', '/entities');
  },
  /**
   * Get entity by id
  ...
  getEntityByKey: function (entityId) {
    return new openapi_1.OpenApiRequestBuilder('get', '/entities/{entityId}', {
  ...
  countEntities: function () {
    return new openapi_1.OpenApiRequestBuilder('get', '/entities/count');
  }
};
