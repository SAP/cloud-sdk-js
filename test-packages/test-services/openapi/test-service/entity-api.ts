...
export const TestServiceEntityApi = {
  ...
  countEntities: () =>
    new OpenApiRequestBuilder<EntityApi, 'countEntities'>(
      EntityApi,
      'countEntities'
    )
};
