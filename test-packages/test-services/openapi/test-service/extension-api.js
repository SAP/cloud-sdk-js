...
exports.ExtensionApi = {
     ...
     */
    niceGetFunction: function () { return new openapi_1.OpenApiRequestBuilder('get', '/test-cases/extension'); },
    /**
     * Create a request builder for execution of post requests to the '/test-cases/extension' endpoint.
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    nicePostFunction: function () { return new openapi_1.OpenApiRequestBuilder('post', '/test-cases/extension'); }
};
