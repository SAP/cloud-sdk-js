    ...
    getEntityByKey: function (entityId, options) {
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          localVarPath = '/entities/{entityId}'.replace(
            '{' + 'entityId' + '}',
          ...
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                exports
                  .EntityApiAxiosParamCreator(configuration)
...
var EntityApi = /** @class */ (function (_super) {
  ...
  EntityApi.prototype.countEntities = function (options) {
    var _this = this;
    return exports
      .EntityApiFp(this.configuration)
      .countEntities(options)
      .then(function (request) {
   ...
   * @memberof EntityApi
   */
  EntityApi.prototype.getAllEntities = function (
    stringParameter,
    integerParameter,
    $dollarParameter,
    dotParameter,
