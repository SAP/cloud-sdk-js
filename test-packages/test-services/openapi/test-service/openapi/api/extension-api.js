          ...
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                exports
                  .ExtensionApiAxiosParamCreator(configuration)
                  .niceGetFunction(options)
              ];
            case 1:
...
var ExtensionApi = /** @class */ (function (_super) {
  ...
  ExtensionApi.prototype.niceGetFunction = function (options) {
    var _this = this;
    return exports
      .ExtensionApiFp(this.configuration)
      .niceGetFunction(options)
      .then(function (request) {
