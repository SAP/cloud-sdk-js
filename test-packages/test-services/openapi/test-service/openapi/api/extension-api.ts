 ...
 * @export
 */
export const ExtensionApiAxiosParamCreator = function (
...
export const ExtensionApiFp = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    async niceGetFunction(
      options?: any
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await ExtensionApiAxiosParamCreator(
        configuration
 ...
 * @export
 */
export const ExtensionApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    niceGetFunction(options?: any): AxiosPromise<void> {
      return ExtensionApiFp(configuration)
        .niceGetFunction(options)
...
export class ExtensionApi extends BaseAPI {
  ...
  public niceGetFunction(options?: any) {
    return ExtensionApiFp(this.configuration)
      .niceGetFunction(options)
