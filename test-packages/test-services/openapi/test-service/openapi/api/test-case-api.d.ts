 ...
 * @export
 */
export declare const TestCaseApiAxiosParamCreator: (
  ...
  testCaseGetRequiredParameters: (
    ...
    simpleTestEntity?: SimpleTestEntity | undefined,
    options?: any
  ) => Promise<RequestArgs>;
  /**
   *
 ...
 * @export
 */
export declare const TestCaseApiFp: (
  configuration?: Configuration | undefined
) => {
  /**
   *
 ...
 * @export
 */
export declare const TestCaseApiFactory: (
  configuration?: Configuration | undefined,
  basePath?: string | undefined,
  axios?: AxiosInstance | undefined
) => {
