...
export declare const TestCaseApi: {
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    useNameWithSymbols: (body: SimpleTestEntityWITHSymbols | undefined) => OpenApiRequestBuilder<any>;
    /**
     * Create a request builder for execution of get requests to the '/test-cases/schema-name-integer' endpoint.
     * @param body - Request body.
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    schemaNameInteger: (body: Schema123456 | undefined) => OpenApiRequestBuilder<any>;
    /**
