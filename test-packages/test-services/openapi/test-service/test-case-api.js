...
exports.TestCaseApi = {
     ...
     */
    testCaseGetRequiredParameters: function (requiredPathItemPathParam, body, queryParameters) { return new openapi_1.OpenApiRequestBuilder('get', '/test-cases/parameters/required-parameters/{requiredPathItemPathParam}', {
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    testCasePostRequiredParameters: function (requiredPathItemPathParam, body, queryParameters) { return new openapi_1.OpenApiRequestBuilder('post', '/test-cases/parameters/required-parameters/{requiredPathItemPathParam}', {
        pathParameters: { requiredPathItemPathParam: requiredPathItemPathParam },
        body: body,
        queryParameters: queryParameters
    }); },
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    testCaseGetDuplicateParameters: function (duplicateParam, queryParameters) { return new openapi_1.OpenApiRequestBuilder('get', '/test-cases/parameters/{duplicateParam}', {
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    duplicateOperationId: function () { return new openapi_1.OpenApiRequestBuilder('get', '/test-cases/duplicate-operation-ids'); },
    /**
     * Create a request builder for execution of put requests to the '/test-cases/duplicate-operation-ids' endpoint.
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    duplicateOperationId1_1: function () { return new openapi_1.OpenApiRequestBuilder('put', '/test-cases/duplicate-operation-ids'); },
    /**
     * Create a request builder for execution of post requests to the '/test-cases/duplicate-operation-ids' endpoint.
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    duplicateOperationId_1: function () { return new openapi_1.OpenApiRequestBuilder('post', '/test-cases/duplicate-operation-ids'); },
    /**
     * Create a request builder for execution of patch requests to the '/test-cases/duplicate-operation-ids' endpoint.
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    duplicateOperationId1: function () { return new openapi_1.OpenApiRequestBuilder('patch', '/test-cases/duplicate-operation-ids'); },
    /**
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    export: function (const1, queryParameters) { return new openapi_1.OpenApiRequestBuilder('get', '/test-cases/reserved-keywords/{const1}', {
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    complexSchemas: function (body) { return new openapi_1.OpenApiRequestBuilder('get', '/test-cases/complex-schemas', {
        body: body
    }); },
    /**
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    useNameWithSymbols: function (body) { return new openapi_1.OpenApiRequestBuilder('post', '/test-cases/complex-schemas', {
        body: body
    }); },
    /**
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    schemaNameInteger: function (body) { return new openapi_1.OpenApiRequestBuilder('get', '/test-cases/schema-name-integer', {
        body: body
    }); },
    /**
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    getTestCasesNoOperationId: function () { return new openapi_1.OpenApiRequestBuilder('get', '/test-cases/no-operation-id'); }
};
