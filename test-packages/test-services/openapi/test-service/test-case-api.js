...
exports.TestCaseApi = {
   ...
   * @returns The request builder, use the `execute()` method to trigger the request.
   */
  testCaseGetDuplicateParameters: (duplicateParam, queryParameters) =>
    new openapi_1.OpenApiRequestBuilder(
      'get',
   ...
   */
  complexSchemas: body =>
    new openapi_1.OpenApiRequestBuilder('get', '/test-cases/complex-schemas', {
      body
    }),
  /**
   ...
   * @returns The request builder, use the `execute()` method to trigger the request.
   */
  useNameWithSymbols: body =>
    new openapi_1.OpenApiRequestBuilder('post', '/test-cases/complex-schemas', {
      body
    }),
  /**
  ...
  getTestCasesNoOperationId: () =>
    new openapi_1.OpenApiRequestBuilder('get', '/test-cases/no-operation-id')
};
