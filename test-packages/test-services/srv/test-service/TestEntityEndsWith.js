...
var TestEntityEndsWith = /** @class */ (function (_super) {
    ...
    TestEntityEndsWith.builder = function () {
        return cloud_sdk_core_1.Entity.entityBuilder(TestEntityEndsWith);
    };
    /**
    ...
    TestEntityEndsWith.customField = function (fieldName) {
        return cloud_sdk_core_1.Entity.customFieldSelector(fieldName, TestEntityEndsWith);
    };
    /**
...
(function (TestEntityEndsWith) {
     ...
     */
    TestEntityEndsWith.KEY_PROPERTY = new cloud_sdk_core_1.StringField('KeyProperty', TestEntityEndsWith, 'Edm.String');
    /**
     ...
     * All fields selector.
     */
    TestEntityEndsWith.ALL_FIELDS = new cloud_sdk_core_1.AllFields('*', TestEntityEndsWith);
    /**
...
})(TestEntityEndsWith = exports.TestEntityEndsWith || (exports.TestEntityEndsWith = {}));
exports.TestEntityEndsWith = TestEntityEndsWith;
