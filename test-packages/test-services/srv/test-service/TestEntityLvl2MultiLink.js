...
var TestEntityLvl2MultiLink = /** @class */ (function (_super) {
    ...
    TestEntityLvl2MultiLink.builder = function () {
        return cloud_sdk_core_1.Entity.entityBuilder(TestEntityLvl2MultiLink);
    };
    /**
    ...
    TestEntityLvl2MultiLink.customField = function (fieldName) {
        return cloud_sdk_core_1.Entity.customFieldSelector(fieldName, TestEntityLvl2MultiLink);
    };
    /**
...
(function (TestEntityLvl2MultiLink) {
     ...
     */
    TestEntityLvl2MultiLink.KEY_PROPERTY = new cloud_sdk_core_1.StringField('KeyProperty', TestEntityLvl2MultiLink, 'Edm.String');
    /**
     * Static representation of the [[stringProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityLvl2MultiLink.STRING_PROPERTY = new cloud_sdk_core_1.StringField('StringProperty', TestEntityLvl2MultiLink, 'Edm.String');
    /**
     * Static representation of the [[booleanProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityLvl2MultiLink.BOOLEAN_PROPERTY = new cloud_sdk_core_1.BooleanField('BooleanProperty', TestEntityLvl2MultiLink, 'Edm.Boolean');
    /**
     * Static representation of the [[guidProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityLvl2MultiLink.GUID_PROPERTY = new cloud_sdk_core_1.StringField('GuidProperty', TestEntityLvl2MultiLink, 'Edm.Guid');
    /**
     * Static representation of the [[int16Property]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityLvl2MultiLink.INT_16_PROPERTY = new cloud_sdk_core_1.NumberField('Int16Property', TestEntityLvl2MultiLink, 'Edm.Int16');
    /**
     ...
     * All fields selector.
     */
    TestEntityLvl2MultiLink.ALL_FIELDS = new cloud_sdk_core_1.AllFields('*', TestEntityLvl2MultiLink);
    /**
