...
import { AllFields, BooleanField, CustomField, Entity, EntityBuilderType, NumberField, ODataV2, Selectable, StringField } from '@sap-cloud-sdk/core';
/**
...
export declare namespace TestEntityLvl2SingleLink {
     ...
     */
    const _allFields: Array<StringField<TestEntityLvl2SingleLink> | BooleanField<TestEntityLvl2SingleLink> | NumberField<TestEntityLvl2SingleLink>>;
    /**
     * All fields selector.
     */
