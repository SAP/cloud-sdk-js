...
var TestEntitySingleLink = /** @class */ (function (_super) {
    ...
    TestEntitySingleLink.builder = function () {
        return v4_1.Entity.entityBuilder(TestEntitySingleLink);
    };
    /**
    ...
    TestEntitySingleLink.customField = function (fieldName) {
        return v4_1.Entity.customFieldSelector(fieldName, TestEntitySingleLink);
    };
    /**
...
(function (TestEntitySingleLink) {
     ...
     */
    TestEntitySingleLink.STRING_PROPERTY = new v4_1.StringField('StringProperty', TestEntitySingleLink, 'Edm.String');
    /**
     * Static representation of the [[booleanProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntitySingleLink.BOOLEAN_PROPERTY = new v4_1.BooleanField('BooleanProperty', TestEntitySingleLink, 'Edm.Boolean');
    /**
     * Static representation of the [[guidProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntitySingleLink.GUID_PROPERTY = new v4_1.StringField('GuidProperty', TestEntitySingleLink, 'Edm.Guid');
    /**
     * Static representation of the [[int16Property]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntitySingleLink.INT_16_PROPERTY = new v4_1.NumberField('Int16Property', TestEntitySingleLink, 'Edm.Int16');
    /**
     * Static representation of the [[keyProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntitySingleLink.KEY_PROPERTY = new v4_1.StringField('KeyProperty', TestEntitySingleLink, 'Edm.String');
    /**
     * Static representation of the one-to-many navigation property [[toMultiLink]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntitySingleLink.TO_MULTI_LINK = new v4_1.OneToManyLink('to_MultiLink', TestEntitySingleLink, TestEntityLvl2MultiLink_1.TestEntityLvl2MultiLink);
    /**
     * Static representation of the one-to-one navigation property [[toSingleLink]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntitySingleLink.TO_SINGLE_LINK = new v4_1.OneToOneLink('to_SingleLink', TestEntitySingleLink, TestEntityLvl2SingleLink_1.TestEntityLvl2SingleLink);
    /**
     ...
     * All fields selector.
     */
    TestEntitySingleLink.ALL_FIELDS = new v4_1.AllFields('*', TestEntitySingleLink);
    /**
