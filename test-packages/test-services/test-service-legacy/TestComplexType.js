...
(function (TestComplexType) {
  function build(json) {
    return core_1.createComplexType(json, {
      ...
      BooleanProperty: function (booleanProperty) {
        return {
          booleanProperty: core_1.edmToTs(booleanProperty, 'Edm.Boolean')
        };
      },
      GuidProperty: function (guidProperty) {
        return { guidProperty: core_1.edmToTs(guidProperty, 'Edm.Guid') };
      },
      Int16Property: function (int16Property) {
        return { int16Property: core_1.edmToTs(int16Property, 'Edm.Int16') };
      },
      Int32Property: function (int32Property) {
        return { int32Property: core_1.edmToTs(int32Property, 'Edm.Int32') };
      },
      Int64Property: function (int64Property) {
        return { int64Property: core_1.edmToTs(int64Property, 'Edm.Int64') };
      },
      DecimalProperty: function (decimalProperty) {
        return {
          decimalProperty: core_1.edmToTs(decimalProperty, 'Edm.Decimal')
        };
      },
      SingleProperty: function (singleProperty) {
        return { singleProperty: core_1.edmToTs(singleProperty, 'Edm.Single') };
      },
      DoubleProperty: function (doubleProperty) {
        return { doubleProperty: core_1.edmToTs(doubleProperty, 'Edm.Double') };
      },
      FloatProperty: function (floatProperty) {
        return { floatProperty: core_1.edmToTs(floatProperty, 'Edm.Float') };
      },
      TimeProperty: function (timeProperty) {
        return { timeProperty: core_1.edmToTs(timeProperty, 'Edm.Time') };
      },
      DateTimeProperty: function (dateTimeProperty) {
        return {
          dateTimeProperty: core_1.edmToTs(dateTimeProperty, 'Edm.DateTime')
        };
      },
      DateTimeOffSetProperty: function (dateTimeOffSetProperty) {
        return {
          dateTimeOffSetProperty: core_1.edmToTs(
            dateTimeOffSetProperty,
            'Edm.DateTimeOffset'
          )
        };
      },
      ByteProperty: function (byteProperty) {
        return { byteProperty: core_1.edmToTs(byteProperty, 'Edm.Byte') };
      },
      SByteProperty: function (sByteProperty) {
        return { sByteProperty: core_1.edmToTs(sByteProperty, 'Edm.SByte') };
      },
