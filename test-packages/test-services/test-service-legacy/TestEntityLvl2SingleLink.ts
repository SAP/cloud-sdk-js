...
export namespace TestEntityLvl2SingleLink {
   ...
   */
  export const _keyFields: Array<Selectable<TestEntityLvl2SingleLink>> = [
    TestEntityLvl2SingleLink.KEY_PROPERTY
  ];
  /**
  ...
  export const _keys: {
    ...
    (
      acc: { [keys: string]: Selectable<TestEntityLvl2SingleLink> },
      field: Selectable<TestEntityLvl2SingleLink>
    ) => {
