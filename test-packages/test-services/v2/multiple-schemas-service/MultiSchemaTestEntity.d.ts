...
export declare namespace MultiSchemaTestEntity {
     ...
     */
    const KEY_PROPERTY: EdmTypeField<MultiSchemaTestEntity, "Edm.String", false, true>;
    /**
     * All fields of the MultiSchemaTestEntity entity.
     */
    const _allFields: Array<EdmTypeField<MultiSchemaTestEntity, 'Edm.String', false, true>>;
    /**
     * All fields selector.
     */
