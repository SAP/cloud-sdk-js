...
class MultiSchemaTestEntity extends odata_v2_1.Entity {
    ...
    static customField(fieldName) {
        return odata_v2_1.Entity.customFieldSelector(fieldName, MultiSchemaTestEntity);
    }
    /**
...
(function (MultiSchemaTestEntity) {
     ...
     */
    MultiSchemaTestEntity.KEY_PROPERTY = _fieldBuilder.buildEdmTypeField('KeyProperty', 'Edm.String', false);
    /**
     ...
     * All fields selector.
     */
    MultiSchemaTestEntity.ALL_FIELDS = new internal_1.AllFields('*', MultiSchemaTestEntity);
    /**
     ...
     */
    MultiSchemaTestEntity._keys = MultiSchemaTestEntity._keyFields.reduce((acc, field) => {
        acc[field._fieldName] = field;
        return acc;
    }, {});
})(MultiSchemaTestEntity = exports.MultiSchemaTestEntity || (exports.MultiSchemaTestEntity = {}));
