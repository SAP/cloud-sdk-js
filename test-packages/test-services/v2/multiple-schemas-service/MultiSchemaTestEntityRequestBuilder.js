...
class MultiSchemaTestEntityRequestBuilder extends internal_1.RequestBuilder {
    ...
    getByKey(keyProperty) {
        return new odata_v2_1.GetByKeyRequestBuilder(MultiSchemaTestEntity_1.MultiSchemaTestEntity, { KeyProperty: keyProperty });
    }
    /**
     ...
     */
    getAll() {
        return new odata_v2_1.GetAllRequestBuilder(MultiSchemaTestEntity_1.MultiSchemaTestEntity);
    }
    /**
     ...
     */
    create(entity) {
        return new odata_v2_1.CreateRequestBuilder(MultiSchemaTestEntity_1.MultiSchemaTestEntity, entity);
    }
    /**
     ...
     */
    update(entity) {
        return new odata_v2_1.UpdateRequestBuilder(MultiSchemaTestEntity_1.MultiSchemaTestEntity, entity);
    }
    delete(keyPropertyOrEntity) {
        return new odata_v2_1.DeleteRequestBuilder(MultiSchemaTestEntity_1.MultiSchemaTestEntity, keyPropertyOrEntity instanceof MultiSchemaTestEntity_1.MultiSchemaTestEntity ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    }
}
