 ...
 */
export function batch(...requests: Array<ReadTestServiceRequestBuilder | BatchChangeSet<WriteTestServiceRequestBuilder>>): ODataBatchRequestBuilder;
export function batch(requests: Array<ReadTestServiceRequestBuilder | BatchChangeSet<WriteTestServiceRequestBuilder>>): ODataBatchRequestBuilder;
export function batch(first: undefined | ReadTestServiceRequestBuilder | BatchChangeSet<WriteTestServiceRequestBuilder> | Array<ReadTestServiceRequestBuilder | BatchChangeSet<WriteTestServiceRequestBuilder>>, ...rest: Array<ReadTestServiceRequestBuilder | BatchChangeSet<WriteTestServiceRequestBuilder>>): ODataBatchRequestBuilder {
 ...
 */
export function changeset(...requests: Array<WriteTestServiceRequestBuilder>): BatchChangeSet<WriteTestServiceRequestBuilder>;
export function changeset(requests: Array<WriteTestServiceRequestBuilder>): BatchChangeSet<WriteTestServiceRequestBuilder>;
export function changeset(first: undefined | WriteTestServiceRequestBuilder | Array<WriteTestServiceRequestBuilder>, ...rest: Array<WriteTestServiceRequestBuilder>): BatchChangeSet<WriteTestServiceRequestBuilder> {
