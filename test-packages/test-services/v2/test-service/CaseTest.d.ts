 ...
 */
export declare class CaseTest<T extends DeSerializers = DefaultDeSerializers> extends Entity implements CaseTestType<T> {
    /**
...
export interface CaseTestType<DeSerializersT extends DeSerializers = DefaultDeSerializers> {
