...
class CaseTestRequestBuilder extends internal_1.RequestBuilder {
    ...
    getByKey(keyPropertyString) {
        return new odata_v2_1.GetByKeyRequestBuilder(CaseTest_1.CaseTest, { KeyPropertyString: keyPropertyString });
    }
    /**
    ...
    delete(keyPropertyStringOrEntity) {
        return new odata_v2_1.DeleteRequestBuilder(CaseTest_1.CaseTest, keyPropertyStringOrEntity instanceof CaseTest_1.CaseTest ? keyPropertyStringOrEntity : { KeyPropertyString: keyPropertyStringOrEntity });
    }
}
