...
var CaseTestRequestBuilder = /** @class */ (function (_super) {
    ...
    CaseTestRequestBuilder.prototype.getByKey = function (keyPropertyString) {
        return new core_1.GetByKeyRequestBuilderV2(CaseTest_1.CaseTest, { KeyPropertyString: keyPropertyString });
    };
    /**
    ...
    CaseTestRequestBuilder.prototype.delete = function (keyPropertyStringOrEntity) {
        return new core_1.DeleteRequestBuilderV2(CaseTest_1.CaseTest, keyPropertyStringOrEntity instanceof CaseTest_1.CaseTest ? keyPropertyStringOrEntity : { KeyPropertyString: keyPropertyStringOrEntity });
    };
