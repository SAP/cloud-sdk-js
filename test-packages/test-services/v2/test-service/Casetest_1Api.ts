...
export class Casetest_1Api<T extends DeSerializers = DefaultDeSerializers>
  implements EntityApi<Casetest_1<T>, T>
{
  ...
  requestBuilder(): Casetest_1RequestBuilder<T> {
    return new Casetest_1RequestBuilder(this);
  }

  entityBuilder(): EntityBuilderType<Casetest_1<T>, T> {
  ...
  ): CustomField<Casetest_1<T>, T, NullableT> {
