 ...
 */
class Casetest_1RequestBuilder extends internal_1.RequestBuilder {
    /**
    ...
    getByKey(keyPropertyString) {
        return new odata_v2_1.GetByKeyRequestBuilder(Casetest_1_1.Casetest_1, { KeyPropertyString: keyPropertyString });
    }
    /**
    ...
    delete(keyPropertyStringOrEntity) {
        return new odata_v2_1.DeleteRequestBuilder(Casetest_1_1.Casetest_1, keyPropertyStringOrEntity instanceof Casetest_1_1.Casetest_1 ? keyPropertyStringOrEntity : { KeyPropertyString: keyPropertyStringOrEntity });
    }
}
