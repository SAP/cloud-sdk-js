...
class Casetest_1RequestBuilder extends internal_1.RequestBuilder {
    ...
    delete(keyPropertyStringOrEntity) {
        return new odata_v2_1.DeleteRequestBuilder(this.entityApi, keyPropertyStringOrEntity instanceof Casetest_1_1.Casetest_1 ? keyPropertyStringOrEntity : { KeyPropertyString: keyPropertyStringOrEntity });
    }
}
