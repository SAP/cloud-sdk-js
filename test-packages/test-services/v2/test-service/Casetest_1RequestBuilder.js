...
var Casetest_1RequestBuilder = /** @class */ (function (_super) {
    ...
    Casetest_1RequestBuilder.prototype.getByKey = function (keyPropertyString) {
        return new core_1.GetByKeyRequestBuilderV2(Casetest_1_1.Casetest_1, { KeyPropertyString: keyPropertyString });
    };
    /**
    ...
    Casetest_1RequestBuilder.prototype.delete = function (keyPropertyStringOrEntity) {
        return new core_1.DeleteRequestBuilderV2(Casetest_1_1.Casetest_1, keyPropertyStringOrEntity instanceof Casetest_1_1.Casetest_1 ? keyPropertyStringOrEntity : { KeyPropertyString: keyPropertyStringOrEntity });
    };
