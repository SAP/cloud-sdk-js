...
import { ComplexTypeField, ConstructorOrField, DeserializedType, EdmTypeField, FieldOptions, OrderableEdmTypeField, PropertyMetadata } from '@sap-cloud-sdk/odata-common/internal';
/**
 * TestComplexType
 */
