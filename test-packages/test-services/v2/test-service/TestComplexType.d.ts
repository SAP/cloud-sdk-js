...
import { ComplexTypeField, ConstructorOrField, EdmTypeField, FieldOptions, FieldType, OrderableEdmTypeField, PropertyMetadata, Time } from '@sap-cloud-sdk/odata-common/internal';
/**
 * TestComplexType
 */
