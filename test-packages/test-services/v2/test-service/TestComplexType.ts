...
import { ComplexTypeAnyPropertyField, ComplexTypeBigNumberPropertyField, ComplexTypeBooleanPropertyField, ComplexTypeDatePropertyField, ComplexTypeField, ComplexTypeNumberPropertyField, ComplexTypeStringPropertyField, ComplexTypeTimePropertyField, ConstructorOrField, EntityV2, FieldType, PropertyMetadata, Time, deserializeComplexTypeV2 } from '@sap-cloud-sdk/core';
 ...
 */
export class TestComplexTypeField<EntityT extends EntityV2> extends ComplexTypeField<EntityT, TestComplexType> {
  /**
