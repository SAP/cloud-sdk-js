...
import { ComplexTypeField, ConstructorOrField, EdmTypeField, EntityV2, FieldBuilder, FieldOptions, FieldType, OrderableEdmTypeField, PropertyMetadata, Time, deserializeComplexTypeV2 } from '@sap-cloud-sdk/core';
 ...
 */
export class TestComplexTypeField<EntityT extends EntityV2, NullableT extends boolean = false, SelectableT extends boolean = false> extends ComplexTypeField<EntityT, TestComplexType, NullableT, SelectableT> {
