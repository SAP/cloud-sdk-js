...
import { AllFields, EdmTypeField, EntityBuilderType, Field, Link } from '@sap-cloud-sdk/odata-common/internal';
/**
...
export declare namespace TestEntityCircularLinkChild {
     ...
     */
    const _allFields: Array<EdmTypeField<TestEntityCircularLinkChild, 'Edm.String', false, true> | Link<TestEntityCircularLinkChild, TestEntityCircularLinkChild>>;
    /**
     * All fields selector.
     */
