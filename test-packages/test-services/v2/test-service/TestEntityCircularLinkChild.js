...
class TestEntityCircularLinkChild extends odata_v2_1.Entity {
    ...
    static customField(fieldName) {
        return odata_v2_1.Entity.customFieldSelector(fieldName, TestEntityCircularLinkChild);
    }
    /**
...
(function (TestEntityCircularLinkChild) {
    const _fieldBuilder = new internal_1.FieldBuilder(TestEntityCircularLinkChild);
    /**
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityCircularLinkChild.TO_PARENT = new internal_1.Link('to_Parent', TestEntityCircularLinkChild, TestEntityCircularLinkChild);
    /**
     ...
     * All fields selector.
     */
    TestEntityCircularLinkChild.ALL_FIELDS = new internal_1.AllFields('*', TestEntityCircularLinkChild);
    /**
     ...
     */
    TestEntityCircularLinkChild._keys = TestEntityCircularLinkChild._keyFields.reduce((acc, field) => {
