...
class TestEntityCircularLinkChildRequestBuilder extends internal_1.RequestBuilder {
    ...
    getByKey(keyProperty) {
        return new odata_v2_1.GetByKeyRequestBuilder(TestEntityCircularLinkChild_1.TestEntityCircularLinkChild, { KeyProperty: keyProperty });
    }
    /**
     ...
     */
    getAll() {
        return new odata_v2_1.GetAllRequestBuilder(TestEntityCircularLinkChild_1.TestEntityCircularLinkChild);
    }
    /**
     ...
     */
    create(entity) {
        return new odata_v2_1.CreateRequestBuilder(TestEntityCircularLinkChild_1.TestEntityCircularLinkChild, entity);
    }
    /**
     ...
     */
    update(entity) {
        return new odata_v2_1.UpdateRequestBuilder(TestEntityCircularLinkChild_1.TestEntityCircularLinkChild, entity);
    }
    delete(keyPropertyOrEntity) {
        return new odata_v2_1.DeleteRequestBuilder(TestEntityCircularLinkChild_1.TestEntityCircularLinkChild, keyPropertyOrEntity instanceof TestEntityCircularLinkChild_1.TestEntityCircularLinkChild ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    }
}
