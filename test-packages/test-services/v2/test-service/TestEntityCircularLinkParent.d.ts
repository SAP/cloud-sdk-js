 ...
 */
export declare class TestEntityCircularLinkParent extends EntityV2 implements TestEntityCircularLinkParentType {
    /**
...
export declare namespace TestEntityCircularLinkParent {
     ...
     */
    const _allFields: Array<EdmTypeField<TestEntityCircularLinkParent, 'Edm.String', false, true> | Link<TestEntityCircularLinkParent, TestEntityCircularLinkChild>>;
    /**
     * All fields selector.
     */
