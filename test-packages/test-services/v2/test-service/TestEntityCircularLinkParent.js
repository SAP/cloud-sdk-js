...
class TestEntityCircularLinkParent extends odata_v2_1.Entity {
    ...
    static customField(fieldName) {
        return odata_v2_1.Entity.customFieldSelector(fieldName, TestEntityCircularLinkParent);
    }
    /**
...
(function (TestEntityCircularLinkParent) {
    const _fieldBuilder = new internal_1.FieldBuilder(TestEntityCircularLinkParent);
    /**
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityCircularLinkParent.TO_CHILD = new internal_1.Link('to_Child', TestEntityCircularLinkParent, TestEntityCircularLinkChild_1.TestEntityCircularLinkChild);
    /**
     ...
     * All fields selector.
     */
    TestEntityCircularLinkParent.ALL_FIELDS = new internal_1.AllFields('*', TestEntityCircularLinkParent);
    /**
     ...
     */
    TestEntityCircularLinkParent._keys = TestEntityCircularLinkParent._keyFields.reduce((acc, field) => {
