...
(function (TestEntityEndsWith) {
     ...
     */
    TestEntityEndsWith.KEY_PROPERTY = _fieldBuilder.buildEdmTypeField('KeyProperty', 'Edm.String', false);
    /**
     ...
     * All fields selector.
     */
    TestEntityEndsWith.ALL_FIELDS = new internal_1.AllFields('*', TestEntityEndsWith);
    /**
     ...
     */
    TestEntityEndsWith._keys = TestEntityEndsWith._keyFields.reduce((acc, field) => {
