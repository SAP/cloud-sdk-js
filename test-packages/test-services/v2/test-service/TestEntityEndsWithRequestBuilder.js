...
class TestEntityEndsWithRequestBuilder extends internal_1.RequestBuilder {
    ...
    getByKey(keyProperty) {
        return new odata_v2_1.GetByKeyRequestBuilder(TestEntityEndsWith_1.TestEntityEndsWith, { KeyProperty: keyProperty });
    }
    /**
     ...
     */
    getAll() {
        return new odata_v2_1.GetAllRequestBuilder(TestEntityEndsWith_1.TestEntityEndsWith);
    }
    /**
     ...
     */
    create(entity) {
        return new odata_v2_1.CreateRequestBuilder(TestEntityEndsWith_1.TestEntityEndsWith, entity);
    }
    /**
     ...
     */
    update(entity) {
        return new odata_v2_1.UpdateRequestBuilder(TestEntityEndsWith_1.TestEntityEndsWith, entity);
    }
    delete(keyPropertyOrEntity) {
        return new odata_v2_1.DeleteRequestBuilder(TestEntityEndsWith_1.TestEntityEndsWith, keyPropertyOrEntity instanceof TestEntityEndsWith_1.TestEntityEndsWith ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    }
}
