...
class TestEntityEndsWithSomethingElse extends odata_v2_1.Entity {
    ...
    static customField(fieldName) {
        return odata_v2_1.Entity.customFieldSelector(fieldName, TestEntityEndsWithSomethingElse);
    }
    /**
...
(function (TestEntityEndsWithSomethingElse) {
    const _fieldBuilder = new internal_1.FieldBuilder(TestEntityEndsWithSomethingElse);
    /**
     ...
     * All fields selector.
     */
    TestEntityEndsWithSomethingElse.ALL_FIELDS = new internal_1.AllFields('*', TestEntityEndsWithSomethingElse);
    /**
     ...
     */
    TestEntityEndsWithSomethingElse._keys = TestEntityEndsWithSomethingElse._keyFields.reduce((acc, field) => {
