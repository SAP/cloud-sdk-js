...
class TestEntityEndsWithSomethingElseRequestBuilder extends internal_1.RequestBuilder {
    ...
    getByKey(keyProperty) {
        return new odata_v2_1.GetByKeyRequestBuilder(TestEntityEndsWithSomethingElse_1.TestEntityEndsWithSomethingElse, { KeyProperty: keyProperty });
    }
    /**
     ...
     */
    getAll() {
        return new odata_v2_1.GetAllRequestBuilder(TestEntityEndsWithSomethingElse_1.TestEntityEndsWithSomethingElse);
    }
    /**
     ...
     */
    create(entity) {
        return new odata_v2_1.CreateRequestBuilder(TestEntityEndsWithSomethingElse_1.TestEntityEndsWithSomethingElse, entity);
    }
    /**
     ...
     */
    update(entity) {
        return new odata_v2_1.UpdateRequestBuilder(TestEntityEndsWithSomethingElse_1.TestEntityEndsWithSomethingElse, entity);
    }
    delete(keyPropertyOrEntity) {
        return new odata_v2_1.DeleteRequestBuilder(TestEntityEndsWithSomethingElse_1.TestEntityEndsWithSomethingElse, keyPropertyOrEntity instanceof TestEntityEndsWithSomethingElse_1.TestEntityEndsWithSomethingElse ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    }
}
