...
import { AllFields, EdmTypeField, EntityBuilderType, Field, OrderableEdmTypeField } from '@sap-cloud-sdk/odata-common/internal';
/**
...
export declare namespace TestEntityLvl2MultiLink {
     ...
     */
    const _allFields: Array<EdmTypeField<TestEntityLvl2MultiLink, 'Edm.String', false, true> | EdmTypeField<TestEntityLvl2MultiLink, 'Edm.String', true, true> | EdmTypeField<TestEntityLvl2MultiLink, 'Edm.Boolean', true, true> | EdmTypeField<TestEntityLvl2MultiLink, 'Edm.Guid', true, true> | OrderableEdmTypeField<TestEntityLvl2MultiLink, 'Edm.Int16', true, true>>;
    /**
     * All fields selector.
     */
