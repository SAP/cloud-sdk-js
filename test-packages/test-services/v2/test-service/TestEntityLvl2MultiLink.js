...
class TestEntityLvl2MultiLink extends odata_v2_1.Entity {
    ...
    static customField(fieldName) {
        return odata_v2_1.Entity.customFieldSelector(fieldName, TestEntityLvl2MultiLink);
    }
    /**
...
(function (TestEntityLvl2MultiLink) {
     ...
     * All fields selector.
     */
    TestEntityLvl2MultiLink.ALL_FIELDS = new internal_1.AllFields('*', TestEntityLvl2MultiLink);
    /**
     ...
     */
    TestEntityLvl2MultiLink._keys = TestEntityLvl2MultiLink._keyFields.reduce((acc, field) => {
