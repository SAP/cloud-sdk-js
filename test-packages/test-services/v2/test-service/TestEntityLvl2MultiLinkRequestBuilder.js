...
class TestEntityLvl2MultiLinkRequestBuilder extends internal_1.RequestBuilder {
    ...
    getByKey(keyProperty) {
        return new odata_v2_1.GetByKeyRequestBuilder(TestEntityLvl2MultiLink_1.TestEntityLvl2MultiLink, { KeyProperty: keyProperty });
    }
    /**
     ...
     */
    getAll() {
        return new odata_v2_1.GetAllRequestBuilder(TestEntityLvl2MultiLink_1.TestEntityLvl2MultiLink);
    }
    /**
     ...
     */
    create(entity) {
        return new odata_v2_1.CreateRequestBuilder(TestEntityLvl2MultiLink_1.TestEntityLvl2MultiLink, entity);
    }
    /**
     ...
     */
    update(entity) {
        return new odata_v2_1.UpdateRequestBuilder(TestEntityLvl2MultiLink_1.TestEntityLvl2MultiLink, entity);
    }
    delete(keyPropertyOrEntity) {
        return new odata_v2_1.DeleteRequestBuilder(TestEntityLvl2MultiLink_1.TestEntityLvl2MultiLink, keyPropertyOrEntity instanceof TestEntityLvl2MultiLink_1.TestEntityLvl2MultiLink ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    }
}
