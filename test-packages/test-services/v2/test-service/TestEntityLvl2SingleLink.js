...
class TestEntityLvl2SingleLink extends odata_v2_1.Entity {
    ...
    static customField(fieldName) {
        return odata_v2_1.Entity.customFieldSelector(fieldName, TestEntityLvl2SingleLink);
    }
    /**
...
(function (TestEntityLvl2SingleLink) {
     ...
     * All fields selector.
     */
    TestEntityLvl2SingleLink.ALL_FIELDS = new internal_1.AllFields('*', TestEntityLvl2SingleLink);
    /**
     ...
     */
    TestEntityLvl2SingleLink._keys = TestEntityLvl2SingleLink._keyFields.reduce((acc, field) => {
