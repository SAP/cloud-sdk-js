 ...
 */
class TestEntityLvl2SingleLinkRequestBuilder extends internal_1.RequestBuilder {
    /**
    ...
    getByKey(keyProperty) {
        return new odata_v2_1.GetByKeyRequestBuilder(TestEntityLvl2SingleLink_1.TestEntityLvl2SingleLink, { KeyProperty: keyProperty });
    }
    /**
     ...
     */
    getAll() {
        return new odata_v2_1.GetAllRequestBuilder(TestEntityLvl2SingleLink_1.TestEntityLvl2SingleLink);
    }
    /**
     ...
     */
    create(entity) {
        return new odata_v2_1.CreateRequestBuilder(TestEntityLvl2SingleLink_1.TestEntityLvl2SingleLink, entity);
    }
    /**
     ...
     */
    update(entity) {
        return new odata_v2_1.UpdateRequestBuilder(TestEntityLvl2SingleLink_1.TestEntityLvl2SingleLink, entity);
    }
    delete(keyPropertyOrEntity) {
        return new odata_v2_1.DeleteRequestBuilder(TestEntityLvl2SingleLink_1.TestEntityLvl2SingleLink, keyPropertyOrEntity instanceof TestEntityLvl2SingleLink_1.TestEntityLvl2SingleLink ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    }
}
