...
var TestEntityLvl2SingleLinkRequestBuilder = /** @class */ (function (_super) {
    ...
    TestEntityLvl2SingleLinkRequestBuilder.prototype.getByKey = function (keyProperty) {
        return new core_1.GetByKeyRequestBuilderV2(TestEntityLvl2SingleLink_1.TestEntityLvl2SingleLink, { KeyProperty: keyProperty });
    };
    /**
    ...
    TestEntityLvl2SingleLinkRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV2(TestEntityLvl2SingleLink_1.TestEntityLvl2SingleLink);
    };
    /**
    ...
    TestEntityLvl2SingleLinkRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV2(TestEntityLvl2SingleLink_1.TestEntityLvl2SingleLink, entity);
    };
    /**
    ...
    TestEntityLvl2SingleLinkRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV2(TestEntityLvl2SingleLink_1.TestEntityLvl2SingleLink, entity);
    };
    TestEntityLvl2SingleLinkRequestBuilder.prototype.delete = function (keyPropertyOrEntity) {
        return new core_1.DeleteRequestBuilderV2(TestEntityLvl2SingleLink_1.TestEntityLvl2SingleLink, keyPropertyOrEntity instanceof TestEntityLvl2SingleLink_1.TestEntityLvl2SingleLink ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    };
