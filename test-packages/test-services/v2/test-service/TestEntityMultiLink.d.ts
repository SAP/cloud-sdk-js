...
import { AllFields, EdmTypeField, EntityBuilderType, Field, Link, OneToOneLink, OrderableEdmTypeField } from '@sap-cloud-sdk/odata-common/internal';
/**
...
export declare namespace TestEntityMultiLink {
     ...
     */
    const _allFields: Array<EdmTypeField<TestEntityMultiLink, 'Edm.String', false, true> | EdmTypeField<TestEntityMultiLink, 'Edm.String', true, true> | EdmTypeField<TestEntityMultiLink, 'Edm.Boolean', true, true> | EdmTypeField<TestEntityMultiLink, 'Edm.Guid', true, true> | OrderableEdmTypeField<TestEntityMultiLink, 'Edm.Int16', true, true> | Link<TestEntityMultiLink, TestEntityLvl2MultiLink> | OneToOneLink<TestEntityMultiLink, TestEntityLvl2SingleLink>>;
    /**
     * All fields selector.
     */
