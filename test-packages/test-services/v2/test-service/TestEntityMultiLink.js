...
var TestEntityMultiLink = /** @class */ (function (_super) {
    ...
    TestEntityMultiLink.builder = function () {
        return core_1.EntityV2.entityBuilder(TestEntityMultiLink);
    };
    /**
    ...
    TestEntityMultiLink.customField = function (fieldName) {
        return core_1.EntityV2.customFieldSelector(fieldName, TestEntityMultiLink);
    };
    /**
...
(function (TestEntityMultiLink) {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityMultiLink.STRING_PROPERTY = new core_1.StringField('StringProperty', TestEntityMultiLink, 'Edm.String');
    /**
     * Static representation of the [[booleanProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityMultiLink.BOOLEAN_PROPERTY = new core_1.BooleanField('BooleanProperty', TestEntityMultiLink, 'Edm.Boolean');
    /**
     * Static representation of the [[guidProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityMultiLink.GUID_PROPERTY = new core_1.StringField('GuidProperty', TestEntityMultiLink, 'Edm.Guid');
    /**
     * Static representation of the [[int16Property]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityMultiLink.INT_16_PROPERTY = new core_1.NumberField('Int16Property', TestEntityMultiLink, 'Edm.Int16');
    /**
     * Static representation of the one-to-many navigation property [[toMultiLink]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityMultiLink.TO_MULTI_LINK = new core_1.Link('to_MultiLink', TestEntityMultiLink, TestEntityLvl2MultiLink_1.TestEntityLvl2MultiLink);
    /**
     * Static representation of the one-to-one navigation property [[toSingleLink]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityMultiLink.TO_SINGLE_LINK = new core_1.OneToOneLink('to_SingleLink', TestEntityMultiLink, TestEntityLvl2SingleLink_1.TestEntityLvl2SingleLink);
    /**
     ...
     * All fields selector.
     */
    TestEntityMultiLink.ALL_FIELDS = new core_1.AllFields('*', TestEntityMultiLink);
    /**
