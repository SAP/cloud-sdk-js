...
import { EdmTypeField, OrderableEdmTypeField, Link, OneToOneLink, AllFields, CustomField, entityBuilder, EntityBuilderType, EntityApi, FieldBuilder, Time } from '@sap-cloud-sdk/odata-common/internal';
