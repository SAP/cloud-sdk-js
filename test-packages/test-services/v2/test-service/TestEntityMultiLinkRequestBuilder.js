 ...
 */
class TestEntityMultiLinkRequestBuilder extends internal_1.RequestBuilder {
    /**
    ...
    getByKey(keyProperty) {
        return new odata_v2_1.GetByKeyRequestBuilder(TestEntityMultiLink_1.TestEntityMultiLink, { KeyProperty: keyProperty });
    }
    /**
     ...
     */
    getAll() {
        return new odata_v2_1.GetAllRequestBuilder(TestEntityMultiLink_1.TestEntityMultiLink);
    }
    /**
     ...
     */
    create(entity) {
        return new odata_v2_1.CreateRequestBuilder(TestEntityMultiLink_1.TestEntityMultiLink, entity);
    }
    /**
     ...
     */
    update(entity) {
        return new odata_v2_1.UpdateRequestBuilder(TestEntityMultiLink_1.TestEntityMultiLink, entity);
    }
    delete(keyPropertyOrEntity) {
        return new odata_v2_1.DeleteRequestBuilder(TestEntityMultiLink_1.TestEntityMultiLink, keyPropertyOrEntity instanceof TestEntityMultiLink_1.TestEntityMultiLink ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    }
}
