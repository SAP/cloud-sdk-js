...
class TestEntityOtherMultiLink extends odata_v2_1.Entity {
    ...
    static customField(fieldName) {
        return odata_v2_1.Entity.customFieldSelector(fieldName, TestEntityOtherMultiLink);
    }
    /**
...
(function (TestEntityOtherMultiLink) {
    const _fieldBuilder = new internal_1.FieldBuilder(TestEntityOtherMultiLink);
    /**
     * Static representation of the [[keyProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityOtherMultiLink.KEY_PROPERTY = _fieldBuilder.buildEdmTypeField('KeyProperty', 'Edm.String', false);
    /**
     ...
     * All fields selector.
     */
    TestEntityOtherMultiLink.ALL_FIELDS = new internal_1.AllFields('*', TestEntityOtherMultiLink);
    /**
     ...
     */
    TestEntityOtherMultiLink._keys = TestEntityOtherMultiLink._keyFields.reduce((acc, field) => {
        acc[field._fieldName] = field;
        return acc;
    }, {});
})(TestEntityOtherMultiLink = exports.TestEntityOtherMultiLink || (exports.TestEntityOtherMultiLink = {}));
