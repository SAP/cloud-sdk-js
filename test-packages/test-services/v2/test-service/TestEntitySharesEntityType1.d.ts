 ...
 */
export declare class TestEntitySharesEntityType1 extends EntityV2 implements TestEntitySharesEntityType1Type {
    /**
     ...
     * @returns A builder that constructs instances of entity type `TestEntitySharesEntityType1`.
     */
    static customField(fieldName: string): CustomFieldV2<TestEntitySharesEntityType1>;
    /**
...
export declare namespace TestEntitySharesEntityType1 {
     ...
     */
    const KEY_PROPERTY: StringField<TestEntitySharesEntityType1>;
    /**
     * All fields of the TestEntitySharesEntityType1 entity.
     */
    const _allFields: Array<StringField<TestEntitySharesEntityType1>>;
    /**
     * All fields selector.
     */
