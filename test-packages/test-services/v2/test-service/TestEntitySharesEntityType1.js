...
var TestEntitySharesEntityType1 = /** @class */ (function (_super) {
  ...
  TestEntitySharesEntityType1.builder = function () {
    return core_1.EntityV2.entityBuilder(TestEntitySharesEntityType1);
  };
  /**
   ...
   */
  TestEntitySharesEntityType1._defaultServicePath =
...
(function (TestEntitySharesEntityType1) {
   ...
   */
  TestEntitySharesEntityType1.KEY_PROPERTY = new core_1.StringField(
    'KeyProperty',
    TestEntitySharesEntityType1,
    'Edm.String'
  );
   ...
   * All fields selector.
   */
  TestEntitySharesEntityType1.ALL_FIELDS = new core_1.AllFields(
    '*',
    TestEntitySharesEntityType1
  );
  /**
   ...
   */
  TestEntitySharesEntityType1._keyFields = [
    TestEntitySharesEntityType1.KEY_PROPERTY
  ];
  /**
   * Mapping of all key field names to the respective static field property TestEntitySharesEntityType1.
   */
  TestEntitySharesEntityType1._keys = TestEntitySharesEntityType1._keyFields.reduce(
    function (acc, field) {
  ...
  (TestEntitySharesEntityType1 =
    exports.TestEntitySharesEntityType1 ||
    (exports.TestEntitySharesEntityType1 = {}))
);
exports.TestEntitySharesEntityType1 = TestEntitySharesEntityType1;
