...
var TestEntitySharesEntityType1RequestBuilder = /** @class */ (function (_super) {
     ...
     */
    TestEntitySharesEntityType1RequestBuilder.prototype.getByKey = function (keyProperty) {
        return new core_1.GetByKeyRequestBuilderV2(TestEntitySharesEntityType1_1.TestEntitySharesEntityType1, { KeyProperty: keyProperty });
    };
    /**
    ...
    TestEntitySharesEntityType1RequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV2(TestEntitySharesEntityType1_1.TestEntitySharesEntityType1);
    };
    /**
    ...
    TestEntitySharesEntityType1RequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV2(TestEntitySharesEntityType1_1.TestEntitySharesEntityType1, entity);
    };
    /**
    ...
    TestEntitySharesEntityType1RequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV2(TestEntitySharesEntityType1_1.TestEntitySharesEntityType1, entity);
    };
    TestEntitySharesEntityType1RequestBuilder.prototype.delete = function (keyPropertyOrEntity) {
        return new core_1.DeleteRequestBuilderV2(TestEntitySharesEntityType1_1.TestEntitySharesEntityType1, keyPropertyOrEntity instanceof TestEntitySharesEntityType1_1.TestEntitySharesEntityType1 ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    };
