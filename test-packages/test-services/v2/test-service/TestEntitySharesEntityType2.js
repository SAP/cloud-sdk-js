...
var TestEntitySharesEntityType2 = /** @class */ (function (_super) {
  ...
  TestEntitySharesEntityType2.builder = function () {
    return core_1.EntityV2.entityBuilder(TestEntitySharesEntityType2);
  };
  /**
   ...
   */
  TestEntitySharesEntityType2._defaultServicePath =
...
(function (TestEntitySharesEntityType2) {
   ...
   */
  TestEntitySharesEntityType2.KEY_PROPERTY = new core_1.StringField(
    'KeyProperty',
    TestEntitySharesEntityType2,
    'Edm.String'
  );
   ...
   * All fields selector.
   */
  TestEntitySharesEntityType2.ALL_FIELDS = new core_1.AllFields(
    '*',
    TestEntitySharesEntityType2
  );
  /**
   ...
   */
  TestEntitySharesEntityType2._keyFields = [
    TestEntitySharesEntityType2.KEY_PROPERTY
  ];
  /**
   * Mapping of all key field names to the respective static field property TestEntitySharesEntityType2.
   */
  TestEntitySharesEntityType2._keys = TestEntitySharesEntityType2._keyFields.reduce(
    function (acc, field) {
  ...
  (TestEntitySharesEntityType2 =
    exports.TestEntitySharesEntityType2 ||
    (exports.TestEntitySharesEntityType2 = {}))
);
exports.TestEntitySharesEntityType2 = TestEntitySharesEntityType2;
