...
var TestEntitySharesEntityType2RequestBuilder = /** @class */ (function (_super) {
     ...
     */
    TestEntitySharesEntityType2RequestBuilder.prototype.getByKey = function (keyProperty) {
        return new core_1.GetByKeyRequestBuilderV2(TestEntitySharesEntityType2_1.TestEntitySharesEntityType2, { KeyProperty: keyProperty });
    };
    /**
    ...
    TestEntitySharesEntityType2RequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV2(TestEntitySharesEntityType2_1.TestEntitySharesEntityType2);
    };
    /**
    ...
    TestEntitySharesEntityType2RequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV2(TestEntitySharesEntityType2_1.TestEntitySharesEntityType2, entity);
    };
    /**
    ...
    TestEntitySharesEntityType2RequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV2(TestEntitySharesEntityType2_1.TestEntitySharesEntityType2, entity);
    };
    TestEntitySharesEntityType2RequestBuilder.prototype.delete = function (keyPropertyOrEntity) {
        return new core_1.DeleteRequestBuilderV2(TestEntitySharesEntityType2_1.TestEntitySharesEntityType2, keyPropertyOrEntity instanceof TestEntitySharesEntityType2_1.TestEntitySharesEntityType2 ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    };
