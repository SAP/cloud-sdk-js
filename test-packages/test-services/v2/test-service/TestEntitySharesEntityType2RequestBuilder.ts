...
export class TestEntitySharesEntityType2RequestBuilder extends RequestBuilder<TestEntitySharesEntityType2> {
   ...
   */
  getByKey(keyProperty: string): GetByKeyRequestBuilderV2<TestEntitySharesEntityType2> {
    return new GetByKeyRequestBuilderV2(TestEntitySharesEntityType2, { KeyProperty: keyProperty });
  }
   ...
   */
  create(entity: TestEntitySharesEntityType2): CreateRequestBuilderV2<TestEntitySharesEntityType2> {
   ...
   */
  update(entity: TestEntitySharesEntityType2): UpdateRequestBuilderV2<TestEntitySharesEntityType2> {
   ...
   */
  delete(keyProperty: string): DeleteRequestBuilderV2<TestEntitySharesEntityType2>;
  /**
   * Returns a request builder for deleting an entity of type `TestEntitySharesEntityType2`.
   ...
   */
  delete(entity: TestEntitySharesEntityType2): DeleteRequestBuilderV2<TestEntitySharesEntityType2>;
  delete(keyPropertyOrEntity: any): DeleteRequestBuilderV2<TestEntitySharesEntityType2> {
    return new DeleteRequestBuilderV2(TestEntitySharesEntityType2, keyPropertyOrEntity instanceof TestEntitySharesEntityType2 ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity! });
  }
}
