...
class TestEntitySingleLinkRequestBuilder extends internal_1.RequestBuilder {
    ...
    getByKey(keyProperty) {
        return new odata_v2_1.GetByKeyRequestBuilder(TestEntitySingleLink_1.TestEntitySingleLink, { KeyProperty: keyProperty });
    }
    /**
     ...
     */
    getAll() {
        return new odata_v2_1.GetAllRequestBuilder(TestEntitySingleLink_1.TestEntitySingleLink);
    }
    /**
     ...
     */
    create(entity) {
        return new odata_v2_1.CreateRequestBuilder(TestEntitySingleLink_1.TestEntitySingleLink, entity);
    }
    /**
     ...
     */
    update(entity) {
        return new odata_v2_1.UpdateRequestBuilder(TestEntitySingleLink_1.TestEntitySingleLink, entity);
    }
    delete(keyPropertyOrEntity) {
        return new odata_v2_1.DeleteRequestBuilder(TestEntitySingleLink_1.TestEntitySingleLink, keyPropertyOrEntity instanceof TestEntitySingleLink_1.TestEntitySingleLink ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    }
}
