 ...
 */
export declare class TestEntityWithSharedEntityType1 extends EntityV2 implements TestEntityWithSharedEntityType1Type {
    /**
     ...
     * @returns A builder that constructs instances of entity type `TestEntityWithSharedEntityType1`.
     */
    static customField(fieldName: string): CustomFieldV2<TestEntityWithSharedEntityType1>;
    /**
