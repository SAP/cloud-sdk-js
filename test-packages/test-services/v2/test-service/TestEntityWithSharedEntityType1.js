...
class TestEntityWithSharedEntityType1 extends odata_v2_1.Entity {
     ...
     */
    static builder() {
        return odata_v2_1.Entity.entityBuilder(TestEntityWithSharedEntityType1);
    }
    /**
    ...
    static customField(fieldName) {
        return odata_v2_1.Entity.customFieldSelector(fieldName, TestEntityWithSharedEntityType1);
    }
    /**
 ...
 */
TestEntityWithSharedEntityType1._entityName = 'A_TestEntityWithSharedEntityType1';
/**
...
(function (TestEntityWithSharedEntityType1) {
    const _fieldBuilder = new internal_1.FieldBuilder(TestEntityWithSharedEntityType1);
    /**
     * Static representation of the [[keyProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityWithSharedEntityType1.KEY_PROPERTY = _fieldBuilder.buildEdmTypeField('KeyProperty', 'Edm.String', false);
    /**
     ...
     * All fields selector.
     */
    TestEntityWithSharedEntityType1.ALL_FIELDS = new internal_1.AllFields('*', TestEntityWithSharedEntityType1);
    /**
     * All key fields of the TestEntityWithSharedEntityType1 entity.
     */
    TestEntityWithSharedEntityType1._keyFields = [TestEntityWithSharedEntityType1.KEY_PROPERTY];
    /**
     * Mapping of all key field names to the respective static field property TestEntityWithSharedEntityType1.
     */
    TestEntityWithSharedEntityType1._keys = TestEntityWithSharedEntityType1._keyFields.reduce((acc, field) => {
        acc[field._fieldName] = field;
        return acc;
    }, {});
})(TestEntityWithSharedEntityType1 = exports.TestEntityWithSharedEntityType1 || (exports.TestEntityWithSharedEntityType1 = {}));
