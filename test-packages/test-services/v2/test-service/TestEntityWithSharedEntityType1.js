...
(function (TestEntityWithSharedEntityType1) {
   ...
   */
  TestEntityWithSharedEntityType1.KEY_PROPERTY = new core_1.StringField(
    'KeyProperty',
    TestEntityWithSharedEntityType1,
    'Edm.String'
  );
   ...
   */
  TestEntityWithSharedEntityType1._keys = TestEntityWithSharedEntityType1._keyFields.reduce(
    function (acc, field) {
