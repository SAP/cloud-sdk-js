...
class TestEntityWithSharedEntityType1Api {
    ...
    get schema() {
        const fieldBuilder = new internal_1.FieldBuilder(TestEntityWithSharedEntityType1_1.TestEntityWithSharedEntityType1, this.deSerializers);
        return {
            /**
         ...
         */
             ...
             * All fields selector.
             */
            ALL_FIELDS: new internal_1.AllFields('*', TestEntityWithSharedEntityType1_1.TestEntityWithSharedEntityType1)
        };
    }
}
