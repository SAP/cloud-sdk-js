...
var TestEntityWithSharedEntityType1RequestBuilder = /** @class */ (function (_super) {
    ...
    TestEntityWithSharedEntityType1RequestBuilder.prototype.getByKey = function (keyProperty) {
        return new core_1.GetByKeyRequestBuilderV2(TestEntityWithSharedEntityType1_1.TestEntityWithSharedEntityType1, { KeyProperty: keyProperty });
    };
    /**
    ...
    TestEntityWithSharedEntityType1RequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV2(TestEntityWithSharedEntityType1_1.TestEntityWithSharedEntityType1);
    };
    /**
    ...
    TestEntityWithSharedEntityType1RequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV2(TestEntityWithSharedEntityType1_1.TestEntityWithSharedEntityType1, entity);
    };
    /**
    ...
    TestEntityWithSharedEntityType1RequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV2(TestEntityWithSharedEntityType1_1.TestEntityWithSharedEntityType1, entity);
    };
    TestEntityWithSharedEntityType1RequestBuilder.prototype.delete = function (keyPropertyOrEntity) {
        return new core_1.DeleteRequestBuilderV2(TestEntityWithSharedEntityType1_1.TestEntityWithSharedEntityType1, keyPropertyOrEntity instanceof TestEntityWithSharedEntityType1_1.TestEntityWithSharedEntityType1 ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    };
