 ...
 */
export declare class TestEntityWithSharedEntityType2 extends EntityV2 implements TestEntityWithSharedEntityType2Type {
    /**
     ...
     * @returns A builder that constructs instances of entity type `TestEntityWithSharedEntityType2`.
     */
    static customField(fieldName: string): CustomFieldV2<TestEntityWithSharedEntityType2>;
    /**
