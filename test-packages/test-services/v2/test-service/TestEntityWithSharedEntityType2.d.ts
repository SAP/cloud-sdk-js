...
import { AllFields, EdmTypeField, EntityBuilderType, Field } from '@sap-cloud-sdk/odata-common/internal';
/**
 * This class represents the entity "A_TestEntityWithSharedEntityType2" of service "API_TEST_SRV".
 */
export declare class TestEntityWithSharedEntityType2 extends Entity implements TestEntityWithSharedEntityType2Type {
    /**
     ...
     * @returns A builder that constructs instances of entity type `TestEntityWithSharedEntityType2`.
     */
    static customField(fieldName: string): CustomField<TestEntityWithSharedEntityType2>;
    /**
...
export declare namespace TestEntityWithSharedEntityType2 {
     ...
     */
    const KEY_PROPERTY: EdmTypeField<TestEntityWithSharedEntityType2, "Edm.String", false, true>;
    /**
     * All fields of the TestEntityWithSharedEntityType2 entity.
     */
    const _allFields: Array<EdmTypeField<TestEntityWithSharedEntityType2, 'Edm.String', false, true>>;
    /**
     * All fields selector.
     */
     ...
     */
    const _keyFields: Array<Field<TestEntityWithSharedEntityType2, boolean, boolean>>;
    /**
