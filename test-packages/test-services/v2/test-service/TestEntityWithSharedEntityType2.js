...
class TestEntityWithSharedEntityType2 extends odata_v2_1.Entity {
    ...
    static customField(fieldName) {
        return odata_v2_1.Entity.customFieldSelector(fieldName, TestEntityWithSharedEntityType2);
    }
    /**
...
(function (TestEntityWithSharedEntityType2) {
    const _fieldBuilder = new internal_1.FieldBuilder(TestEntityWithSharedEntityType2);
    /**
     ...
     * All fields selector.
     */
    TestEntityWithSharedEntityType2.ALL_FIELDS = new internal_1.AllFields('*', TestEntityWithSharedEntityType2);
    /**
     ...
     */
    TestEntityWithSharedEntityType2._keys = TestEntityWithSharedEntityType2._keyFields.reduce((acc, field) => {
