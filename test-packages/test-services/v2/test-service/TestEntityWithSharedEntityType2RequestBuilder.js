...
var TestEntityWithSharedEntityType2RequestBuilder = /** @class */ (function (_super) {
    ...
    TestEntityWithSharedEntityType2RequestBuilder.prototype.getByKey = function (keyProperty) {
        return new core_1.GetByKeyRequestBuilderV2(TestEntityWithSharedEntityType2_1.TestEntityWithSharedEntityType2, { KeyProperty: keyProperty });
    };
    /**
    ...
    TestEntityWithSharedEntityType2RequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV2(TestEntityWithSharedEntityType2_1.TestEntityWithSharedEntityType2);
    };
    /**
    ...
    TestEntityWithSharedEntityType2RequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV2(TestEntityWithSharedEntityType2_1.TestEntityWithSharedEntityType2, entity);
    };
    /**
    ...
    TestEntityWithSharedEntityType2RequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV2(TestEntityWithSharedEntityType2_1.TestEntityWithSharedEntityType2, entity);
    };
    TestEntityWithSharedEntityType2RequestBuilder.prototype.delete = function (keyPropertyOrEntity) {
        return new core_1.DeleteRequestBuilderV2(TestEntityWithSharedEntityType2_1.TestEntityWithSharedEntityType2, keyPropertyOrEntity instanceof TestEntityWithSharedEntityType2_1.TestEntityWithSharedEntityType2 ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    };
