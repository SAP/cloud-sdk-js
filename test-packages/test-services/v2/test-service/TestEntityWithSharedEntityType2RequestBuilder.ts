...
export class TestEntityWithSharedEntityType2RequestBuilder extends RequestBuilder<TestEntityWithSharedEntityType2> {
   ...
   */
  getByKey(keyProperty: string): GetByKeyRequestBuilderV2<TestEntityWithSharedEntityType2> {
    return new GetByKeyRequestBuilderV2(TestEntityWithSharedEntityType2, { KeyProperty: keyProperty });
  }
   ...
   */
  create(entity: TestEntityWithSharedEntityType2): CreateRequestBuilderV2<TestEntityWithSharedEntityType2> {
   ...
   */
  update(entity: TestEntityWithSharedEntityType2): UpdateRequestBuilderV2<TestEntityWithSharedEntityType2> {
   ...
   */
  delete(keyProperty: string): DeleteRequestBuilderV2<TestEntityWithSharedEntityType2>;
  /**
   * Returns a request builder for deleting an entity of type `TestEntityWithSharedEntityType2`.
   ...
   */
  delete(entity: TestEntityWithSharedEntityType2): DeleteRequestBuilderV2<TestEntityWithSharedEntityType2>;
  delete(keyPropertyOrEntity: any): DeleteRequestBuilderV2<TestEntityWithSharedEntityType2> {
    return new DeleteRequestBuilderV2(TestEntityWithSharedEntityType2, keyPropertyOrEntity instanceof TestEntityWithSharedEntityType2 ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity! });
  }
}
