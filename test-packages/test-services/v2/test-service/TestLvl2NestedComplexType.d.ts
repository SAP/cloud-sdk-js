import { ComplexTypeField, ConstructorOrField, EdmTypeField, EntityV2, FieldOptions, FieldType, PropertyMetadata } from '@sap-cloud-sdk/core';
/**
 ...
 */
export declare class TestLvl2NestedComplexTypeField<EntityT extends EntityV2, NullableT extends boolean = false, SelectableT extends boolean = false> extends ComplexTypeField<EntityT, TestLvl2NestedComplexType, NullableT, SelectableT> {
