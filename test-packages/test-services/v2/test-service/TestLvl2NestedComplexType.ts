 ...
 */
import { ComplexTypeField, ConstructorOrField, EdmTypeField, EntityV2, FieldBuilder, FieldOptions, FieldType, PropertyMetadata, deserializeComplexTypeV2 } from '@sap-cloud-sdk/core';
 ...
 */
export class TestLvl2NestedComplexTypeField<EntityT extends EntityV2, NullableT extends boolean = false, SelectableT extends boolean = false> extends ComplexTypeField<EntityT, TestLvl2NestedComplexType, NullableT, SelectableT> {
