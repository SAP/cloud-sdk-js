 ...
 */
import { ComplexTypeField, ComplexTypeStringPropertyField, ConstructorOrField, EntityV2, FieldType, PropertyMetadata, deserializeComplexTypeV2 } from '@sap-cloud-sdk/core';
 ...
 */
export class TestLvl2NestedComplexTypeField<EntityT extends EntityV2> extends ComplexTypeField<EntityT, TestLvl2NestedComplexType> {
  /**
