...
function testFunctionImportEdmReturnType(parameters, deSerializers = odata_v2_1.defaultDeSerializers) {
    const params = {};
    return new odata_v2_1.FunctionImportRequestBuilder('get', '/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportEdmReturnType', (data) => (0, odata_v2_1.transformReturnValueForEdmType)(data, (val) => (0, odata_v2_1.edmToTs)(val.TestFunctionImportEdmReturnType, 'Edm.Boolean')), params, deSerializers);
}
...
function testFunctionImportEdmReturnTypeCollection(parameters, deSerializers = odata_v2_1.defaultDeSerializers) {
    const params = {};
    return new odata_v2_1.FunctionImportRequestBuilder('get', '/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportEdmReturnTypeCollection', (data) => (0, odata_v2_1.transformReturnValueForEdmTypeList)(data, (val) => (0, odata_v2_1.edmToTs)(val, 'Edm.String')), params, deSerializers);
}
...
function testFunctionImportEntityReturnType(parameters, deSerializers = odata_v2_1.defaultDeSerializers) {
    const params = {};
    return new odata_v2_1.FunctionImportRequestBuilder('get', '/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportEntityReturnType', (data) => (0, odata_v2_1.transformReturnValueForEntity)(data, new TestEntityApi_1.TestEntityApi(deSerializers)), params, deSerializers);
}
...
function testFunctionImportEntityReturnTypeCollection(parameters, deSerializers = odata_v2_1.defaultDeSerializers) {
    const params = {};
    return new odata_v2_1.FunctionImportRequestBuilder('get', '/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportEntityReturnTypeCollection', (data) => (0, odata_v2_1.transformReturnValueForEntityList)(data, new TestEntityApi_1.TestEntityApi(deSerializers)), params, deSerializers);
}
...
function testFunctionImportUnsupportedEdmTypes(parameters, deSerializers = odata_v2_1.defaultDeSerializers) {
    ...
    return new odata_v2_1.FunctionImportRequestBuilder('get', '/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportUnsupportedEdmTypes', (data) => (0, odata_v2_1.transformReturnValueForEdmType)(data, (val) => (0, odata_v2_1.edmToTs)(val.TestFunctionImportUnsupportedEdmTypes, 'Edm.Any')), params, deSerializers);
}
...
function testFunctionImportGet(parameters, deSerializers = odata_v2_1.defaultDeSerializers) {
    ...
    return new odata_v2_1.FunctionImportRequestBuilder('get', '/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportGET', (data) => (0, odata_v2_1.transformReturnValueForEdmType)(data, (val) => (0, odata_v2_1.edmToTs)(val.TestFunctionImportGET, 'Edm.Boolean')), params, deSerializers);
}
...
function testFunctionImportPost(parameters, deSerializers = odata_v2_1.defaultDeSerializers) {
    ...
    return new odata_v2_1.FunctionImportRequestBuilder('post', '/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportPOST', (data) => (0, odata_v2_1.transformReturnValueForEdmType)(data, (val) => (0, odata_v2_1.edmToTs)(val.TestFunctionImportPOST, 'Edm.Boolean')), params, deSerializers);
}
...
function testFunctionImportMultipleParams(parameters, deSerializers = odata_v2_1.defaultDeSerializers) {
    ...
    return new odata_v2_1.FunctionImportRequestBuilder('get', '/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportMultipleParams', (data) => (0, odata_v2_1.transformReturnValueForEdmType)(data, (val) => (0, odata_v2_1.edmToTs)(val.TestFunctionImportMultipleParams, 'Edm.Boolean')), params, deSerializers);
}
...
function fContinue(parameters, deSerializers = odata_v2_1.defaultDeSerializers) {
    const params = {};
    return new odata_v2_1.FunctionImportRequestBuilder('get', '/sap/opu/odata/sap/API_TEST_SRV', 'Continue', (data) => (0, odata_v2_1.transformReturnValueForEdmType)(data, (val) => (0, odata_v2_1.edmToTs)(val.Continue, 'Edm.Boolean')), params, deSerializers);
}
