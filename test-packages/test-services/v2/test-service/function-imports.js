...
function testFunctionImportNoReturnType(parameters) {
    var params = {};
    return new core_1.FunctionImportRequestBuilderV2('post', '/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportNoReturnType', function (data) { return core_1.transformReturnValueForUndefinedV2(data, function (val) { return undefined; }); }, params);
}
...
function testFunctionImportEdmReturnType(parameters) {
    var params = {};
    return new core_1.FunctionImportRequestBuilderV2('get', '/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportEdmReturnType', function (data) { return core_1.transformReturnValueForEdmTypeV2(data, function (val) { return core_1.edmToTsV2(val.TestFunctionImportEdmReturnType, 'Edm.Boolean'); }); }, params);
}
...
function testFunctionImportEdmReturnTypeCollection(parameters) {
    var params = {};
    return new core_1.FunctionImportRequestBuilderV2('get', '/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportEdmReturnTypeCollection', function (data) { return core_1.transformReturnValueForEdmTypeListV2(data, function (val) { return core_1.edmToTsV2(val, 'Edm.String'); }); }, params);
}
...
function testFunctionImportEntityReturnType(parameters) {
    var params = {};
    return new core_1.FunctionImportRequestBuilderV2('get', '/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportEntityReturnType', function (data) { return core_1.transformReturnValueForEntityV2(data, TestEntity_1.TestEntity); }, params);
}
...
function testFunctionImportEntityReturnTypeCollection(parameters) {
    var params = {};
    return new core_1.FunctionImportRequestBuilderV2('get', '/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportEntityReturnTypeCollection', function (data) { return core_1.transformReturnValueForEntityListV2(data, TestEntity_1.TestEntity); }, params);
}
...
function testFunctionImportSharedEntityReturnType(parameters) {
    var params = {};
    return new core_1.FunctionImportRequestBuilderV2('get', '/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportSharedEntityReturnType', function (data) { return core_1.throwErrorWhenReturnTypeIsUnionType(data, 'TestFunctionImportSharedEntityReturnType'); }, params);
}
...
function testFunctionImportSharedEntityReturnTypeCollection(parameters) {
    var params = {};
    return new core_1.FunctionImportRequestBuilderV2('get', '/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportSharedEntityReturnTypeCollection', function (data) { return core_1.throwErrorWhenReturnTypeIsUnionType(data, 'TestFunctionImportSharedEntityReturnTypeCollection'); }, params);
}
...
function testFunctionImportComplexReturnType(parameters) {
    var params = {};
    return new core_1.FunctionImportRequestBuilderV2('get', '/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportComplexReturnType', function (data) { return core_1.transformReturnValueForComplexTypeV2(data, function (data) { return core_1.deserializeComplexTypeV2(data, TestComplexType_1.TestComplexType); }); }, params);
}
...
function testFunctionImportUnsupportedEdmTypes(parameters) {
    ...
    return new core_1.FunctionImportRequestBuilderV2('get', '/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportUnsupportedEdmTypes', function (data) { return core_1.transformReturnValueForEdmTypeV2(data, function (val) { return core_1.edmToTsV2(val.TestFunctionImportUnsupportedEdmTypes, 'Edm.Any'); }); }, params);
}
...
function testFunctionImportGet(parameters) {
    ...
    return new core_1.FunctionImportRequestBuilderV2('get', '/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportGET', function (data) { return core_1.transformReturnValueForEdmTypeV2(data, function (val) { return core_1.edmToTsV2(val.TestFunctionImportGET, 'Edm.Boolean'); }); }, params);
}
...
function testFunctionImportPost(parameters) {
    ...
    return new core_1.FunctionImportRequestBuilderV2('post', '/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportPOST', function (data) { return core_1.transformReturnValueForEdmTypeV2(data, function (val) { return core_1.edmToTsV2(val.TestFunctionImportPOST, 'Edm.Boolean'); }); }, params);
}
...
function testFunctionImportMultipleParams(parameters) {
    ...
    return new core_1.FunctionImportRequestBuilderV2('get', '/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportMultipleParams', function (data) { return core_1.transformReturnValueForEdmTypeV2(data, function (val) { return core_1.edmToTsV2(val.TestFunctionImportMultipleParams, 'Edm.Boolean'); }); }, params);
}
...
function createTestComplexType(parameters) {
    var params = {};
    return new core_1.FunctionImportRequestBuilderV2('get', '/sap/opu/odata/sap/API_TEST_SRV', 'CreateTestComplexType', function (data) { return core_1.transformReturnValueForComplexTypeV2(data, function (data) { return core_1.deserializeComplexTypeV2(data, TestComplexType_1.TestComplexType); }); }, params);
}
...
function fContinue(parameters) {
    var params = {};
    return new core_1.FunctionImportRequestBuilderV2('get', '/sap/opu/odata/sap/API_TEST_SRV', 'Continue', function (data) { return core_1.transformReturnValueForEdmTypeV2(data, function (val) { return core_1.edmToTsV2(val.Continue, 'Edm.Boolean'); }); }, params);
}
