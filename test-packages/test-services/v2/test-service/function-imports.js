...
function testFunctionImportNoReturnType(parameters) {
    var params = {};
    return new core_1.FunctionImportRequestBuilder('post', '/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportNoReturnType', function (data) { return core_1.transformReturnValueForUndefined(data, function (val) { return undefined; }); }, params);
}
...
function testFunctionImportEdmReturnType(parameters) {
    var params = {};
    return new core_1.FunctionImportRequestBuilder('get', '/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportEdmReturnType', function (data) { return core_1.transformReturnValueForEdmType(data, function (val) { return core_1.edmToTs(val.TestFunctionImportEdmReturnType, 'Edm.Boolean'); }); }, params);
}
...
function testFunctionImportUnsupportedEdmTypes(parameters) {
    ...
    return new core_1.FunctionImportRequestBuilder('get', '/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportUnsupportedEdmTypes', function (data) { return core_1.transformReturnValueForEdmType(data, function (val) { return core_1.edmToTs(val.TestFunctionImportUnsupportedEdmTypes, 'Edm.Any'); }); }, params);
}
...
function testFunctionImportGet(parameters) {
    ...
    return new core_1.FunctionImportRequestBuilder('get', '/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportGET', function (data) { return core_1.transformReturnValueForEdmType(data, function (val) { return core_1.edmToTs(val.TestFunctionImportGET, 'Edm.Boolean'); }); }, params);
}
...
function testFunctionImportPost(parameters) {
    ...
    return new core_1.FunctionImportRequestBuilder('post', '/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportPOST', function (data) { return core_1.transformReturnValueForEdmType(data, function (val) { return core_1.edmToTs(val.TestFunctionImportPOST, 'Edm.Boolean'); }); }, params);
}
...
function testFunctionImportMultipleParams(parameters) {
    ...
    return new core_1.FunctionImportRequestBuilder('get', '/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportMultipleParams', function (data) { return core_1.transformReturnValueForEdmType(data, function (val) { return core_1.edmToTs(val.TestFunctionImportMultipleParams, 'Edm.Boolean'); }); }, params);
}
...
function fContinue(parameters) {
    var params = {};
    return new core_1.FunctionImportRequestBuilder('get', '/sap/opu/odata/sap/API_TEST_SRV', 'Continue', function (data) { return core_1.transformReturnValueForEdmType(data, function (val) { return core_1.edmToTs(val.Continue, 'Edm.Boolean'); }); }, params);
}
