 ...
 */
class CommonEntity extends odata_v4_1.Entity {
  /**
   ...
   */
  static builder() {
    return odata_v4_1.Entity.entityBuilder(CommonEntity);
  }
  /**
  ...
  static customField(fieldName) {
    return odata_v4_1.Entity.customFieldSelector(fieldName, CommonEntity);
  }
  /**
...
(function (CommonEntity) {
   ...
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  CommonEntity.COLLECTION_PROPERTY = _fieldBuilder.buildCollectionField(
    'CollectionProperty',
    'Edm.String',
    true
  );
   ...
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  CommonEntity.TO_SINGLE_LINK = new internal_1.OneToOneLink(
    'to_SingleLink',
    CommonEntity,
