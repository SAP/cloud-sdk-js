 ...
 */
export class CommonEntitySingleLinkRequestBuilder extends RequestBuilder<CommonEntitySingleLink> {
  /**
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder(CommonEntitySingleLink, {
  ...
  getAll(): GetAllRequestBuilder<CommonEntitySingleLink> {
    return new GetAllRequestBuilder(CommonEntitySingleLink);
  }
  ...
  create(
    ...
    return new CreateRequestBuilder(CommonEntitySingleLink, entity);
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder(CommonEntitySingleLink, entity);
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder(
      ...
      keyPropertyOrEntity instanceof CommonEntitySingleLink
        ? keyPropertyOrEntity
