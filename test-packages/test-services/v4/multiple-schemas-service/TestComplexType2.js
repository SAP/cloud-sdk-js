...
var TestComplexType2Field = /** @class */ (function (_super) {
     ...
     */
    function TestComplexType2Field(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, TestComplexType2) || this;
        /**
...
(function (TestComplexType2) {
     ...
     */
    function build(json) {
        return core_1.deserializeComplexType(json, TestComplexType2);
    }
