...
import { AllFields, CustomFieldV4, EdmTypeField, EntityBuilderType, EntityV4, EnumField, Field, OrderableEdmTypeField } from '@sap-cloud-sdk/core';
/**
...
export declare namespace TestEntity1 {
     ...
     */
    const KEY_PROPERTY_STRING: EdmTypeField<TestEntity1, "Edm.String", false, true>;
    /**
     * Static representation of the [[int16Property]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const INT_16_PROPERTY: OrderableEdmTypeField<TestEntity1, "Edm.Int16", true, true>;
    /**
     ...
     */
    const _allFields: Array<EdmTypeField<TestEntity1, 'Edm.String', false, true> | OrderableEdmTypeField<TestEntity1, 'Edm.Int16', true, true> | EnumField<TestEntity1, TestEnumType1, true, true> | TestComplexType1Field<TestEntity1, true, true>>;
    /**
     * All fields selector.
     */
