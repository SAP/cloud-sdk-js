...
export declare namespace TestEntity1 {
     ...
     */
    const _allFields: Array<EdmTypeField<TestEntity1, 'Edm.String', false, true> | OrderableEdmTypeField<TestEntity1, 'Edm.Int16', true, true> | EdmTypeField<TestEntity1, 'Edm.Enum', true, true> | TestComplexType1Field<TestEntity1, true, true>>;
    /**
     * All fields selector.
     */
