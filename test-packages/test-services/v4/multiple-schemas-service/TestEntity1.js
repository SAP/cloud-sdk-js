...
var TestEntity1 = /** @class */ (function (_super) {
    ...
    TestEntity1.builder = function () {
        return core_1.Entity.entityBuilder(TestEntity1);
    };
    /**
    ...
    TestEntity1.customField = function (fieldName) {
        return core_1.Entity.customFieldSelector(fieldName, TestEntity1);
    };
    /**
...
(function (TestEntity1) {
     ...
     */
    TestEntity1.KEY_PROPERTY_STRING = new core_1.StringField('KeyPropertyString', TestEntity1, 'Edm.String');
    /**
     * Static representation of the [[int16Property]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntity1.INT_16_PROPERTY = new core_1.NumberField('Int16Property', TestEntity1, 'Edm.Int16');
    /**
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntity1.COMPLEX_TYPE_PROPERTY = new TestComplexType1_1.TestComplexType1Field('ComplexTypeProperty', TestEntity1);
    /**
