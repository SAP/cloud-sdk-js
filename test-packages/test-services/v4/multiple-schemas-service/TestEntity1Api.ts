...
export class TestEntity1Api<T extends DeSerializers = DefaultDeSerializers>
  implements EntityApi<TestEntity1<T>, T>
{
  ...
  requestBuilder(): TestEntity1RequestBuilder<T> {
    return new TestEntity1RequestBuilder(this);
  }

  entityBuilder(): EntityBuilderType<TestEntity1<T>, T> {
  ...
  ): CustomField<TestEntity1<T>, T, NullableT> {
