...
var TestEntity1RequestBuilder = /** @class */ (function (_super) {
    ...
    TestEntity1RequestBuilder.prototype.getByKey = function (keyPropertyString) {
        return new core_1.GetByKeyRequestBuilder(TestEntity1_1.TestEntity1, { KeyPropertyString: keyPropertyString });
    };
    /**
    ...
    TestEntity1RequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilder(TestEntity1_1.TestEntity1);
    };
    /**
    ...
    TestEntity1RequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilder(TestEntity1_1.TestEntity1, entity);
    };
    /**
    ...
    TestEntity1RequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilder(TestEntity1_1.TestEntity1, entity);
    };
    TestEntity1RequestBuilder.prototype.delete = function (keyPropertyStringOrEntity) {
        return new core_1.DeleteRequestBuilder(TestEntity1_1.TestEntity1, keyPropertyStringOrEntity instanceof TestEntity1_1.TestEntity1 ? keyPropertyStringOrEntity : { KeyPropertyString: keyPropertyStringOrEntity });
    };
