...
export declare namespace TestEntity2 {
     ...
     */
    const KEY_PROPERTY_STRING: EdmTypeField<TestEntity2, "Edm.String", false, true>;
    /**
     * Static representation of the [[singleProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const SINGLE_PROPERTY: OrderableEdmTypeField<TestEntity2, "Edm.Single", true, true>;
    /**
     * All fields of the TestEntity2 entity.
     */
    const _allFields: Array<EdmTypeField<TestEntity2, 'Edm.String', false, true> | OrderableEdmTypeField<TestEntity2, 'Edm.Single', true, true>>;
    /**
     * All fields selector.
     */
