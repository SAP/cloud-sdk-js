...
var TestEntity2 = /** @class */ (function (_super) {
     ...
     * Technical service name for TestEntity2.
     */
    TestEntity2._serviceName = 'API_MULTIPLE_SCHEMAS_SRV';
    /**
     * Default url path for the according service.
     */
    TestEntity2._defaultServicePath = 'VALUE_IS_UNDEFINED';
    return TestEntity2;
}(core_1.EntityV4));
...
(function (TestEntity2) {
     ...
     */
    TestEntity2.KEY_PROPERTY_STRING = new core_1.StringField('KeyPropertyString', TestEntity2, 'Edm.String');
    /**
     * Static representation of the [[singleProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntity2.SINGLE_PROPERTY = new core_1.NumberField('SingleProperty', TestEntity2, 'Edm.Single');
    /**
