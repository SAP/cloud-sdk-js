...
var TestEntity2RequestBuilder = /** @class */ (function (_super) {
    ...
    TestEntity2RequestBuilder.prototype.getByKey = function (keyPropertyString) {
        return new odata_v4_1.GetByKeyRequestBuilder(TestEntity2_1.TestEntity2, { KeyPropertyString: keyPropertyString });
    };
    /**
    ...
    TestEntity2RequestBuilder.prototype.create = function (entity) {
        return new odata_v4_1.CreateRequestBuilder(TestEntity2_1.TestEntity2, entity);
    };
    /**
    ...
    TestEntity2RequestBuilder.prototype.update = function (entity) {
        return new odata_v4_1.UpdateRequestBuilder(TestEntity2_1.TestEntity2, entity);
    };
    TestEntity2RequestBuilder.prototype.delete = function (keyPropertyStringOrEntity) {
        return new odata_v4_1.DeleteRequestBuilder(TestEntity2_1.TestEntity2, keyPropertyStringOrEntity instanceof TestEntity2_1.TestEntity2 ? keyPropertyStringOrEntity : { KeyPropertyString: keyPropertyStringOrEntity });
    };
