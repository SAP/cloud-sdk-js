...
import { AllFields, CustomField, EntityBuilderType, Entity, EnumField, Field, StringField } from '@sap-cloud-sdk/core';
/**
...
export declare namespace TestEntity3 {
     ...
     */
    const _allFields: Array<StringField<TestEntity3> | EnumField<TestEntity3> | TestComplexType2Field<TestEntity3>>;
    /**
     * All fields selector.
     */
