...
import { AllFields, EdmTypeField, EntityBuilderType, EnumField, Field } from '@sap-cloud-sdk/odata-common';
/**
 * This class represents the entity "A_TestEntity3" of service "API_MULTIPLE_SCHEMAS_SRV".
 */
export declare class TestEntity3 extends Entity implements TestEntity3Type {
    /**
...
export declare namespace TestEntity3 {
     ...
     */
    const KEY_PROPERTY_STRING: EdmTypeField<TestEntity3, "Edm.String", false, true>;
    /**
     ...
     */
    const _allFields: Array<EdmTypeField<TestEntity3, 'Edm.String', false, true> | EnumField<TestEntity3, TestEnumType2, true, true> | TestComplexType2Field<TestEntity3, true, true>>;
    /**
     * All fields selector.
     */
