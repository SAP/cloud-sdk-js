...
var TestEntity3 = /** @class */ (function (_super) {
     ...
     * Technical service name for TestEntity3.
     */
    TestEntity3._serviceName = 'API_MULTIPLE_SCHEMAS_SRV';
    /**
     * Default url path for the according service.
     */
    TestEntity3._defaultServicePath = 'VALUE_IS_UNDEFINED';
    return TestEntity3;
}(core_1.EntityV4));
...
(function (TestEntity3) {
     ...
     */
    TestEntity3.KEY_PROPERTY_STRING = new core_1.StringField('KeyPropertyString', TestEntity3, 'Edm.String');
    /**
     * Static representation of the [[enumProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntity3.ENUM_PROPERTY = new core_1.EnumField('EnumProperty', TestEntity3);
    /**
     * Static representation of the [[complexTypeProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntity3.COMPLEX_TYPE_PROPERTY = new TestComplexType2_1.TestComplexType2Field('ComplexTypeProperty', TestEntity3);
    /**
