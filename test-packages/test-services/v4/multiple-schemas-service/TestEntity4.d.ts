...
export declare namespace TestEntity4 {
     ...
     */
    const KEY_PROPERTY_STRING: EdmTypeField<TestEntity4, "Edm.String", false, true>;
    /**
     ...
     */
    const _allFields: Array<EdmTypeField<TestEntity4, 'Edm.String', false, true> | EdmTypeField<TestEntity4, 'Edm.Boolean', true, true>>;
    /**
     * All fields selector.
     */
