...
(function (TestEntity4) {
     ...
     */
    TestEntity4.KEY_PROPERTY_STRING = new core_1.StringField('KeyPropertyString', TestEntity4, 'Edm.String');
    /**
     * Static representation of the [[booleanProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntity4.BOOLEAN_PROPERTY = new core_1.BooleanField('BooleanProperty', TestEntity4, 'Edm.Boolean');
    /**
