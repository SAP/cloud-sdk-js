...
export class TestEntity4RequestBuilder extends RequestBuilder<TestEntity4> {
  ...
  getByKey(keyPropertyString: string): GetByKeyRequestBuilderV4<TestEntity4> {
    return new GetByKeyRequestBuilderV4(TestEntity4, { KeyPropertyString: keyPropertyString });
  }
  ...
  delete(keyPropertyStringOrEntity: any): DeleteRequestBuilderV4<TestEntity4> {
    return new DeleteRequestBuilderV4(TestEntity4, keyPropertyStringOrEntity instanceof TestEntity4 ? keyPropertyStringOrEntity : { KeyPropertyString: keyPropertyStringOrEntity! });
  }
}
