 ...
 */
export declare function testFunctionImportEntityReturnType1(parameters: TestFunctionImportEntityReturnType1Parameters): FunctionImportRequestBuilder<TestFunctionImportEntityReturnType1Parameters, TestEntity1>;
/**
 ...
 * @returns A request builder that allows to overwrite some of the values and execute the resulting request.
 */
export declare function testFunctionImportEntityReturnType2(parameters: TestFunctionImportEntityReturnType2Parameters): FunctionImportRequestBuilder<TestFunctionImportEntityReturnType2Parameters, TestEntity2>;
