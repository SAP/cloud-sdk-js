...
function testFunctionImportEntityReturnType1(parameters) {
    var params = {};
    return new core_1.FunctionImportRequestBuilderV4('VALUE_IS_UNDEFINED', 'TestFunctionImportEntityReturnType1', function (data) { return core_1.transformReturnValueForEntityV4(data, TestEntity1_1.TestEntity1); }, params);
}
...
function testFunctionImportEntityReturnType2(parameters) {
    var params = {};
    return new core_1.FunctionImportRequestBuilderV4('VALUE_IS_UNDEFINED', 'TestFunctionImportEntityReturnType2', function (data) { return core_1.transformReturnValueForEntityV4(data, TestEntity2_1.TestEntity2); }, params);
}
