...
function testFunctionImportEntityReturnType1(parameters) {
    var params = {};
    return new core_1.FunctionImportRequestBuilderV4('/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportEntityReturnType1', function (data) { return (0, core_1.transformReturnValueForEntityV4)(data, TestEntity1_1.TestEntity1); }, params);
}
...
function testFunctionImportEntityReturnType2(parameters) {
    var params = {};
    return new core_1.FunctionImportRequestBuilderV4('/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportEntityReturnType2', function (data) { return (0, core_1.transformReturnValueForEntityV4)(data, TestEntity2_1.TestEntity2); }, params);
}
