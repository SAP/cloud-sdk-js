...
function testFunctionImportEntityReturnType1(parameters) {
    var params = {};
    return new core_1.FunctionImportRequestBuilder('/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportEntityReturnType1', function (data) { return core_1.transformReturnValueForEntity(data, TestEntity1_1.TestEntity1); }, params);
}
...
function testFunctionImportEntityReturnType2(parameters) {
    var params = {};
    return new core_1.FunctionImportRequestBuilder('/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportEntityReturnType2', function (data) { return core_1.transformReturnValueForEntity(data, TestEntity2_1.TestEntity2); }, params);
}
