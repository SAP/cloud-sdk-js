...
import { CollectionField, ComplexTypeField, ConstructorOrField, EdmTypeField, EnumField, FieldOptions, FieldType, OrderableEdmTypeField, PropertyMetadata, Time } from '@sap-cloud-sdk/odata-common';
/**
 * TestComplexType
 */
 ...
 */
export declare class TestComplexTypeField<EntityT extends Entity, NullableT extends boolean = false, SelectableT extends boolean = false> extends ComplexTypeField<EntityT, TestComplexType, NullableT, SelectableT> {
