...
import { CollectionField, ComplexTypeField, ConstructorOrField, EdmTypeField, EntityV4, EnumField, FieldOptions, FieldType, OrderableEdmTypeField, PropertyMetadata, Time } from '@sap-cloud-sdk/core';
/**
 * TestComplexType
 */
 ...
 */
export declare class TestComplexTypeField<EntityT extends EntityV4, NullableT extends boolean = false, SelectableT extends boolean = false> extends ComplexTypeField<EntityT, TestComplexType, NullableT, SelectableT> {
     ...
     * Use to reference this property in query operations such as 'filter' in the fluent request API.
     */
    timeOfDayProperty: OrderableEdmTypeField<EntityT, 'Edm.TimeOfDay', true, false>;
    /**
     ...
     * Use to reference this property in query operations such as 'filter' in the fluent request API.
     */
    dateTimeOffSetProperty: OrderableEdmTypeField<EntityT, 'Edm.DateTimeOffset', true, false>;
    /**
     ...
     * Use to reference this property in query operations such as 'filter' in the fluent request API.
     */
    collectionEnumProperty: CollectionField<EntityT, typeof TestEnumType, true, false>;
    /**
     * Representation of the [[TestComplexType.collectionComplexTypeProperty]] property for query construction.
     * Use to reference this property in query operations such as 'filter' in the fluent request API.
     */
    collectionComplexTypeProperty: CollectionField<EntityT, TestNestedComplexType, true, false>;
    /**
