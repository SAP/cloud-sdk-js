...
import { CollectionField, ComplexTypeField, ConstructorOrField, EdmTypeField, EntityV4, FieldOptions, FieldType, OrderableEdmTypeField, PropertyMetadata, Time } from '@sap-cloud-sdk/core';
/**
 * TestComplexType
 */
