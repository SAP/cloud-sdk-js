...
import { AllFields, CollectionField, EdmTypeField, EntityBuilderType, EnumField, Field, OneToManyLink, OneToOneLink, OrderableEdmTypeField, Time } from '@sap-cloud-sdk/odata-common';
/**
