...
import { AllFields, CollectionField, CustomFieldV4, EdmTypeField, EntityBuilderType, EntityV4, Field, OneToManyLink, OneToOneLink, OrderableEdmTypeField, Time } from '@sap-cloud-sdk/core';
/**
...
export declare namespace TestEntity {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const ENUM_PROPERTY_WITH_ONE_MEMBER: EdmTypeField<TestEntity, "Edm.Enum", true, true>;
    /**
     * Static representation of the [[enumCollectionProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const ENUM_COLLECTION_PROPERTY: CollectionField<TestEntity, "Edm.Enum", true, true>;
    /**
