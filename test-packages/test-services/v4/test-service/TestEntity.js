...
(function (TestEntity) {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntity.ENUM_PROPERTY = _fieldBuilder.buildEdmTypeField('EnumProperty', 'Edm.Enum', true);
    /**
     * Static representation of the [[enumPropertyInt64]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntity.ENUM_PROPERTY_INT_64 = _fieldBuilder.buildEdmTypeField('EnumPropertyInt64', 'Edm.Enum', true);
    /**
     * Static representation of the [[enumPropertyWithOneMember]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntity.ENUM_PROPERTY_WITH_ONE_MEMBER = _fieldBuilder.buildEdmTypeField('EnumPropertyWithOneMember', 'Edm.Enum', true);
    /**
     * Static representation of the [[enumCollectionProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntity.ENUM_COLLECTION_PROPERTY = _fieldBuilder.buildCollectionField('EnumCollectionProperty', 'Edm.Enum', true);
    /**
