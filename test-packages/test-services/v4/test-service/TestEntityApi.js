...
class TestEntityApi {
    ...
    _addNavigationProperties(linkedApis) {
        this.navigationPropertyFields = {
            ...
            TO_OTHER_MULTI_LINK: new internal_1.OneToManyLink('to_OtherMultiLink', this, linkedApis[1]),
            TO_SINGLE_LINK: new internal_1.OneToOneLink('to_SingleLink', this, linkedApis[2])
        };
        return this;
    }
    requestBuilder() {
