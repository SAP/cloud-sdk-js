...
import { Time, EdmTypeField, OrderableEdmTypeField, CollectionField, EnumField, OneToManyLink, OneToOneLink, AllFields, entityBuilder, EntityBuilderType, EntityApi, FieldBuilder } from '@sap-cloud-sdk/odata-common/internal';
import { BigNumber } from 'bignumber.js';
import { Moment, Duration } from 'moment';
export class TestEntityApi<BinaryT = string,
BooleanT = boolean,
ByteT = number,
DecimalT = BigNumber,
DoubleT = number,
...
TimeOfDayT>> = defaultDeSerializers as any) {
  ...
  private navigationPropertyFields!: {
      ...
      TO_MULTI_LINK: OneToManyLink<
            TestEntity<DeSerializers<BinaryT,
      BooleanT,
      ByteT,
      DecimalT,
      DoubleT,
  ...
  _addNavigationProperties(
      linkedApis: [
        TestEntityMultiLinkApi<BinaryT,
        BooleanT,
        ByteT,
        DecimalT,
        DoubleT,
        ...
        DateT,
        DurationT,
        TimeOfDayT>,TestEntityMultiLinkApi<BinaryT,
        BooleanT,
        ByteT,
        DecimalT,
        DoubleT,
        ...
        DateT,
        DurationT,
        TimeOfDayT>,TestEntitySingleLinkApi<BinaryT,
        BooleanT,
        ByteT,
        DecimalT,
        DoubleT,
