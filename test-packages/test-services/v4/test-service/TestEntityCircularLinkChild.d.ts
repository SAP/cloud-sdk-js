...
import { AllFields, CustomFieldV4, EdmTypeField, EntityBuilderType, EntityV4, Field, OneToOneLink } from '@sap-cloud-sdk/core';
/**
 * This class represents the entity "A_TestEntityCircularLinkChild" of service "API_TEST_SRV".
 */
export declare class TestEntityCircularLinkChild extends EntityV4 implements TestEntityCircularLinkChildType {
    /**
...
export declare namespace TestEntityCircularLinkChild {
     ...
     */
    const KEY_PROPERTY: EdmTypeField<TestEntityCircularLinkChild, "Edm.String", false, true>;
    /**
     * Static representation of the one-to-one navigation property [[toParent]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const TO_PARENT: OneToOneLink<TestEntityCircularLinkChild, TestEntityCircularLinkParent>;
    /**
     * All fields of the TestEntityCircularLinkChild entity.
     */
    const _allFields: Array<EdmTypeField<TestEntityCircularLinkChild, 'Edm.String', false, true> | OneToOneLink<TestEntityCircularLinkChild, TestEntityCircularLinkParent>>;
    /**
     * All fields selector.
     */
