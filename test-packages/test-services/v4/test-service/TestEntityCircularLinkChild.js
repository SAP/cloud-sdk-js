...
var TestEntityCircularLinkChild = /** @class */ (function (_super) {
    ...
    TestEntityCircularLinkChild.customField = function (fieldName) {
        return odata_v4_1.Entity.customFieldSelector(fieldName, TestEntityCircularLinkChild);
    };
    /**
...
(function (TestEntityCircularLinkChild) {
    var _fieldBuilder = new odata_common_1.FieldBuilder(TestEntityCircularLinkChild);
    /**
     * Static representation of the [[keyProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityCircularLinkChild.KEY_PROPERTY = _fieldBuilder.buildEdmTypeField('KeyProperty', 'Edm.String', false);
    /**
     * Static representation of the one-to-one navigation property [[toParent]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityCircularLinkChild.TO_PARENT = new odata_common_1.OneToOneLink('to_Parent', TestEntityCircularLinkChild, TestEntityCircularLinkParent_1.TestEntityCircularLinkParent);
    /**
     ...
     * All fields selector.
     */
    TestEntityCircularLinkChild.ALL_FIELDS = new odata_common_1.AllFields('*', TestEntityCircularLinkChild);
    /**
