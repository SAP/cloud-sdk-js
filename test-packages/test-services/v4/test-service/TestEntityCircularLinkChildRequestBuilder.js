...
var TestEntityCircularLinkChildRequestBuilder = /** @class */ (function (_super) {
    ...
    TestEntityCircularLinkChildRequestBuilder.prototype.getByKey = function (keyProperty) {
        return new odata_v4_1.GetByKeyRequestBuilder(TestEntityCircularLinkChild_1.TestEntityCircularLinkChild, { KeyProperty: keyProperty });
    };
    /**
    ...
    TestEntityCircularLinkChildRequestBuilder.prototype.getAll = function () {
        return new odata_v4_1.GetAllRequestBuilder(TestEntityCircularLinkChild_1.TestEntityCircularLinkChild);
    };
    /**
    ...
    TestEntityCircularLinkChildRequestBuilder.prototype.create = function (entity) {
        return new odata_v4_1.CreateRequestBuilder(TestEntityCircularLinkChild_1.TestEntityCircularLinkChild, entity);
    };
    /**
    ...
    TestEntityCircularLinkChildRequestBuilder.prototype.update = function (entity) {
        return new odata_v4_1.UpdateRequestBuilder(TestEntityCircularLinkChild_1.TestEntityCircularLinkChild, entity);
    };
    TestEntityCircularLinkChildRequestBuilder.prototype.delete = function (keyPropertyOrEntity) {
        return new odata_v4_1.DeleteRequestBuilder(TestEntityCircularLinkChild_1.TestEntityCircularLinkChild, keyPropertyOrEntity instanceof TestEntityCircularLinkChild_1.TestEntityCircularLinkChild ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    };
