...
export class TestEntityCircularLinkChildRequestBuilder extends RequestBuilder<TestEntityCircularLinkChild> {
   ...
   */
  getByKey(keyProperty: string): GetByKeyRequestBuilderV4<TestEntityCircularLinkChild> {
    return new GetByKeyRequestBuilderV4(TestEntityCircularLinkChild, { KeyProperty: keyProperty });
  }
   ...
   */
  create(entity: TestEntityCircularLinkChild): CreateRequestBuilderV4<TestEntityCircularLinkChild> {
   ...
   */
  update(entity: TestEntityCircularLinkChild): UpdateRequestBuilderV4<TestEntityCircularLinkChild> {
   ...
   */
  delete(keyProperty: string): DeleteRequestBuilderV4<TestEntityCircularLinkChild>;
  /**
   * Returns a request builder for deleting an entity of type `TestEntityCircularLinkChild`.
   ...
   */
  delete(entity: TestEntityCircularLinkChild): DeleteRequestBuilderV4<TestEntityCircularLinkChild>;
  delete(keyPropertyOrEntity: any): DeleteRequestBuilderV4<TestEntityCircularLinkChild> {
    return new DeleteRequestBuilderV4(TestEntityCircularLinkChild, keyPropertyOrEntity instanceof TestEntityCircularLinkChild ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity! });
  }
}
