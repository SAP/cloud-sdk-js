...
import { AllFields, CustomFieldV4, EdmTypeField, EntityBuilderType, EntityV4, Field, OneToManyLink, OneToOneLink } from '@sap-cloud-sdk/core';
/**
 * This class represents the entity "A_TestEntityCircularLinkParent" of service "API_TEST_SRV".
 */
export declare class TestEntityCircularLinkParent extends EntityV4 implements TestEntityCircularLinkParentType {
    /**
...
export declare namespace TestEntityCircularLinkParent {
     ...
     */
    const KEY_PROPERTY: EdmTypeField<TestEntityCircularLinkParent, "Edm.String", false, true>;
    /**
     * Static representation of the one-to-one navigation property [[toFirstChild]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const TO_FIRST_CHILD: OneToOneLink<TestEntityCircularLinkParent, TestEntityCircularLinkChild>;
    /**
     * Static representation of the one-to-many navigation property [[toChildren]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const TO_CHILDREN: OneToManyLink<TestEntityCircularLinkParent, TestEntityCircularLinkChild>;
    /**
     * All fields of the TestEntityCircularLinkParent entity.
     */
    const _allFields: Array<EdmTypeField<TestEntityCircularLinkParent, 'Edm.String', false, true> | OneToOneLink<TestEntityCircularLinkParent, TestEntityCircularLinkChild> | OneToManyLink<TestEntityCircularLinkParent, TestEntityCircularLinkChild>>;
    /**
     * All fields selector.
     */
     ...
     */
    const _keyFields: Array<Field<TestEntityCircularLinkParent, boolean, boolean>>;
    /**
