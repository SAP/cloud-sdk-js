...
var TestEntityCircularLinkParent = /** @class */ (function (_super) {
    ...
    TestEntityCircularLinkParent.customField = function (fieldName) {
        return odata_v4_1.Entity.customFieldSelector(fieldName, TestEntityCircularLinkParent);
    };
    /**
...
(function (TestEntityCircularLinkParent) {
    var _fieldBuilder = new odata_common_1.FieldBuilder(TestEntityCircularLinkParent);
    /**
     * Static representation of the [[keyProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityCircularLinkParent.KEY_PROPERTY = _fieldBuilder.buildEdmTypeField('KeyProperty', 'Edm.String', false);
    /**
     * Static representation of the one-to-one navigation property [[toFirstChild]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityCircularLinkParent.TO_FIRST_CHILD = new odata_common_1.OneToOneLink('to_FirstChild', TestEntityCircularLinkParent, TestEntityCircularLinkChild_1.TestEntityCircularLinkChild);
    /**
     * Static representation of the one-to-many navigation property [[toChildren]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityCircularLinkParent.TO_CHILDREN = new odata_common_1.OneToManyLink('to_Children', TestEntityCircularLinkParent, TestEntityCircularLinkChild_1.TestEntityCircularLinkChild);
    /**
     ...
     * All fields selector.
     */
    TestEntityCircularLinkParent.ALL_FIELDS = new odata_common_1.AllFields('*', TestEntityCircularLinkParent);
    /**
...
})(TestEntityCircularLinkParent = exports.TestEntityCircularLinkParent || (exports.TestEntityCircularLinkParent = {}));
exports.TestEntityCircularLinkParent = TestEntityCircularLinkParent;
