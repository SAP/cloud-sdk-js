 ...
 */
export declare class TestEntityEndsWith extends EntityV4 implements TestEntityEndsWithType {
    /**
...
export declare namespace TestEntityEndsWith {
     ...
     */
    const KEY_PROPERTY: EdmTypeField<TestEntityEndsWith, "Edm.String", false, true>;
    /**
     * All fields of the TestEntityEndsWith entity.
     */
    const _allFields: Array<EdmTypeField<TestEntityEndsWith, 'Edm.String', false, true>>;
    /**
     * All fields selector.
     */
