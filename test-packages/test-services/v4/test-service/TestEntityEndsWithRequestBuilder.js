...
var TestEntityEndsWithRequestBuilder = /** @class */ (function (_super) {
    ...
    TestEntityEndsWithRequestBuilder.prototype.getByKey = function (keyProperty) {
        return new odata_v4_1.GetByKeyRequestBuilder(TestEntityEndsWith_1.TestEntityEndsWith, { KeyProperty: keyProperty });
    };
    /**
    ...
    TestEntityEndsWithRequestBuilder.prototype.getAll = function () {
        return new odata_v4_1.GetAllRequestBuilder(TestEntityEndsWith_1.TestEntityEndsWith);
    };
    /**
    ...
    TestEntityEndsWithRequestBuilder.prototype.create = function (entity) {
        return new odata_v4_1.CreateRequestBuilder(TestEntityEndsWith_1.TestEntityEndsWith, entity);
    };
    /**
    ...
    TestEntityEndsWithRequestBuilder.prototype.update = function (entity) {
        return new odata_v4_1.UpdateRequestBuilder(TestEntityEndsWith_1.TestEntityEndsWith, entity);
    };
    TestEntityEndsWithRequestBuilder.prototype.delete = function (keyPropertyOrEntity) {
        return new odata_v4_1.DeleteRequestBuilder(TestEntityEndsWith_1.TestEntityEndsWith, keyPropertyOrEntity instanceof TestEntityEndsWith_1.TestEntityEndsWith ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    };
