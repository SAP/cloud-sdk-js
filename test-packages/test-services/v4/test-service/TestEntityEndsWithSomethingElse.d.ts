...
export declare namespace TestEntityEndsWithSomethingElse {
     ...
     */
    const KEY_PROPERTY: EdmTypeField<TestEntityEndsWithSomethingElse, "Edm.String", false, true>;
    /**
     * All fields of the TestEntityEndsWithSomethingElse entity.
     */
    const _allFields: Array<EdmTypeField<TestEntityEndsWithSomethingElse, 'Edm.String', false, true>>;
    /**
     * All fields selector.
     */
     ...
     */
    const _keyFields: Array<Field<TestEntityEndsWithSomethingElse, boolean, boolean>>;
    /**
