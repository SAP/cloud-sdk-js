...
var TestEntityEndsWithSomethingElse = /** @class */ (function (_super) {
    ...
    TestEntityEndsWithSomethingElse.customField = function (fieldName) {
        return odata_v4_1.Entity.customFieldSelector(fieldName, TestEntityEndsWithSomethingElse);
    };
    /**
...
(function (TestEntityEndsWithSomethingElse) {
    var _fieldBuilder = new odata_common_1.FieldBuilder(TestEntityEndsWithSomethingElse);
    /**
     * Static representation of the [[keyProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityEndsWithSomethingElse.KEY_PROPERTY = _fieldBuilder.buildEdmTypeField('KeyProperty', 'Edm.String', false);
    /**
     ...
     * All fields selector.
     */
    TestEntityEndsWithSomethingElse.ALL_FIELDS = new odata_common_1.AllFields('*', TestEntityEndsWithSomethingElse);
    /**
