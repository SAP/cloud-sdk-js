...
import { AllFields, EdmTypeField, EntityBuilderType, Field, OneToManyLink, OrderableEdmTypeField } from '@sap-cloud-sdk/odata-common';
/**
...
export declare namespace TestEntityLvl2MultiLink {
     ...
     */
    const STRING_PROPERTY: EdmTypeField<TestEntityLvl2MultiLink, "Edm.String", true, true>;
    /**
     * Static representation of the [[booleanProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BOOLEAN_PROPERTY: EdmTypeField<TestEntityLvl2MultiLink, "Edm.Boolean", true, true>;
    /**
     * Static representation of the [[guidProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const GUID_PROPERTY: EdmTypeField<TestEntityLvl2MultiLink, "Edm.Guid", true, true>;
    /**
     * Static representation of the [[int16Property]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const INT_16_PROPERTY: OrderableEdmTypeField<TestEntityLvl2MultiLink, "Edm.Int16", true, true>;
    /**
     * Static representation of the [[keyProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const KEY_PROPERTY: EdmTypeField<TestEntityLvl2MultiLink, "Edm.String", false, true>;
    /**
     ...
     */
    const _allFields: Array<EdmTypeField<TestEntityLvl2MultiLink, 'Edm.String', true, true> | EdmTypeField<TestEntityLvl2MultiLink, 'Edm.Boolean', true, true> | EdmTypeField<TestEntityLvl2MultiLink, 'Edm.Guid', true, true> | OrderableEdmTypeField<TestEntityLvl2MultiLink, 'Edm.Int16', true, true> | EdmTypeField<TestEntityLvl2MultiLink, 'Edm.String', false, true> | OneToManyLink<TestEntityLvl2MultiLink, TestEntityLvl3MultiLink>>;
    /**
     * All fields selector.
     */
