...
var TestEntityLvl2MultiLinkRequestBuilder = /** @class */ (function (_super) {
    ...
    TestEntityLvl2MultiLinkRequestBuilder.prototype.getByKey = function (keyProperty) {
        return new v4_1.GetByKeyRequestBuilder(TestEntityLvl2MultiLink_1.TestEntityLvl2MultiLink, { KeyProperty: keyProperty });
    };
    /**
    ...
    TestEntityLvl2MultiLinkRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(TestEntityLvl2MultiLink_1.TestEntityLvl2MultiLink);
    };
    /**
    ...
    TestEntityLvl2MultiLinkRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(TestEntityLvl2MultiLink_1.TestEntityLvl2MultiLink, entity);
    };
    /**
    ...
    TestEntityLvl2MultiLinkRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(TestEntityLvl2MultiLink_1.TestEntityLvl2MultiLink, entity);
    };
    TestEntityLvl2MultiLinkRequestBuilder.prototype.delete = function (keyPropertyOrEntity) {
        return new v4_1.DeleteRequestBuilder(TestEntityLvl2MultiLink_1.TestEntityLvl2MultiLink, keyPropertyOrEntity instanceof TestEntityLvl2MultiLink_1.TestEntityLvl2MultiLink ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    };
