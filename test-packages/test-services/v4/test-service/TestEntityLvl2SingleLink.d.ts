...
import { AllFields, CustomFieldV4, EdmTypeField, EntityBuilderType, EntityV4, Field, OrderableEdmTypeField } from '@sap-cloud-sdk/core';
/**
 * This class represents the entity "A_TestEntityLvl2SingleLink" of service "API_TEST_SRV".
 */
export declare class TestEntityLvl2SingleLink extends EntityV4 implements TestEntityLvl2SingleLinkType {
    /**
...
export declare namespace TestEntityLvl2SingleLink {
     ...
     */
    const STRING_PROPERTY: EdmTypeField<TestEntityLvl2SingleLink, "Edm.String", true, true>;
    /**
     * Static representation of the [[booleanProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BOOLEAN_PROPERTY: EdmTypeField<TestEntityLvl2SingleLink, "Edm.Boolean", true, true>;
    /**
     * Static representation of the [[guidProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const GUID_PROPERTY: EdmTypeField<TestEntityLvl2SingleLink, "Edm.Guid", true, true>;
    /**
     * Static representation of the [[int16Property]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const INT_16_PROPERTY: OrderableEdmTypeField<TestEntityLvl2SingleLink, "Edm.Int16", true, true>;
    /**
     * Static representation of the [[keyProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const KEY_PROPERTY: EdmTypeField<TestEntityLvl2SingleLink, "Edm.String", false, true>;
    /**
     * All fields of the TestEntityLvl2SingleLink entity.
     */
    const _allFields: Array<EdmTypeField<TestEntityLvl2SingleLink, 'Edm.String', true, true> | EdmTypeField<TestEntityLvl2SingleLink, 'Edm.Boolean', true, true> | EdmTypeField<TestEntityLvl2SingleLink, 'Edm.Guid', true, true> | OrderableEdmTypeField<TestEntityLvl2SingleLink, 'Edm.Int16', true, true> | EdmTypeField<TestEntityLvl2SingleLink, 'Edm.String', false, true>>;
    /**
     * All fields selector.
     */
