...
> implements EntityApi<TestEntityLvl2SingleLink<T>, T>
{
  ...
  requestBuilder(): TestEntityLvl2SingleLinkRequestBuilder<T> {
    return new TestEntityLvl2SingleLinkRequestBuilder(this);
  }

  entityBuilder(): EntityBuilderType<TestEntityLvl2SingleLink<T>, T> {
  ...
  ): CustomField<TestEntityLvl2SingleLink<T>, T, NullableT> {
