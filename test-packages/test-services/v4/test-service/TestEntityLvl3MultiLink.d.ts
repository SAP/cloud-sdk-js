...
import { AllFields, EdmTypeField, EntityBuilderType, Field } from '@sap-cloud-sdk/odata-common';
/**
 * This class represents the entity "A_TestEntityLvl3MultiLink" of service "API_TEST_SRV".
 */
export declare class TestEntityLvl3MultiLink extends Entity implements TestEntityLvl3MultiLinkType {
    /**
...
export declare namespace TestEntityLvl3MultiLink {
     ...
     */
    const STRING_PROPERTY: EdmTypeField<TestEntityLvl3MultiLink, "Edm.String", true, true>;
    /**
     * Static representation of the [[guidProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const GUID_PROPERTY: EdmTypeField<TestEntityLvl3MultiLink, "Edm.Guid", true, true>;
    /**
     * Static representation of the [[keyProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const KEY_PROPERTY: EdmTypeField<TestEntityLvl3MultiLink, "Edm.String", false, true>;
    /**
     * All fields of the TestEntityLvl3MultiLink entity.
     */
    const _allFields: Array<EdmTypeField<TestEntityLvl3MultiLink, 'Edm.String', true, true> | EdmTypeField<TestEntityLvl3MultiLink, 'Edm.Guid', true, true> | EdmTypeField<TestEntityLvl3MultiLink, 'Edm.String', false, true>>;
    /**
     * All fields selector.
     */
