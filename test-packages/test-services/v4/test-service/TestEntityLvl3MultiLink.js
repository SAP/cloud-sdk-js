...
var TestEntityLvl3MultiLink = /** @class */ (function (_super) {
    ...
    TestEntityLvl3MultiLink.customField = function (fieldName) {
        return odata_v4_1.Entity.customFieldSelector(fieldName, TestEntityLvl3MultiLink);
    };
    /**
...
(function (TestEntityLvl3MultiLink) {
     ...
     */
    TestEntityLvl3MultiLink.STRING_PROPERTY = _fieldBuilder.buildEdmTypeField('StringProperty', 'Edm.String', true);
    /**
     * Static representation of the [[guidProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityLvl3MultiLink.GUID_PROPERTY = _fieldBuilder.buildEdmTypeField('GuidProperty', 'Edm.Guid', true);
    /**
     * Static representation of the [[keyProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityLvl3MultiLink.KEY_PROPERTY = _fieldBuilder.buildEdmTypeField('KeyProperty', 'Edm.String', false);
    /**
     ...
     * All fields selector.
     */
    TestEntityLvl3MultiLink.ALL_FIELDS = new odata_common_1.AllFields('*', TestEntityLvl3MultiLink);
    /**
