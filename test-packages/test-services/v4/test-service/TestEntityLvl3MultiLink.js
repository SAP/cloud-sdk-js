...
var TestEntityLvl3MultiLink = /** @class */ (function (_super) {
    ...
    TestEntityLvl3MultiLink.builder = function () {
        return core_1.Entity.entityBuilder(TestEntityLvl3MultiLink);
    };
    /**
    ...
    TestEntityLvl3MultiLink.customField = function (fieldName) {
        return core_1.Entity.customFieldSelector(fieldName, TestEntityLvl3MultiLink);
    };
    /**
...
(function (TestEntityLvl3MultiLink) {
     ...
     */
    TestEntityLvl3MultiLink.STRING_PROPERTY = new core_1.StringField('StringProperty', TestEntityLvl3MultiLink, 'Edm.String');
    /**
     * Static representation of the [[guidProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityLvl3MultiLink.GUID_PROPERTY = new core_1.StringField('GuidProperty', TestEntityLvl3MultiLink, 'Edm.Guid');
    /**
     * Static representation of the [[keyProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityLvl3MultiLink.KEY_PROPERTY = new core_1.StringField('KeyProperty', TestEntityLvl3MultiLink, 'Edm.String');
    /**
     ...
     * All fields selector.
     */
    TestEntityLvl3MultiLink.ALL_FIELDS = new core_1.AllFields('*', TestEntityLvl3MultiLink);
    /**
     ...
     */
    TestEntityLvl3MultiLink._keys = TestEntityLvl3MultiLink._keyFields.reduce(function (acc, field) {
        acc[field._fieldName] = field;
        return acc;
    }, {});
})(TestEntityLvl3MultiLink = exports.TestEntityLvl3MultiLink || (exports.TestEntityLvl3MultiLink = {}));
exports.TestEntityLvl3MultiLink = TestEntityLvl3MultiLink;
