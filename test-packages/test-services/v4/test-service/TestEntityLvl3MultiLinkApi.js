...
class TestEntityLvl3MultiLinkApi {
    ...
    get schema() {
        const fieldBuilder = new internal_1.FieldBuilder(TestEntityLvl3MultiLink_1.TestEntityLvl3MultiLink, this.deSerializers);
        return {
            /**
         ...
         */
             ...
             * All fields selector.
             */
            ALL_FIELDS: new internal_1.AllFields('*', TestEntityLvl3MultiLink_1.TestEntityLvl3MultiLink)
        };
    }
}
