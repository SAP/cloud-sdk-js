...
var TestEntityLvl3MultiLinkRequestBuilder = /** @class */ (function (_super) {
    ...
    TestEntityLvl3MultiLinkRequestBuilder.prototype.getByKey = function (keyProperty) {
        return new odata_v4_1.GetByKeyRequestBuilder(TestEntityLvl3MultiLink_1.TestEntityLvl3MultiLink, { KeyProperty: keyProperty });
    };
    /**
    ...
    TestEntityLvl3MultiLinkRequestBuilder.prototype.getAll = function () {
        return new odata_v4_1.GetAllRequestBuilder(TestEntityLvl3MultiLink_1.TestEntityLvl3MultiLink);
    };
    /**
    ...
    TestEntityLvl3MultiLinkRequestBuilder.prototype.create = function (entity) {
        return new odata_v4_1.CreateRequestBuilder(TestEntityLvl3MultiLink_1.TestEntityLvl3MultiLink, entity);
    };
    /**
    ...
    TestEntityLvl3MultiLinkRequestBuilder.prototype.update = function (entity) {
        return new odata_v4_1.UpdateRequestBuilder(TestEntityLvl3MultiLink_1.TestEntityLvl3MultiLink, entity);
    };
    TestEntityLvl3MultiLinkRequestBuilder.prototype.delete = function (keyPropertyOrEntity) {
        return new odata_v4_1.DeleteRequestBuilder(TestEntityLvl3MultiLink_1.TestEntityLvl3MultiLink, keyPropertyOrEntity instanceof TestEntityLvl3MultiLink_1.TestEntityLvl3MultiLink ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    };
