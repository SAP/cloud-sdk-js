 ...
 */
export class TestEntityLvl3MultiLinkRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<TestEntityLvl3MultiLink<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<TestEntityLvl3MultiLink<T>, T> {
    return new GetByKeyRequestBuilder<TestEntityLvl3MultiLink<T>, T>(
      this.entityApi,
  ...
  getAll(): GetAllRequestBuilder<TestEntityLvl3MultiLink<T>, T> {
    return new GetAllRequestBuilder<TestEntityLvl3MultiLink<T>, T>(
      this.entityApi
    );
  }
  ...
  ): CreateRequestBuilder<TestEntityLvl3MultiLink<T>, T> {
    return new CreateRequestBuilder<TestEntityLvl3MultiLink<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    entity: TestEntityLvl3MultiLink<T>
  ): UpdateRequestBuilder<TestEntityLvl3MultiLink<T>, T> {
    return new UpdateRequestBuilder<TestEntityLvl3MultiLink<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<TestEntityLvl3MultiLink<T>, T>(
      this.entityApi,
      keyPropertyOrEntity instanceof TestEntityLvl3MultiLink
        ? keyPropertyOrEntity
