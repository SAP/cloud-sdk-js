...
var TestEntityMultiLink = /** @class */ (function (_super) {
    ...
    TestEntityMultiLink.builder = function () {
        return odata_v4_1.Entity.entityBuilder(TestEntityMultiLink);
    };
    /**
    ...
    TestEntityMultiLink.customField = function (fieldName) {
        return odata_v4_1.Entity.customFieldSelector(fieldName, TestEntityMultiLink);
    };
    /**
...
(function (TestEntityMultiLink) {
    var _fieldBuilder = new odata_common_1.FieldBuilder(TestEntityMultiLink);
    /**
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityMultiLink.TO_MULTI_LINK_1 = new odata_common_1.OneToManyLink('to_MultiLink1', TestEntityMultiLink, TestEntityLvl2MultiLink_1.TestEntityLvl2MultiLink);
    /**
     * Static representation of the one-to-one navigation property [[toSingleLink]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityMultiLink.TO_SINGLE_LINK = new odata_common_1.OneToOneLink('to_SingleLink', TestEntityMultiLink, TestEntityLvl2SingleLink_1.TestEntityLvl2SingleLink);
    /**
     ...
     * All fields selector.
     */
    TestEntityMultiLink.ALL_FIELDS = new odata_common_1.AllFields('*', TestEntityMultiLink);
    /**
