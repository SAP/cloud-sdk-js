...
import { AllFields, Constructable, EdmTypeField, EntityBuilderType, Field, FieldBuilder, OneToManyLink, OneToOneLink, OrderableEdmTypeField } from '@sap-cloud-sdk/odata-common';
