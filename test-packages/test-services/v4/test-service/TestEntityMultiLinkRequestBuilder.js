...
var TestEntityMultiLinkRequestBuilder = /** @class */ (function (_super) {
    ...
    TestEntityMultiLinkRequestBuilder.prototype.getByKey = function (keyProperty) {
        return new odata_v4_1.GetByKeyRequestBuilder(TestEntityMultiLink_1.TestEntityMultiLink, { KeyProperty: keyProperty });
    };
    /**
    ...
    TestEntityMultiLinkRequestBuilder.prototype.getAll = function () {
        return new odata_v4_1.GetAllRequestBuilder(TestEntityMultiLink_1.TestEntityMultiLink);
    };
    /**
    ...
    TestEntityMultiLinkRequestBuilder.prototype.create = function (entity) {
        return new odata_v4_1.CreateRequestBuilder(TestEntityMultiLink_1.TestEntityMultiLink, entity);
    };
    /**
    ...
    TestEntityMultiLinkRequestBuilder.prototype.update = function (entity) {
        return new odata_v4_1.UpdateRequestBuilder(TestEntityMultiLink_1.TestEntityMultiLink, entity);
    };
    TestEntityMultiLinkRequestBuilder.prototype.delete = function (keyPropertyOrEntity) {
        return new odata_v4_1.DeleteRequestBuilder(TestEntityMultiLink_1.TestEntityMultiLink, keyPropertyOrEntity instanceof TestEntityMultiLink_1.TestEntityMultiLink ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    };
