...
var TestEntityMultiLinkRequestBuilder = /** @class */ (function (_super) {
    ...
    TestEntityMultiLinkRequestBuilder.prototype.getByKey = function (keyProperty) {
        return new core_1.GetByKeyRequestBuilderV4(TestEntityMultiLink_1.TestEntityMultiLink, { KeyProperty: keyProperty });
    };
    /**
    ...
    TestEntityMultiLinkRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(TestEntityMultiLink_1.TestEntityMultiLink);
    };
    /**
    ...
    TestEntityMultiLinkRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(TestEntityMultiLink_1.TestEntityMultiLink, entity);
    };
    /**
    ...
    TestEntityMultiLinkRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(TestEntityMultiLink_1.TestEntityMultiLink, entity);
    };
    TestEntityMultiLinkRequestBuilder.prototype.delete = function (keyPropertyOrEntity) {
        return new core_1.DeleteRequestBuilderV4(TestEntityMultiLink_1.TestEntityMultiLink, keyPropertyOrEntity instanceof TestEntityMultiLink_1.TestEntityMultiLink ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    };
