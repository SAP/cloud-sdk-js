 ...
 */
export declare class TestEntityOtherMultiLink extends EntityV4 implements TestEntityOtherMultiLinkType {
    /**
...
export declare namespace TestEntityOtherMultiLink {
     ...
     */
    const KEY_PROPERTY: EdmTypeField<TestEntityOtherMultiLink, "Edm.String", false, true>;
    /**
     * All fields of the TestEntityOtherMultiLink entity.
     */
    const _allFields: Array<EdmTypeField<TestEntityOtherMultiLink, 'Edm.String', false, true>>;
    /**
     * All fields selector.
     */
