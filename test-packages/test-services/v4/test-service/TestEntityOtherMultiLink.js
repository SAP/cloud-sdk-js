...
var TestEntityOtherMultiLink = /** @class */ (function (_super) {
    ...
    TestEntityOtherMultiLink.customField = function (fieldName) {
        return odata_v4_1.Entity.customFieldSelector(fieldName, TestEntityOtherMultiLink);
    };
    /**
...
(function (TestEntityOtherMultiLink) {
    var _fieldBuilder = new odata_common_1.FieldBuilder(TestEntityOtherMultiLink);
    /**
     ...
     * All fields selector.
     */
    TestEntityOtherMultiLink.ALL_FIELDS = new odata_common_1.AllFields('*', TestEntityOtherMultiLink);
    /**
