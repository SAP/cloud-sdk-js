...
var TestEntityOtherMultiLinkRequestBuilder = /** @class */ (function (_super) {
    ...
    TestEntityOtherMultiLinkRequestBuilder.prototype.getByKey = function (keyProperty) {
        return new odata_v4_1.GetByKeyRequestBuilder(TestEntityOtherMultiLink_1.TestEntityOtherMultiLink, { KeyProperty: keyProperty });
    };
    /**
    ...
    TestEntityOtherMultiLinkRequestBuilder.prototype.getAll = function () {
        return new odata_v4_1.GetAllRequestBuilder(TestEntityOtherMultiLink_1.TestEntityOtherMultiLink);
    };
    /**
    ...
    TestEntityOtherMultiLinkRequestBuilder.prototype.create = function (entity) {
        return new odata_v4_1.CreateRequestBuilder(TestEntityOtherMultiLink_1.TestEntityOtherMultiLink, entity);
    };
    /**
    ...
    TestEntityOtherMultiLinkRequestBuilder.prototype.update = function (entity) {
        return new odata_v4_1.UpdateRequestBuilder(TestEntityOtherMultiLink_1.TestEntityOtherMultiLink, entity);
    };
    TestEntityOtherMultiLinkRequestBuilder.prototype.delete = function (keyPropertyOrEntity) {
        return new odata_v4_1.DeleteRequestBuilder(TestEntityOtherMultiLink_1.TestEntityOtherMultiLink, keyPropertyOrEntity instanceof TestEntityOtherMultiLink_1.TestEntityOtherMultiLink ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    };
