...
export namespace TestEntitySharesEntityType1 {
   ...
   */
  export const _allFields: Array<StringField<TestEntitySharesEntityType1> | NumberField<TestEntitySharesEntityType1>> = [
   ...
   */
  export const _keyFields: Array<Field<TestEntitySharesEntityType1>> = [TestEntitySharesEntityType1.KEY_PROPERTY_STRING];
  /**
