...
var TestEntitySharesEntityType1RequestBuilder = /** @class */ (function (_super) {
    ...
    TestEntitySharesEntityType1RequestBuilder.prototype.getByKey = function (keyProperty) {
        return new core_1.GetByKeyRequestBuilderV4(TestEntitySharesEntityType1_1.TestEntitySharesEntityType1, { KeyProperty: keyProperty });
    };
    /**
    ...
    TestEntitySharesEntityType1RequestBuilder.prototype.delete = function (keyPropertyOrEntity) {
        return new core_1.DeleteRequestBuilderV4(TestEntitySharesEntityType1_1.TestEntitySharesEntityType1, keyPropertyOrEntity instanceof TestEntitySharesEntityType1_1.TestEntitySharesEntityType1 ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    };
