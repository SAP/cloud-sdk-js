...
var TestEntitySharesEntityType2RequestBuilder = /** @class */ (function (_super) {
    ...
    TestEntitySharesEntityType2RequestBuilder.prototype.getByKey = function (keyProperty) {
        return new core_1.GetByKeyRequestBuilderV4(TestEntitySharesEntityType2_1.TestEntitySharesEntityType2, { KeyProperty: keyProperty });
    };
    /**
    ...
    TestEntitySharesEntityType2RequestBuilder.prototype.delete = function (keyPropertyOrEntity) {
        return new core_1.DeleteRequestBuilderV4(TestEntitySharesEntityType2_1.TestEntitySharesEntityType2, keyPropertyOrEntity instanceof TestEntitySharesEntityType2_1.TestEntitySharesEntityType2 ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    };
