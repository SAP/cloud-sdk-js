 ...
 */
var TestEntitySharesEntityType2RequestBuilder = /** @class */ (function (
  _super
) {
   ...
   */
  TestEntitySharesEntityType2RequestBuilder.prototype.getByKey = function (
    keyProperty
  ) {
    return new core_1.GetByKeyRequestBuilderV4(
      TestEntitySharesEntityType2_1.TestEntitySharesEntityType2,
   ...
   */
  TestEntitySharesEntityType2RequestBuilder.prototype.create = function (
    entity
  ) {
   ...
   */
  TestEntitySharesEntityType2RequestBuilder.prototype.update = function (
    entity
  ) {
  ...
  TestEntitySharesEntityType2RequestBuilder.prototype.delete = function (
    keyPropertyOrEntity
  ) {
