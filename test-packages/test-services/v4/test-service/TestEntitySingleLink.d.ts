...
import { AllFields, CustomFieldV4, EdmTypeField, EntityBuilderType, EntityV4, Field, OneToManyLink, OneToOneLink, OrderableEdmTypeField } from '@sap-cloud-sdk/core';
/**
 * This class represents the entity "A_TestEntitySingleLink" of service "API_TEST_SRV".
 */
export declare class TestEntitySingleLink extends EntityV4 implements TestEntitySingleLinkType {
    /**
...
export declare namespace TestEntitySingleLink {
     ...
     */
    const STRING_PROPERTY: EdmTypeField<TestEntitySingleLink, "Edm.String", true, true>;
    /**
     * Static representation of the [[booleanProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BOOLEAN_PROPERTY: EdmTypeField<TestEntitySingleLink, "Edm.Boolean", true, true>;
    /**
     * Static representation of the [[guidProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const GUID_PROPERTY: EdmTypeField<TestEntitySingleLink, "Edm.Guid", true, true>;
    /**
     * Static representation of the [[int16Property]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const INT_16_PROPERTY: OrderableEdmTypeField<TestEntitySingleLink, "Edm.Int16", true, true>;
    /**
     * Static representation of the [[keyProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const KEY_PROPERTY: EdmTypeField<TestEntitySingleLink, "Edm.String", false, true>;
    /**
     * Static representation of the one-to-many navigation property [[toMultiLink]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const TO_MULTI_LINK: OneToManyLink<TestEntitySingleLink, TestEntityLvl2MultiLink>;
    /**
     ...
     */
    const _allFields: Array<EdmTypeField<TestEntitySingleLink, 'Edm.String', true, true> | EdmTypeField<TestEntitySingleLink, 'Edm.Boolean', true, true> | EdmTypeField<TestEntitySingleLink, 'Edm.Guid', true, true> | OrderableEdmTypeField<TestEntitySingleLink, 'Edm.Int16', true, true> | EdmTypeField<TestEntitySingleLink, 'Edm.String', false, true> | OneToManyLink<TestEntitySingleLink, TestEntityLvl2MultiLink> | OneToOneLink<TestEntitySingleLink, TestEntityLvl2SingleLink>>;
    /**
     * All fields selector.
     */
