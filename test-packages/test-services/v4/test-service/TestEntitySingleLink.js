...
var TestEntitySingleLink = /** @class */ (function (_super) {
    ...
    TestEntitySingleLink.customField = function (fieldName) {
        return odata_v4_1.Entity.customFieldSelector(fieldName, TestEntitySingleLink);
    };
    /**
...
(function (TestEntitySingleLink) {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntitySingleLink.TO_MULTI_LINK = new odata_common_1.OneToManyLink('to_MultiLink', TestEntitySingleLink, TestEntityLvl2MultiLink_1.TestEntityLvl2MultiLink);
    /**
     * Static representation of the one-to-one navigation property [[toSingleLink]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntitySingleLink.TO_SINGLE_LINK = new odata_common_1.OneToOneLink('to_SingleLink', TestEntitySingleLink, TestEntityLvl2SingleLink_1.TestEntityLvl2SingleLink);
    /**
     ...
     * All fields selector.
     */
    TestEntitySingleLink.ALL_FIELDS = new odata_common_1.AllFields('*', TestEntitySingleLink);
    /**
