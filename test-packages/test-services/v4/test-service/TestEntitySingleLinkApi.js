...
class TestEntitySingleLinkApi {
    ...
    _addNavigationProperties(linkedApis) {
        this.navigationPropertyFields = {
            TO_MULTI_LINK: new internal_1.OneToManyLink('to_MultiLink', this, linkedApis[0]),
    ...
    get schema() {
        const fieldBuilder = new internal_1.FieldBuilder(TestEntitySingleLink_1.TestEntitySingleLink, this.deSerializers);
        return {
            /**
         ...
         */
             ...
             * All fields selector.
             */
            ALL_FIELDS: new internal_1.AllFields('*', TestEntitySingleLink_1.TestEntitySingleLink)
        };
    }
}
