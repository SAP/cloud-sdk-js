...
var TestEntitySingleLinkRequestBuilder = /** @class */ (function (_super) {
    ...
    TestEntitySingleLinkRequestBuilder.prototype.getByKey = function (keyProperty) {
        return new odata_v4_1.GetByKeyRequestBuilder(TestEntitySingleLink_1.TestEntitySingleLink, { KeyProperty: keyProperty });
    };
    /**
    ...
    TestEntitySingleLinkRequestBuilder.prototype.getAll = function () {
        return new odata_v4_1.GetAllRequestBuilder(TestEntitySingleLink_1.TestEntitySingleLink);
    };
    /**
    ...
    TestEntitySingleLinkRequestBuilder.prototype.create = function (entity) {
        return new odata_v4_1.CreateRequestBuilder(TestEntitySingleLink_1.TestEntitySingleLink, entity);
    };
    /**
    ...
    TestEntitySingleLinkRequestBuilder.prototype.update = function (entity) {
        return new odata_v4_1.UpdateRequestBuilder(TestEntitySingleLink_1.TestEntitySingleLink, entity);
    };
    TestEntitySingleLinkRequestBuilder.prototype.delete = function (keyPropertyOrEntity) {
        return new odata_v4_1.DeleteRequestBuilder(TestEntitySingleLink_1.TestEntitySingleLink, keyPropertyOrEntity instanceof TestEntitySingleLink_1.TestEntitySingleLink ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    };
