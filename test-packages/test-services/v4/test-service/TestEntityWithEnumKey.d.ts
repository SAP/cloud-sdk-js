...
import { AllFields, CustomFieldV4, EntityBuilderType, EntityV4, EnumField, Field } from '@sap-cloud-sdk/core';
/**
...
export declare namespace TestEntityWithEnumKey {
     ...
     */
    const KEY_PROPERTY_ENUM_1: EnumField<TestEntityWithEnumKey, TestEnumType, false, true>;
    /**
     * All fields of the TestEntityWithEnumKey entity.
     */
    const _allFields: Array<EnumField<TestEntityWithEnumKey, TestEnumType, false, true>>;
    /**
     * All fields selector.
     */
