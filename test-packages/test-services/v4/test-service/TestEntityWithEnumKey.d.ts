...
import { AllFields, EntityBuilderType, EnumField, Field } from '@sap-cloud-sdk/odata-common';
/**
 * This class represents the entity "A_TestEntityWithEnumKey" of service "API_TEST_SRV".
 */
export declare class TestEntityWithEnumKey extends Entity implements TestEntityWithEnumKeyType {
    /**
