 ...
 */
export declare class TestEntityWithEnumKey extends EntityV4 implements TestEntityWithEnumKeyType {
    /**
...
export declare namespace TestEntityWithEnumKey {
     ...
     */
    const KEY_PROPERTY_ENUM_1: EdmTypeField<TestEntityWithEnumKey, "Edm.Enum", false, true>;
    /**
     * Static representation of the [[keyPropertyEnum2]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const KEY_PROPERTY_ENUM_2: EdmTypeField<TestEntityWithEnumKey, "Edm.Enum", false, true>;
    /**
     * Static representation of the [[keyPropertyEnum3]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const KEY_PROPERTY_ENUM_3: EdmTypeField<TestEntityWithEnumKey, "Edm.Enum", false, true>;
    /**
     * All fields of the TestEntityWithEnumKey entity.
     */
    const _allFields: Array<EdmTypeField<TestEntityWithEnumKey, 'Edm.Enum', false, true>>;
    /**
     * All fields selector.
     */
