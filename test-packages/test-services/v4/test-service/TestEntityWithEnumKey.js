...
var TestEntityWithEnumKey = /** @class */ (function (_super) {
    ...
    TestEntityWithEnumKey.customField = function (fieldName) {
        return odata_v4_1.Entity.customFieldSelector(fieldName, TestEntityWithEnumKey);
    };
    /**
...
(function (TestEntityWithEnumKey) {
     ...
     */
    TestEntityWithEnumKey.KEY_PROPERTY_ENUM_1 = _fieldBuilder.buildEnumField('KeyPropertyEnum1', TestEnumType_1.TestEnumType, false);
    /**
     ...
     * All fields selector.
     */
    TestEntityWithEnumKey.ALL_FIELDS = new odata_common_1.AllFields('*', TestEntityWithEnumKey);
    /**
     * All key fields of the TestEntityWithEnumKey entity.
     */
    TestEntityWithEnumKey._keyFields = [TestEntityWithEnumKey.KEY_PROPERTY_ENUM_1];
    /**
