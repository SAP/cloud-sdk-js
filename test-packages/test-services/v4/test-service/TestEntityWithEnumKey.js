...
var TestEntityWithEnumKey = /** @class */ (function (_super) {
    ...
    TestEntityWithEnumKey.customField = function (fieldName) {
        return core_1.EntityV4.customFieldSelector(fieldName, TestEntityWithEnumKey);
    };
    /**
...
(function (TestEntityWithEnumKey) {
     ...
     */
    TestEntityWithEnumKey.KEY_PROPERTY_ENUM_1 = _fieldBuilder.buildEdmTypeField('KeyPropertyEnum1', 'Edm.Enum', false);
    /**
     * Static representation of the [[keyPropertyEnum2]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityWithEnumKey.KEY_PROPERTY_ENUM_2 = _fieldBuilder.buildEdmTypeField('KeyPropertyEnum2', 'Edm.Enum', false);
    /**
     * Static representation of the [[keyPropertyEnum3]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityWithEnumKey.KEY_PROPERTY_ENUM_3 = _fieldBuilder.buildEdmTypeField('KeyPropertyEnum3', 'Edm.Enum', false);
    /**
     ...
     * All fields selector.
     */
    TestEntityWithEnumKey.ALL_FIELDS = new core_1.AllFields('*', TestEntityWithEnumKey);
    /**
     * All key fields of the TestEntityWithEnumKey entity.
     */
    TestEntityWithEnumKey._keyFields = [TestEntityWithEnumKey.KEY_PROPERTY_ENUM_1, TestEntityWithEnumKey.KEY_PROPERTY_ENUM_2, TestEntityWithEnumKey.KEY_PROPERTY_ENUM_3];
    /**
     * Mapping of all key field names to the respective static field property TestEntityWithEnumKey.
     */
    TestEntityWithEnumKey._keys = TestEntityWithEnumKey._keyFields.reduce(function (acc, field) {
        acc[field._fieldName] = field;
        return acc;
    }, {});
})(TestEntityWithEnumKey = exports.TestEntityWithEnumKey || (exports.TestEntityWithEnumKey = {}));
exports.TestEntityWithEnumKey = TestEntityWithEnumKey;
