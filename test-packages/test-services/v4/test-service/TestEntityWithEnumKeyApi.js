...
class TestEntityWithEnumKeyApi {
    ...
    get schema() {
        const fieldBuilder = new internal_1.FieldBuilder(TestEntityWithEnumKey_1.TestEntityWithEnumKey, this.deSerializers);
        return {
            /**
         ...
         */
             ...
             * All fields selector.
             */
            ALL_FIELDS: new internal_1.AllFields('*', TestEntityWithEnumKey_1.TestEntityWithEnumKey)
        };
    }
}
