...
var TestEntityWithEnumKeyRequestBuilder = /** @class */ (function (_super) {
     ...
     * @param keyPropertyEnum2 Key property. See [[TestEntityWithEnumKey.keyPropertyEnum2]].
     ...
     */
    TestEntityWithEnumKeyRequestBuilder.prototype.getByKey = function (keyPropertyEnum1, keyPropertyEnum2, keyPropertyEnum3) {
        return new core_1.GetByKeyRequestBuilderV4(TestEntityWithEnumKey_1.TestEntityWithEnumKey, {
    ...
    TestEntityWithEnumKeyRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(TestEntityWithEnumKey_1.TestEntityWithEnumKey);
    };
    /**
    ...
    TestEntityWithEnumKeyRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(TestEntityWithEnumKey_1.TestEntityWithEnumKey, entity);
    };
    /**
    ...
    TestEntityWithEnumKeyRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(TestEntityWithEnumKey_1.TestEntityWithEnumKey, entity);
    };
    TestEntityWithEnumKeyRequestBuilder.prototype.delete = function (keyPropertyEnum1OrEntity, keyPropertyEnum2, keyPropertyEnum3) {
        return new core_1.DeleteRequestBuilderV4(TestEntityWithEnumKey_1.TestEntityWithEnumKey, keyPropertyEnum1OrEntity instanceof TestEntityWithEnumKey_1.TestEntityWithEnumKey ? keyPropertyEnum1OrEntity : {
