...
var TestEntityWithEnumKeyRequestBuilder = /** @class */ (function (_super) {
     ...
     */
    TestEntityWithEnumKeyRequestBuilder.prototype.getByKey = function (keyPropertyEnum1) {
        return new odata_v4_1.GetByKeyRequestBuilder(TestEntityWithEnumKey_1.TestEntityWithEnumKey, { KeyPropertyEnum1: keyPropertyEnum1 });
    };
    /**
    ...
    TestEntityWithEnumKeyRequestBuilder.prototype.getAll = function () {
        return new odata_v4_1.GetAllRequestBuilder(TestEntityWithEnumKey_1.TestEntityWithEnumKey);
    };
    /**
    ...
    TestEntityWithEnumKeyRequestBuilder.prototype.create = function (entity) {
        return new odata_v4_1.CreateRequestBuilder(TestEntityWithEnumKey_1.TestEntityWithEnumKey, entity);
    };
    /**
    ...
    TestEntityWithEnumKeyRequestBuilder.prototype.update = function (entity) {
        return new odata_v4_1.UpdateRequestBuilder(TestEntityWithEnumKey_1.TestEntityWithEnumKey, entity);
    };
    TestEntityWithEnumKeyRequestBuilder.prototype.delete = function (keyPropertyEnum1OrEntity) {
        return new odata_v4_1.DeleteRequestBuilder(TestEntityWithEnumKey_1.TestEntityWithEnumKey, keyPropertyEnum1OrEntity instanceof TestEntityWithEnumKey_1.TestEntityWithEnumKey ? keyPropertyEnum1OrEntity : { KeyPropertyEnum1: keyPropertyEnum1OrEntity });
    };
