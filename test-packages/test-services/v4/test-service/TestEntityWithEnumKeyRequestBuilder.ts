...
export class TestEntityWithEnumKeyRequestBuilder extends RequestBuilder<TestEntityWithEnumKey> {
   ...
   */
  getByKey(keyPropertyEnum1: TestEnumType): GetByKeyRequestBuilderV4<TestEntityWithEnumKey> {
    return new GetByKeyRequestBuilderV4(TestEntityWithEnumKey, { KeyPropertyEnum1: keyPropertyEnum1 });
  }
   ...
   */
  delete(keyPropertyEnum1: TestEnumType): DeleteRequestBuilderV4<TestEntityWithEnumKey>;
  /**
   * Returns a request builder for deleting an entity of type `TestEntityWithEnumKey`.
  ...
  delete(keyPropertyEnum1OrEntity: any): DeleteRequestBuilderV4<TestEntityWithEnumKey> {
    return new DeleteRequestBuilderV4(TestEntityWithEnumKey, keyPropertyEnum1OrEntity instanceof TestEntityWithEnumKey ? keyPropertyEnum1OrEntity : { KeyPropertyEnum1: keyPropertyEnum1OrEntity! });
  }
}
