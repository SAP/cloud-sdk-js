 ...
 */
export declare class TestEntityWithSharedEntityType1 extends EntityV4 implements TestEntityWithSharedEntityType1Type {
    /**
     ...
     * @returns A builder that constructs instances of entity type `TestEntityWithSharedEntityType1`.
     */
    static customField(fieldName: string): CustomFieldV4<TestEntityWithSharedEntityType1>;
    /**
...
export declare namespace TestEntityWithSharedEntityType1 {
     ...
     */
    const KEY_PROPERTY: EdmTypeField<TestEntityWithSharedEntityType1, "Edm.String", false, true>;
    /**
     * All fields of the TestEntityWithSharedEntityType1 entity.
     */
    const _allFields: Array<EdmTypeField<TestEntityWithSharedEntityType1, 'Edm.String', false, true>>;
    /**
     * All fields selector.
     */
     ...
     */
    const _keyFields: Array<Field<TestEntityWithSharedEntityType1, boolean, boolean>>;
    /**
