 ...
 */
var TestEntityWithSharedEntityType1RequestBuilder = /** @class */ (function (_super) {
     ...
     */
    TestEntityWithSharedEntityType1RequestBuilder.prototype.getByKey = function (keyProperty) {
        return new odata_v4_1.GetByKeyRequestBuilder(TestEntityWithSharedEntityType1_1.TestEntityWithSharedEntityType1, { KeyProperty: keyProperty });
    };
    /**
    ...
    TestEntityWithSharedEntityType1RequestBuilder.prototype.getAll = function () {
        return new odata_v4_1.GetAllRequestBuilder(TestEntityWithSharedEntityType1_1.TestEntityWithSharedEntityType1);
    };
    /**
     ...
     */
    TestEntityWithSharedEntityType1RequestBuilder.prototype.create = function (entity) {
        return new odata_v4_1.CreateRequestBuilder(TestEntityWithSharedEntityType1_1.TestEntityWithSharedEntityType1, entity);
    };
    /**
     ...
     */
    TestEntityWithSharedEntityType1RequestBuilder.prototype.update = function (entity) {
        return new odata_v4_1.UpdateRequestBuilder(TestEntityWithSharedEntityType1_1.TestEntityWithSharedEntityType1, entity);
    };
    TestEntityWithSharedEntityType1RequestBuilder.prototype.delete = function (keyPropertyOrEntity) {
        return new odata_v4_1.DeleteRequestBuilder(TestEntityWithSharedEntityType1_1.TestEntityWithSharedEntityType1, keyPropertyOrEntity instanceof TestEntityWithSharedEntityType1_1.TestEntityWithSharedEntityType1 ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    };
