...
var TestEntityWithSharedEntityType2 = /** @class */ (function (_super) {
    ...
    TestEntityWithSharedEntityType2.customField = function (fieldName) {
        return odata_v4_1.Entity.customFieldSelector(fieldName, TestEntityWithSharedEntityType2);
    };
    /**
...
(function (TestEntityWithSharedEntityType2) {
    var _fieldBuilder = new odata_common_1.FieldBuilder(TestEntityWithSharedEntityType2);
    /**
     * Static representation of the [[keyProperty]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TestEntityWithSharedEntityType2.KEY_PROPERTY = _fieldBuilder.buildEdmTypeField('KeyProperty', 'Edm.String', false);
    /**
     ...
     * All fields selector.
     */
    TestEntityWithSharedEntityType2.ALL_FIELDS = new odata_common_1.AllFields('*', TestEntityWithSharedEntityType2);
    /**
     * All key fields of the TestEntityWithSharedEntityType2 entity.
     */
    TestEntityWithSharedEntityType2._keyFields = [TestEntityWithSharedEntityType2.KEY_PROPERTY];
    /**
     * Mapping of all key field names to the respective static field property TestEntityWithSharedEntityType2.
     */
    TestEntityWithSharedEntityType2._keys = TestEntityWithSharedEntityType2._keyFields.reduce(function (acc, field) {
        acc[field._fieldName] = field;
        return acc;
    }, {});
})(TestEntityWithSharedEntityType2 = exports.TestEntityWithSharedEntityType2 || (exports.TestEntityWithSharedEntityType2 = {}));
exports.TestEntityWithSharedEntityType2 = TestEntityWithSharedEntityType2;
