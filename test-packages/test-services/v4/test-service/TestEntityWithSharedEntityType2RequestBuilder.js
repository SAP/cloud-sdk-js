 ...
 */
var TestEntityWithSharedEntityType2RequestBuilder = /** @class */ (function (_super) {
     ...
     */
    TestEntityWithSharedEntityType2RequestBuilder.prototype.getByKey = function (keyProperty) {
        return new odata_v4_1.GetByKeyRequestBuilder(TestEntityWithSharedEntityType2_1.TestEntityWithSharedEntityType2, { KeyProperty: keyProperty });
    };
    /**
    ...
    TestEntityWithSharedEntityType2RequestBuilder.prototype.getAll = function () {
        return new odata_v4_1.GetAllRequestBuilder(TestEntityWithSharedEntityType2_1.TestEntityWithSharedEntityType2);
    };
    /**
     ...
     */
    TestEntityWithSharedEntityType2RequestBuilder.prototype.create = function (entity) {
        return new odata_v4_1.CreateRequestBuilder(TestEntityWithSharedEntityType2_1.TestEntityWithSharedEntityType2, entity);
    };
    /**
     ...
     */
    TestEntityWithSharedEntityType2RequestBuilder.prototype.update = function (entity) {
        return new odata_v4_1.UpdateRequestBuilder(TestEntityWithSharedEntityType2_1.TestEntityWithSharedEntityType2, entity);
    };
    TestEntityWithSharedEntityType2RequestBuilder.prototype.delete = function (keyPropertyOrEntity) {
        return new odata_v4_1.DeleteRequestBuilder(TestEntityWithSharedEntityType2_1.TestEntityWithSharedEntityType2, keyPropertyOrEntity instanceof TestEntityWithSharedEntityType2_1.TestEntityWithSharedEntityType2 ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    };
