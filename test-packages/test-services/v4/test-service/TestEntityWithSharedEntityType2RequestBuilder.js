...
var TestEntityWithSharedEntityType2RequestBuilder = /** @class */ (function (_super) {
    ...
    TestEntityWithSharedEntityType2RequestBuilder.prototype.getByKey = function (keyProperty) {
        return new core_1.GetByKeyRequestBuilderV4(TestEntityWithSharedEntityType2_1.TestEntityWithSharedEntityType2, { KeyProperty: keyProperty });
    };
    /**
    ...
    TestEntityWithSharedEntityType2RequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(TestEntityWithSharedEntityType2_1.TestEntityWithSharedEntityType2);
    };
    /**
    ...
    TestEntityWithSharedEntityType2RequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(TestEntityWithSharedEntityType2_1.TestEntityWithSharedEntityType2, entity);
    };
    /**
    ...
    TestEntityWithSharedEntityType2RequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(TestEntityWithSharedEntityType2_1.TestEntityWithSharedEntityType2, entity);
    };
    TestEntityWithSharedEntityType2RequestBuilder.prototype.delete = function (keyPropertyOrEntity) {
        return new core_1.DeleteRequestBuilderV4(TestEntityWithSharedEntityType2_1.TestEntityWithSharedEntityType2, keyPropertyOrEntity instanceof TestEntityWithSharedEntityType2_1.TestEntityWithSharedEntityType2 ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    };
