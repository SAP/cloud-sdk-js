...
var TestNestedComplexTypeField = /** @class */ (function (_super) {
    ...
    function TestNestedComplexTypeField(fieldName, fieldOf, fieldOptions) {
        var _this = _super.call(this, fieldName, fieldOf, TestNestedComplexType, fieldOptions) || this;
         ...
         */
        _this.stringProperty = _this._fieldBuilder.buildEdmTypeField('StringProperty', 'Edm.String', true);
        /**
         * Representation of the [[TestNestedComplexType.complexTypeProperty]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.complexTypeProperty = _this._fieldBuilder.buildComplexTypeField('ComplexTypeProperty', TestLvl2NestedComplexType_1.TestLvl2NestedComplexTypeField, true);
        return _this;
    }
...
(function (TestNestedComplexType) {
     ...
     */
    function build(json) {
        return (0, core_1.deserializeComplexTypeV4)(json, TestNestedComplexType);
    }
