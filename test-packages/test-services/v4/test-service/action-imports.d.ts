 ...
 * @returns A request builder that allows to overwrite some of the values and execute the resulting request.
 */
export declare function testActionImportSharedEntityReturnType(parameters: TestActionImportSharedEntityReturnTypeParameters): Omit<ActionImportRequestBuilder<TestActionImportSharedEntityReturnTypeParameters, never>, 'execute'>;
/**
 ...
 * @returns A request builder that allows to overwrite some of the values and execute the resulting request.
 */
export declare function testActionImportSharedEntityReturnTypeCollection(parameters: TestActionImportSharedEntityReturnTypeCollectionParameters): Omit<ActionImportRequestBuilder<TestActionImportSharedEntityReturnTypeCollectionParameters, never>, 'execute'>;
/**
 ...
 * @returns A request builder that allows to overwrite some of the values and execute the resulting request.
 */
export declare function testActionImportNullableTest(parameters: TestActionImportNullableTestParameters): ActionImportRequestBuilder<TestActionImportNullableTestParameters, TestComplexType | null>;
