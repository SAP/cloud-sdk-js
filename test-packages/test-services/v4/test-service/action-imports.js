...
function testActionImportUnsupportedEdmTypes(parameters, deSerializers = odata_v4_1.defaultDeSerializers) {
    ...
    return new odata_v4_1.ActionImportRequestBuilder('/sap/opu/odata/sap/API_TEST_SRV', 'TestActionImportUnsupportedEdmTypes', (data) => (0, odata_v4_1.transformReturnValueForEdmType)(data, (val) => (0, odata_v4_1.edmToTs)(val.value, 'Edm.Any')), params, deSerializers);
}
