...
function testActionImportNoParameterNoReturnType(parameters) {
    var params = {};
    return new core_1.ActionImportRequestBuilder('/sap/opu/odata/sap/API_TEST_SRV', 'TestActionImportNoParameterNoReturnType', function (data) { return (0, core_1.transformReturnValueForUndefinedV4)(data, function (val) { return undefined; }); }, params);
}
...
function testActionImportMultipleParameterComplexReturnType(parameters) {
    ...
    return new core_1.ActionImportRequestBuilder('/sap/opu/odata/sap/API_TEST_SRV', 'TestActionImportMultipleParameterComplexReturnType', function (data) { return (0, core_1.transformReturnValueForComplexTypeV4)(data, function (data) { return (0, core_1.deserializeComplexTypeV4)(data, TestComplexType_1.TestComplexType); }); }, params);
}
...
function testActionImportUnsupportedEdmTypes(parameters) {
    ...
    return new core_1.ActionImportRequestBuilder('/sap/opu/odata/sap/API_TEST_SRV', 'TestActionImportUnsupportedEdmTypes', function (data) { return (0, core_1.transformReturnValueForEdmTypeV4)(data, function (val) { return (0, core_1.edmToTsV4)(val.value, 'Edm.Any'); }); }, params);
}
...
function testActionImportNoParameterEntityReturnType(parameters) {
    var params = {};
    return new core_1.ActionImportRequestBuilder('/sap/opu/odata/sap/API_TEST_SRV', 'TestActionImportNoParameterEntityReturnType', function (data) { return (0, core_1.transformReturnValueForEntityV4)(data, TestEntity_1.TestEntity); }, params);
}
...
function testActionImportSharedEntityReturnType(parameters) {
    var params = {};
    return new core_1.ActionImportRequestBuilder('/sap/opu/odata/sap/API_TEST_SRV', 'TestActionImportSharedEntityReturnType', function (data) { return (0, core_1.throwErrorWhenReturnTypeIsUnionType)(data, 'TestActionImportSharedEntityReturnType'); }, params);
}
...
function testActionImportSharedEntityReturnTypeCollection(parameters) {
    var params = {};
    return new core_1.ActionImportRequestBuilder('/sap/opu/odata/sap/API_TEST_SRV', 'TestActionImportSharedEntityReturnTypeCollection', function (data) { return (0, core_1.throwErrorWhenReturnTypeIsUnionType)(data, 'TestActionImportSharedEntityReturnTypeCollection'); }, params);
}
...
function testActionImportNullableTest(parameters) {
    var params = {
        nullablePerDefault: new core_1.ActionImportParameter('NullablePerDefault', 'Edm.String', parameters.nullablePerDefault),
        nullableExplicit: new core_1.ActionImportParameter('NullableExplicit', 'Edm.String', parameters.nullableExplicit),
        nonNullable: new core_1.ActionImportParameter('NonNullable', 'Edm.String', parameters.nonNullable)
    };
    return new core_1.ActionImportRequestBuilder('/sap/opu/odata/sap/API_TEST_SRV', 'TestActionImportNullableTest', function (data) { return (0, core_1.transformReturnValueForComplexTypeV4)(data, function (data) { return (0, core_1.deserializeComplexTypeV4)(data, TestComplexType_1.TestComplexType); }); }, params);
}
