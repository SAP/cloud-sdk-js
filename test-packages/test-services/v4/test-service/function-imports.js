...
function testFunctionImportEdmReturnType(parameters) {
    var params = {};
    return new odata_v4_1.FunctionImportRequestBuilder('/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportEdmReturnType', function (data) { return (0, odata_v4_1.transformReturnValueForEdmType)(data, function (val) { return (0, odata_v4_1.edmToTs)(val.value, 'Edm.Boolean'); }); }, params);
}
...
function testFunctionImportEdmReturnTypeCollection(parameters) {
    var params = {};
    return new odata_v4_1.FunctionImportRequestBuilder('/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportEdmReturnTypeCollection', function (data) { return (0, odata_v4_1.transformReturnValueForEdmTypeList)(data, function (val) { return (0, odata_v4_1.edmToTs)(val, 'Edm.String'); }); }, params);
}
...
function testFunctionImportNullableTest(parameters) {
    ...
    return new odata_v4_1.FunctionImportRequestBuilder('/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportNullableTest', function (data) { return (0, odata_v4_1.transformReturnValueForEdmTypeList)(data, function (val) { return (0, odata_v4_1.edmToTs)(val, 'Edm.String'); }); }, params);
}
...
function testFunctionImportMultipleParams(parameters) {
    ...
    return new odata_v4_1.FunctionImportRequestBuilder('/sap/opu/odata/sap/API_TEST_SRV', 'TestFunctionImportMultipleParams', function (data) { return (0, odata_v4_1.transformReturnValueForEdmType)(data, function (val) { return (0, odata_v4_1.edmToTs)(val.value, 'Edm.Boolean'); }); }, params);
}
