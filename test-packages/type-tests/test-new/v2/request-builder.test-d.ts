...
expectType<TestEntityRequestBuilder<DefaultDeSerializerV2>>(testEntityApi.requestBuilder());
...
expectType<GetAllRequestBuilder<TestEntity<DefaultDeSerializerV2>,DefaultDeSerializerV2>>(testEntityGetAllRequest)
...
expectType<GetByKeyRequestBuilder<TestEntity<DefaultDeSerializerV2>,DefaultDeSerializerV2>>(testEntityApi.requestBuilder().getByKey('uuid', 'test'));
...
expectType<CreateRequestBuilder<TestEntity<DefaultDeSerializerV2>,DefaultDeSerializerV2>>(testEntityApi.requestBuilder().create(testEntityInstance));
...
expectType<UpdateRequestBuilder<TestEntity<DefaultDeSerializerV2>,DefaultDeSerializerV2>>(testEntityApi.requestBuilder().update(testEntityInstance));
...
expectType<CreateRequestBuilder<TestEntityMultiLink<DefaultDeSerializerV2>,DefaultDeSerializerV2>>(testEntityMultiLinkApi
  .requestBuilder()
  .create(testMultiLinkInstance)
  .asChildOf(testEntityInstance, testEntitySchema.TO_MULTI_LINK));

expectError<any>(testEntityMultiLinkApi
  .requestBuilder()
  .create(testMultiLinkInstance)
 ...
 */
// $ExpectType GetAllRequestBuilder<TestEntity<DeSerializers<string, boolean, number, BigNumber, number, number, number, number, BigNumber, string, number, number, string, any, Moment, Moment, Time>>, DeSerializers<string, boolean, number, BigNumber, number, number, number, number, BigNumber, string, number, number, string, any, Moment, Moment, Time>>
expectType<GetAllRequestBuilder<TestEntity<DefaultDeSerializerV2>,DefaultDeSerializerV2>>(testEntityGetAllRequest.select(testEntitySchema.STRING_PROPERTY));

// $ExpectError
expectError<any>(testEntityGetAllRequest.select(testEntityMultiLinkSchema.STRING_PROPERTY));

// $ExpectType GetAllRequestBuilder<TestEntity<DeSerializers<string, boolean, number, BigNumber, number, number, number, number, BigNumber, string, number, number, string, any, Moment, Moment, Time>>, DeSerializers<string, boolean, number, BigNumber, number, number, number, number, BigNumber, string, number, number, string, any, Moment, Moment, Time>>
expectType<GetAllRequestBuilder<TestEntity<DefaultDeSerializerV2>,DefaultDeSerializerV2>>(testEntityGetAllRequest.select(testEntityApi.customField('CustomField')));

expectError<any>(testEntityGetAllRequest.select(
 ...
 */
// $ExpectType GetAllRequestBuilder<TestEntity<DeSerializers<string, boolean, number, BigNumber, number, number, number, number, BigNumber, string, number, number, string, any, Moment, Moment, Time>>, DeSerializers<string, boolean, number, BigNumber, number, number, number, number, BigNumber, string, number, number, string, any, Moment, Moment, Time>>
expectType<GetAllRequestBuilder<TestEntity<DefaultDeSerializerV2>,DefaultDeSerializerV2>>(testEntityGetAllRequest.select(
 ...
 */
// $ExpectType GetAllRequestBuilder<TestEntity<DeSerializers<string, boolean, number, BigNumber, number, number, number, number, BigNumber, string, number, number, string, any, Moment, Moment, Time>>, DeSerializers<string, boolean, number, BigNumber, number, number, number, number, BigNumber, string, number, number, string, any, Moment, Moment, Time>>
expectType<GetAllRequestBuilder<TestEntity<DefaultDeSerializerV2>,DefaultDeSerializerV2>>(testEntityGetAllRequest.filter(testEntitySchema.STRING_PROPERTY.equals('test')));

// $ExpectType GetAllRequestBuilder<TestEntity<DeSerializers<string, boolean, number, BigNumber, number, number, number, number, BigNumber, string, number, number, string, any, Moment, Moment, Time>>, DeSerializers<string, boolean, number, BigNumber, number, number, number, number, BigNumber, string, number, number, string, any, Moment, Moment, Time>>
expectType<GetAllRequestBuilder<TestEntity<DefaultDeSerializerV2>,DefaultDeSerializerV2>>(testEntityGetAllRequest.filter(
...
expectError<any>(testEntityGetAllRequest.filter(
...
expectError<any>(testEntitySchema.customField('SomeCustomField').edmString().equals(13214)); // $ExpectError

expectError<any>(testEntitySchema.customField('SomeCustomField').edmDouble().equals('aString')); // $ExpectError

/**
 * ORDER BY.
 */
// $ExpectType GetAllRequestBuilder<TestEntity<DeSerializers<string, boolean, number, BigNumber, number, number, number, number, BigNumber, string, number, number, string, any, Moment, Moment, Time>>, DeSerializers<string, boolean, number, BigNumber, number, number, number, number, BigNumber, string, number, number, string, any, Moment, Moment, Time>>
expectType<GetAllRequestBuilder<TestEntity<DefaultDeSerializerV2>,DefaultDeSerializerV2>>(testEntityGetAllRequest.orderBy(asc(testEntitySchema.STRING_PROPERTY)));

// $ExpectType GetAllRequestBuilder<TestEntity<DeSerializers<string, boolean, number, BigNumber, number, number, number, number, BigNumber, string, number, number, string, any, Moment, Moment, Time>>, DeSerializers<string, boolean, number, BigNumber, number, number, number, number, BigNumber, string, number, number, string, any, Moment, Moment, Time>>
expectType<GetAllRequestBuilder<TestEntity<DefaultDeSerializerV2>,DefaultDeSerializerV2>>(testEntityGetAllRequest.orderBy(desc(testEntitySchema.STRING_PROPERTY)));

// $ExpectType GetAllRequestBuilder<TestEntity<DeSerializers<string, boolean, number, BigNumber, number, number, number, number, BigNumber, string, number, number, string, any, Moment, Moment, Time>>, DeSerializers<string, boolean, number, BigNumber, number, number, number, number, BigNumber, string, number, number, string, any, Moment, Moment, Time>>
expectType<GetAllRequestBuilder<TestEntity<DefaultDeSerializerV2>,DefaultDeSerializerV2>>(testEntityGetAllRequest.orderBy(
  asc(testEntitySchema.STRING_PROPERTY),
  desc(testEntitySchema.STRING_PROPERTY)
));

expectError<any>(testEntityGetAllRequest.orderBy(
